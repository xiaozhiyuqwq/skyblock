...
#游戏模式更改
execute @a[scores={tptype=1..3,temp=1101},tag=!admin] ~ ~ ~ gamemode survival @s
execute @a[scores={tptype=4,temp=1101},tag=!admin] ~ ~ ~ gamemode adventure @s
execute @a[scores={tptype=5,temp=1101},tag=!admin] ~ ~ ~ gamemode survival @s
execute @a[scores={tptype=1..3,temp=1101},tag=admin,m=!creative] ~ ~ ~ gamemode survival @s
execute @a[scores={tptype=4,temp=1101},tag=admin,m=!creative] ~ ~ ~ gamemode adventure @s
execute @a[scores={tptype=5,temp=1101},tag=admin,m=!creative] ~ ~ ~ gamemode survival @s
execute @a[scores={tptype=5,temp=1101},tag=admin,m=creative] ~ ~ ~ gamemode creative @s
