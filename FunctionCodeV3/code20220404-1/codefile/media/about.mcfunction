...
execute @a[scores={temp=50,about=100..,abouttext=1,language=3}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§l§6開発者 §r§3祉語 §f祉語。MinecraftとACG文化が好きです。Githubホームページ:https://github.com/xiaozhiyuqwqGiteホームページ：https://gitee.com/xiaozhiyuqwqサージのホームページ:https://space.bilibili.com/43736982。祉語はロリじゃないです（ちょっとツンデレな時もありますが）！"}]}
...
execute @a[scores={temp=50,about=960..,abouttext=20..21,language=1}] ~ ~ ~ titleraw @s subtitle {"rawtext":[{"text":"§eSkyblock-for-Server §bTechnical Support"}]}
execute @a[scores={temp=50,about=960..,abouttext=20..21,language=2}] ~ ~ ~ titleraw @s subtitle {"rawtext":[{"text":"§e空島生存-伺服器版本 §b技術支援"}]}
execute @a[scores={temp=50,about=960..,abouttext=20..21,language=3}] ~ ~ ~ titleraw @s subtitle {"rawtext":[{"text":"§eSkyblock-for-Server §bテクニカルサポート"}]}
...
execute @a[scores={temp=50,about=1000..,abouttext=22..27,language=1}] ~ ~ ~ titleraw @s subtitle {"rawtext":[{"text":"§eSkyblock-for-Server §bSpecial Thanks"}]}
execute @a[scores={temp=50,about=1000..,abouttext=22..27,language=2}] ~ ~ ~ titleraw @s subtitle {"rawtext":[{"text":"§e空島生存-伺服器版本 §b特別感謝"}]}
execute @a[scores={temp=50,about=1000..,abouttext=22..27,language=3}] ~ ~ ~ titleraw @s subtitle {"rawtext":[{"text":"§eSkyblock-for-Server §bありがとうございます"}]}
