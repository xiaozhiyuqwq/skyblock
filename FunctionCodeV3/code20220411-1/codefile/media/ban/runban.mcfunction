...
execute @e[scores={typeid=128},type=armor_stand] ~ ~ ~ tag @a[r=99999999999999999] add mainworld
#跑图确认
...
#恢复50
execute @a[scores={actionbar=48},tag=!islandruns] ~ ~ ~ tag @s[scores={actionbar=48}] add noactionbar
execute @a[scores={actionbar=35},tag=!islandruns] ~ ~ ~ tag @s[scores={actionbar=35}] add noactionbar
execute @a[scores={actionbar=30},tag=!islandruns] ~ ~ ~ tag @s[scores={actionbar=30}] add noactionbar
execute @a[tag=!islandruns,tag=!noactionbar] ~ ~ ~ scoreboard players set @s actionbar 50
execute @a[tag=noactionbar] ~ ~ ~ tag @s remove noactionbar
