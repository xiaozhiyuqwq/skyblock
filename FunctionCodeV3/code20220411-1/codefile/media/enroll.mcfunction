...
#传送门的刷新
#原版的末地刷新
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~1 ~ ~2 end_portal_frame 2
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~ ~ ~2 end_portal_frame 2
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~-1 ~ ~2 end_portal_frame 2
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~-2 ~ ~1 end_portal_frame 3
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~-2 ~ ~ end_portal_frame 3
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~-2 ~ ~-1 end_portal_frame 3
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~-1 ~ ~-2 end_portal_frame 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~ ~ ~-2 end_portal_frame 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~1 ~ ~-2 end_portal_frame 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~2 ~ ~1 end_portal_frame 1
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~2 ~ ~-1 end_portal_frame 1
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~2 ~ ~ end_portal_frame 1
...
execute @e[type=armor_stand,scores={typeid=128,version=0..1}] ~ ~ ~ execute @a[scores={temp=223,receive=535..}] ~ ~ ~ tag @s add registered
