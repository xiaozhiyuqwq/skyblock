...
#请在下面填写更新月份
scoreboard players set upmouth version 2
#请在下面填写更新主版本
scoreboard players set mainver version 1
#请在下面填写更新子版本(分支)
scoreboard players set branchesver version 20
#请在下面填写更新标签1=BETA 2=RELEASE 3=DEMO 4=DEVELOP 5=SNAPSHOT
scoreboard players set vertag version 2
#版本设置
...
execute @a[scores={language=3}] ~ ~ ~ tellraw @s[scores={login=0,language=0},tag=!admin] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§l§aログインに成功しました! §l§3"},{"selector":"s"},{"text":" §6["},{"score":{"name":"@s","ob@jective":"uid"}},{"text":"] §r§fユーザー グループ： §l§bUser§f-§cLevel_"},{"score":{"name":"@s","objective":"level"}}]}
...
tellraw @a[scores={login=0,language=3,level=0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§fこんにちは、ゲームへようこそ! §cアカウントはまだ登録していません。"}]}
...
tellraw @a[scores={login=0,language=0,level=1..5,sign_in=0..1,uid=!40001..99999},tag=developer] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§f您好，欢迎加入游戏！§6欢迎回来！§b您今天好像还没有签到哦，签到即可获得硬币。 §f尊敬的开发者 §l§b"},{"selector":"@s"},{"text":" §r§f，欢迎回来！"}]}
...
tellraw @a[scores={login=0,language=2,level=1..5,sign_in=0..1,uid=!40001..99999},tag=developer] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§f您好，歡迎加入遊戲！§6歡迎回來！§b您今天好像還沒有簽到哦，簽到即可獲得硬幣。 尊敬的開發者 §l§b"},{"selector":"@s"},{"text":" §r§f ，歡迎回來！"}]}
tellraw @a[scores={login=0,language=3,level=1..5,sign_in=0..1,uid=!40001..99999},tag=!developer] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§fこんにちは、ゲームへようこそ！ §6お帰りなさい！§b今日、あなたはコインを得るために署名していないようです。"}]}
tellraw @a[scores={login=0,language=3,level=1..5,sign_in=0..1,uid=!40001..99999},tag=developer] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§fこんにちは、ゲームへようこそ！ §6お帰りなさい！§b今日、あなたはコインを得るために署名していないようです。 §f親愛なる開発者 §l§b"},{"selector":"@s"},{"text":" §r§f、お帰りなさい！"}]}
...
tellraw @a[scores={login=0,language=3,level=1..5,sign_in=2,uid=!40001..99999},tag=!developer] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§fこんにちは、ゲームへようこそ！ §6お帰りなさい！"}]}
tellraw @a[scores={login=0,language=3,level=1..5,sign_in=2,uid=!40001..99999},tag=developer] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§fこんにちは、ゲームへようこそ！ §6お帰りなさい！§b今日、あなたはコインを得るために署名していないようです。 §f親愛なる開発者 §l§b"},{"selector":"@s"},{"text":" §r§f、お帰りなさい！"}]}
...
tellraw @a[scores={login=0,language=3,uid=40001..99999}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§fこんにちは、ゲームへようこそ！ §c無効なユーザー識別子パラメーターです。 処理するために管理者に連絡してください！"}]}
