...
execute @a[scores={temp=444}] ~ ~ ~ scoreboard players set @s[scores={temp=444,deadproject=!0..1440},tag=!developer] deadproject 1330
execute @a[scores={temp=444}] ~ ~ ~ scoreboard players set @s[scores={temp=444,deadproject=!0..1440},tag=developer] deadproject 1325
...
#直接传送回岛屿
execute @a[scores={temp=444}] ~ ~ ~ scoreboard players add @s tptype 0
execute @a[scores={temp=444,tptype=!0}] ~ ~ ~ scoreboard players set @s temp 1102
execute @a[scores={temp=1102}] ~ ~ ~ function media/tp
