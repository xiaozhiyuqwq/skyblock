#dead
#计算
execute @a[scores={temp=444},tag=registered] ~ ~ ~ scoreboard players random @s[scores={temp=444,level=1}] deadcoin 10 20
execute @a[scores={temp=444},tag=registered] ~ ~ ~ scoreboard players random @s[scores={temp=444,level=2}] deadcoin 15 25
execute @a[scores={temp=444},tag=registered] ~ ~ ~ scoreboard players random @s[scores={temp=444,level=3}] deadcoin 20 30
execute @a[scores={temp=444},tag=registered] ~ ~ ~ scoreboard players random @s[scores={temp=444,level=4}] deadcoin 35 45
execute @a[scores={temp=444},tag=registered] ~ ~ ~ scoreboard players random @s[scores={temp=444,level=5}] deadcoin 45 50
execute @a[scores={temp=444},tag=registered] ~ ~ ~ scoreboard players set @s[scores={temp=444,coin=!100..}] deadcoin 0
