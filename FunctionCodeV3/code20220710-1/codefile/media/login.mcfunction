...
#请在下面填写更新子版本(分支)
scoreboard players set branchesver version 35
#请在下面填写更新标签
#2=RELEASE
#3=DEMO
#4=DEVELOP
...
#7=CLOSED-BETA（封测）
#8=OPEN-BETA（公测）
scoreboard players set vertag version 5
#版本设置
...
scoreboard players add @a[scores={login=0..3}] achievement14 0
scoreboard players add @a[scores={login=0..3}] achievement15 0
scoreboard players add @a[scores={login=0..3}] achievement16 0
scoreboard players add @a[scores={login=0..3}] achievement17 0
scoreboard players add @a[scores={login=0..3}] achievement18 0
scoreboard players add @a[scores={login=0..3}] achievement19 0
scoreboard players add @a[scores={login=0..3}] achievement20 0
scoreboard players add @a[scores={login=0..3}] achievement21 0
scoreboard players add @a[scores={login=0..3}] achievement22 0
scoreboard players add @a[scores={login=0..3}] achievement23 0
scoreboard players add @a[scores={login=0..3}] achievement24 0
...
#开发版
execute @a[scores={login=0,hitokotolang=0,version=4,language=0}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f当前版本为 §l§cDEVELOP §r§f版本，系统内容正在开发中，将会会出现各种错误。§l§c此版本所有内容可能会在将来版本修改或移除。§r§f漏洞追踪器请访问 §7https://skyblock.xiaozhiyuqwq.top/wiki/issue§r§f 更新日志请访问 §7https://skyblock.xiaozhiyuqwq.top/wiki/update§r§f 。"}]}
...
execute @a[scores={login=0,hitokotolang=0,version=4,language=2}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空島生存§f>>§r§f當前版本為 §l§cDEVELOP §r§f版本，系統內容正在開發中，將會會出現各種錯誤。§l§c此版本所有內容可能會在將來版本修改或移除。"}]}
