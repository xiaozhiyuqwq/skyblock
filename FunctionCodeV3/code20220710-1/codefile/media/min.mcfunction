...
#单方块部分限制恢复
execute @e[type=leash_knot,scores={version=1,obbox=95..100}] ~ ~ ~ scoreboard players remove @s obbox 1
execute @e[type=leash_knot,scores={version=1,obvaluable=280..400}] ~ ~ ~ scoreboard players remove @s obvaluable 2