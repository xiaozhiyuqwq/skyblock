...
#扣硬币
execute @a[scores={softbantype=2}] ~ ~ ~ scoreboard players random @s softbantype 201 205
execute @a[scores={softbantype=201}] ~ ~ ~ scoreboard players remove @s coin 10
execute @a[scores={softbantype=202}] ~ ~ ~ scoreboard players remove @s coin 20
execute @a[scores={softbantype=203}] ~ ~ ~ scoreboard players remove @s coin 30
execute @a[scores={softbantype=204}] ~ ~ ~ scoreboard players remove @s coin 40
execute @a[scores={softbantype=205}] ~ ~ ~ scoreboard players remove @s coin 50
execute @a[scores={softbantype=201..205,coin=..-1000}] ~ ~ ~ scoreboard players set @s coin 0
execute @a[scores={softbantype=201..205}] ~ ~ ~ scoreboard players reset @s softbantype
#刷新生物
