...
execute @a[scores={sign_in=0,stinger=1001..1200,login=4}] ~ ~ ~ scoreboard players random @s[scores={sign_in=0}] stinger 301 306
execute @a[scores={sign_in=0,login=4}] ~ ~ ~ scoreboard players set @s[scores={sign_in=0}] sign_in 1
#天気の子
execute @a[scores={stinger=301}] ~ ~ ~ tag @a remove weatheringwithyou
...
#君の名は。
execute @a[scores={stinger=302}] ~ ~ ~ tag @a remove yourname
...
#千と千寻の神隠し
execute @a[scores={stinger=303}] ~ ~ ~ tag @a remove spiritedaway
...
#あの日見た花の名前を僕達はまだ知らない。
execute @a[scores={stinger=304}] ~ ~ ~ tag @a remove buster
...
#星空列车与白的旅行
execute @a[scores={stinger=305}] ~ ~ ~ tag @a remove stinger-305
...
#烟火Firework
execute @a[scores={stinger=306}] ~ ~ ~ tag @a remove stinger-306
execute @a[scores={stinger=306}] ~ ~ ~ tag @r[tag=!stinger] add stinger-306
execute @a[tag=buster,scores={stinger=306}] ~ ~ ~ tellraw @s[scores={language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§7爬出枯井的瞬间，整篇星空映入眼帘。 摘录自 §b烟火§7 。"}]}
execute @a[tag=buster,scores={stinger=306}] ~ ~ ~ tellraw @s[scores={language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§7爬出枯井的瞬间，整篇星空映入眼帘。 Excerpt from §bFirework§7 ."}]}
execute @a[tag=buster,scores={stinger=306}] ~ ~ ~ tellraw @s[scores={language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§7爬出枯井的瞬間，整篇星空映入眼簾。 摘錄自 §b烟火§7 。 "}]}
execute @a[tag=buster,scores={stinger=306}] ~ ~ ~ tellraw @s[scores={language=3}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§7爬出枯井的瞬间，整篇星空映入眼帘。 §b烟火§7 から抜粋します。"}]}
#执行彩蛋区域
#主要
...
tag @a[tag=weather] add getegg
tag @a[tag=weather] add getegg1
...
execute @e[type=item,name=君の名。] ~ ~ ~ tag @p[r=5,tag=yourname,tag=!stinger] add name
execute @e[type=item,name=你的名字。] ~ ~ ~ tag @p[r=5,tag=yourname,tag=!stinger] add name
...
tag @a[tag=name] add getegg
tag @a[tag=name] add getegg2
...
tag @a[tag=busters] add getegg
tag @a[tag=busters] add getegg3
...
tag @a[tag=stinger-305-1] add getegg
tag @a[tag=stinger-305-1] add getegg4
tag @a[tag=stinger-305-1] remove stinger-305
tag @a[tag=stinger-305-1] remove stinger-305-1
#烟火 彩蛋（迷
execute @e[type=item,name=烟火] ~ ~ ~ tag @p[r=5,tag=stinger-306,tag=!stinger] add stinger-306-1
execute @e[type=item,name=Firework] ~ ~ ~ tag @p[r=5,tag=stinger-306,tag=!stinger] add stinger-306-1
execute @a[tag=stinger-306,tag=stinger-306-1] ~ ~ ~ tellraw @s[scores={language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§7绽放的烟火能给找不到归路的灵魂指引方向。 摘录自 烟火 。"}]}
execute @a[tag=stinger-306,tag=stinger-306-1] ~ ~ ~ tellraw @s[scores={language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§7绽放的烟火能给找不到归路的灵魂指引方向。 Excerpt from 烟火 ."}]}
execute @a[tag=stinger-306,tag=stinger-306-1] ~ ~ ~ tellraw @s[scores={language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§7綻放的烟火能給找不到歸路的靈魂指引方向。 摘錄自 烟火 。"}]}
execute @a[tag=stinger-306,tag=stinger-306-1] ~ ~ ~ tellraw @s[scores={language=3}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§7绽放的烟火能给找不到归路的灵魂指引方向。 烟火 から抜粋します。"}]}
execute @a[tag=stinger-306,tag=stinger-306-1] ~ ~ ~ summon fireworks_rocket ~ ~2 ~
execute @a[tag=stinger-306,tag=stinger-306-1] ~ ~ ~ summon fireworks_rocket ~ ~2 ~
execute @a[tag=stinger-306,tag=stinger-306-1] ~ ~ ~ summon fireworks_rocket ~ ~2 ~
execute @a[tag=stinger-306,tag=stinger-306-1] ~ ~ ~ tag @a[tag=stinger-305-1] add stinger
tag @a[tag=stinger-306-1] add getegg
tag @a[tag=stinger-306-1] add getegg5
tag @a[tag=stinger-306-1] remove stinger-306
tag @a[tag=stinger-306-1] remove stinger-306-1