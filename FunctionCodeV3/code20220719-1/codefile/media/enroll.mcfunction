...
# ===强制锁定游戏模式===
#
# execute @a ~ ~ ~ scoreboard players set gamerule version 
#
# =====================
...
#全局游戏模式确认
execute @a[tag=receiveitem] ~ ~ ~ execute @e[type=armor_stand,scores={typeid=128}] ~ ~ ~ scoreboard players operation @e[type=armor_stand,scores={typeid=128}] version = gamerule version
execute @a[tag=receiveitem] ~ ~ ~ execute @e[type=armor_stand,scores={typeid=128,version=!0..1}] ~ ~ ~ scoreboard players set gamerule version 0
#物品获得与数据赋值
...
execute @a[tag=receiveitem] ~ ~ ~ scoreboard players set @s[tag=receiveitem] achievement25 0
execute @a[tag=receiveitem] ~ ~ ~ scoreboard players set @s[tag=receiveitem] achievement26 0
execute @a[tag=receiveitem] ~ ~ ~ scoreboard players set @s[tag=receiveitem] achievement27 0
execute @a[tag=receiveitem] ~ ~ ~ scoreboard players set @s[tag=receiveitem] achievement28 0
execute @a[tag=receiveitem] ~ ~ ~ scoreboard players set @s[tag=receiveitem] achievement29 0
execute @a[tag=receiveitem] ~ ~ ~ scoreboard players set @s[tag=receiveitem] achievement30 0
execute @a[tag=receiveitem] ~ ~ ~ scoreboard players set @s[tag=receiveitem] achievement31 0
execute @a[tag=receiveitem] ~ ~ ~ scoreboard players set @s[tag=receiveitem] achievement32 0
execute @a[tag=receiveitem] ~ ~ ~ scoreboard players set @s[tag=receiveitem] achievement33 0
execute @a[tag=receiveitem] ~ ~ ~ scoreboard players set @s[tag=receiveitem] achievement34 0
execute @a[tag=receiveitem] ~ ~ ~ scoreboard players set @s[tag=receiveitem] achievement35 0
execute @a[tag=receiveitem] ~ ~ ~ scoreboard players set @s[tag=receiveitem] achievement36 0
execute @a[tag=receiveitem] ~ ~ ~ scoreboard players set @s[tag=receiveitem] achievement37 0
execute @a[tag=receiveitem] ~ ~ ~ scoreboard players set @s[tag=receiveitem] task 0
execute @a[tag=receiveitem] ~ ~ ~ tag @s remove closeaction
#原版模式的注册物品
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[tag=receiveitem] ~ ~ ~ give @s[tag=receiveitem] leather_helmet 1 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[tag=receiveitem] ~ ~ ~ give @s[tag=receiveitem] leather_chestplate 1 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[tag=receiveitem] ~ ~ ~ give @s[tag=receiveitem] leather_leggings 1 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[tag=receiveitem] ~ ~ ~ give @s[tag=receiveitem] leather_boots 1 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[tag=receiveitem] ~ ~ ~ give @s[tag=receiveitem] wooden_sword 1 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[tag=receiveitem] ~ ~ ~ give @s[tag=receiveitem] wooden_axe 1 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[tag=receiveitem] ~ ~ ~ give @s[tag=receiveitem] wooden_pickaxe 1 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[tag=receiveitem] ~ ~ ~ give @s[tag=receiveitem] wooden_shovel 1 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[tag=receiveitem] ~ ~ ~ give @s[tag=receiveitem] wooden_hoe 1 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[tag=receiveitem] ~ ~ ~ give @s[tag=receiveitem] log 4 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[tag=receiveitem] ~ ~ ~ give @s[tag=receiveitem] bucket 1 10
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[tag=receiveitem] ~ ~ ~ give @s[tag=receiveitem] bucket 1 10
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[tag=receiveitem] ~ ~ ~ give @s[tag=receiveitem] ice 3 0
#单方块的注册物品
execute @e[type=armor_stand,scores={typeid=128,version=1}] ~ ~ ~ execute @a[tag=receiveitem] ~ ~ ~ give @s[tag=receiveitem] leather_chestplate 1 0
execute @e[type=armor_stand,scores={typeid=128,version=1}] ~ ~ ~ execute @a[tag=receiveitem] ~ ~ ~ give @s[tag=receiveitem] leather_leggings 1 0
#每个人都有/每种模式都有的
execute @a[tag=receiveitem] ~ ~ ~ give @s[tag=receiveitem] stone 16 2
execute @a[tag=receiveitem] ~ ~ ~ give @s[tag=receiveitem] cookie 8 0
execute @a[tag=receiveitem] ~ ~ ~ give @s[tag=receiveitem] dirt 3 0
execute @a[tag=receiveitem] ~ ~ ~ give @s[tag=receiveitem] sapling 3 0
#开发者额外的内容
...
#开始计算注册时间
execute @a[tag=receiveitem] ~ ~ ~ scoreboard players set @s regtime 1
#游客注册
...
#ob模式的刷新
execute @e[type=armor_stand,scores={typeid=128,version=1}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ detect ~ 253 ~ air 0 fill ~-2 251 ~-2 ~2 255 ~2 barrier 0
execute @e[type=armor_stand,scores={typeid=128,version=1}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~ 253 ~ cobblestone_wall 0
execute @e[type=armor_stand,scores={typeid=128,version=1}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ tag @s add gamemodeob
execute @e[type=armor_stand,scores={typeid=128,version=1}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1,tag=gamemodeob,tag=!gamemodeob2] ~ ~ ~ summon leash_knot ~ 253.50 ~
execute @e[tag=ob,x=~,y=253,z=~,r=5,type=leash_knot] ~ ~ ~ tag @a[x=~,y=101,z=~,r=15,tag=gamemodeob] add gamemodeob2
execute @e[type=armor_stand,scores={typeid=128,version=1}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ tag @e[x=~,y=253,z=~,r=5,type=leash_knot] add ob
execute @e[type=armor_stand,scores={typeid=128,version=1}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ execute @e[type=leash_knot,tag=ob] ~ ~ ~ scoreboard players operation @s version = gamerule version
execute @e[type=armor_stand,scores={typeid=128,version=1}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ scoreboard players add @e[tag=ob,type=leash_knot] obnumber 0
execute @e[type=armor_stand,scores={typeid=128,version=1}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ scoreboard players add @e[tag=ob,type=leash_knot] oblevel 0
execute @e[type=armor_stand,scores={typeid=128,version=1}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ execute @e[tag=ob,type=leash_knot,scores={oblevel=0,obnumber=0}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ stained_glass 1
execute @e[type=armor_stand,scores={typeid=128,version=1}] ~ ~ ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ scoreboard players set @e[tag=ob,type=leash_knot,scores={oblevel=0,obnumber=0}] obnumber 1
...
#传送门的刷新
#原版的末地刷新
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 32 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ 64 ~ setblock ~1 ~ ~2 end_portal_frame 2
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 32 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ 64 ~ setblock ~ ~ ~2 end_portal_frame 2
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 32 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ 64 ~ setblock ~-1 ~ ~2 end_portal_frame 2
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 32 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ 64 ~ setblock ~-2 ~ ~1 end_portal_frame 3
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 32 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ 64 ~ setblock ~-2 ~ ~ end_portal_frame 3
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 32 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ 64 ~ setblock ~-2 ~ ~-1 end_portal_frame 3
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 32 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ 64 ~ setblock ~-1 ~ ~-2 end_portal_frame 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 32 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ 64 ~ setblock ~ ~ ~-2 end_portal_frame 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 32 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ 64 ~ setblock ~1 ~ ~-2 end_portal_frame 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 32 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ 64 ~ setblock ~2 ~ ~1 end_portal_frame 1
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 32 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ 64 ~ setblock ~2 ~ ~-1 end_portal_frame 1
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 32 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ 64 ~ setblock ~2 ~ ~ end_portal_frame 1
#地狱门刷新
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 80 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~-16 ~ ~ obsidian 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 80 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~16 ~ ~ obsidian 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 80 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~ ~ ~-16 obsidian 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 80 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~-16 ~ ~16 obsidian 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 80 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~16 ~ ~16 obsidian 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 80 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~16 ~ ~-16 obsidian 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 80 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~-16 ~ ~16 obsidian 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 80 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~-16 ~ ~-16 obsidian 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 128 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~ ~16 ~ obsidian 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ 64 ~ execute @a[scores={temp=223,receive=10..40},c=1] ~ ~ ~ setblock ~ ~-16 ~ obsidian 0
#快速注册（对原版空岛+单方块，只要10s，速度更快，对服务端卡顿更小）
execute @e[type=armor_stand,scores={typeid=128,version=0..1}] ~ ~ ~ execute @a[scores={temp=223,receive=50..500}] ~ ~ ~ scoreboard players set @s receive 535
...
#完成注册后删除缓存
execute @a[scores={receive=541..}] ~ ~ ~ function media/actionbar
