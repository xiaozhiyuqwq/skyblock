...
execute @a[tag=reset] ~ ~ ~ scoreboard players reset @s[tag=reset] obnumber
execute @a[tag=reset] ~ ~ ~ scoreboard players reset @s[tag=reset] obtitletar
execute @a[tag=reset] ~ ~ ~ scoreboard players reset @s[tag=reset] obtitlebfb
execute @a[tag=reset] ~ ~ ~ scoreboard players reset @s[tag=reset] signdays
execute @a[tag=reset] ~ ~ ~ scoreboard players reset @s[tag=reset] regtime
...
execute @a[tag=reset] ~ ~ ~ scoreboard players reset @s[tag=reset] achievement25
execute @a[tag=reset] ~ ~ ~ scoreboard players reset @s[tag=reset] achievement26
execute @a[tag=reset] ~ ~ ~ scoreboard players reset @s[tag=reset] achievement27
execute @a[tag=reset] ~ ~ ~ scoreboard players reset @s[tag=reset] achievement28
execute @a[tag=reset] ~ ~ ~ scoreboard players reset @s[tag=reset] achievement29
execute @a[tag=reset] ~ ~ ~ scoreboard players reset @s[tag=reset] achievement30
execute @a[tag=reset] ~ ~ ~ scoreboard players reset @s[tag=reset] achievement31
execute @a[tag=reset] ~ ~ ~ scoreboard players reset @s[tag=reset] achievement32
execute @a[tag=reset] ~ ~ ~ scoreboard players reset @s[tag=reset] achievement33
execute @a[tag=reset] ~ ~ ~ scoreboard players reset @s[tag=reset] achievement34
execute @a[tag=reset] ~ ~ ~ scoreboard players reset @s[tag=reset] achievement35
execute @a[tag=reset] ~ ~ ~ scoreboard players reset @s[tag=reset] achievement36
execute @a[tag=reset] ~ ~ ~ scoreboard players reset @s[tag=reset] achievement37
execute @a[tag=reset] ~ ~ ~ tag @s[tag=reset] remove objtzw
execute @a[tag=reset] ~ ~ ~ tag @s[tag=reset] remove getabout
execute @a[tag=reset] ~ ~ ~ tag @s[tag=reset] remove getabout1
execute @a[tag=reset] ~ ~ ~ tag @s[tag=reset] remove getegg
execute @a[tag=reset] ~ ~ ~ tag @s[tag=reset] remove getegg1
execute @a[tag=reset] ~ ~ ~ tag @s[tag=reset] remove getegg2
execute @a[tag=reset] ~ ~ ~ tag @s[tag=reset] remove getegg3
execute @a[tag=reset] ~ ~ ~ tag @s[tag=reset] remove getegg4
execute @a[tag=reset] ~ ~ ~ tag @s[tag=reset] remove getegg5
execute @a[tag=reset] ~ ~ ~ tag @s[tag=reset] remove nogm
execute @a[tag=reset] ~ ~ ~ tag @s[tag=reset] remove closeaction
...
#clear 清理玩家背包
#clear
execute @a[tag=clear] ~ ~ ~ clear @s
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.hotbar 0 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.hotbar 1 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.hotbar 2 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.hotbar 3 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.hotbar 4 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.hotbar 5 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.hotbar 6 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.hotbar 7 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.hotbar 8 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 0 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 1 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 2 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 3 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 4 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 5 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 6 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 7 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 8 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 9 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 10 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 11 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 12 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 13 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 14 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 15 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 16 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 17 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 18 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 19 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 20 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 21 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 22 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 23 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 24 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 25 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.inventory 26 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 0 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 1 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 2 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 3 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 4 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 5 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 6 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 7 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 8 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 9 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 10 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 11 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 12 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 13 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 14 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 15 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 16 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 17 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 18 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 19 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 20 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 21 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 22 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 23 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 24 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 25 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.enderchest 26 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.armor.chest 0 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.armor.feet 0 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.armor.head 0 air
execute @a[tag=clear] ~ ~ ~ replaceitem entity @s slot.armor.legs 0 air
execute @a[tag=clear] ~ ~ ~ tellraw @s[scores={language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f清包执行成功！已清除您的所有物品。"}]}
execute @a[tag=clear] ~ ~ ~ tellraw @s[scores={language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fClear package successfully executed! All your items have been cleared."}]}
execute @a[tag=clear] ~ ~ ~ tellraw @s[scores={language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f清包執行成功！已清除您的所有物品。"}]}
execute @a[tag=clear] ~ ~ ~ tellraw @s[scores={language=3}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fリュックサッククリア実行成功！すべてのアイテムをクリアしました。"}]}
execute @a[tag=clear] ~ ~ ~ tag @s remove clear
#答案之书 answer
...
#关闭字幕条
execute @a[scores={temp=70},tag=!closeaction] ~ ~ ~ scoreboard players set @s temp 71
execute @a[scores={temp=70},tag=closeaction] ~ ~ ~ scoreboard players set @s temp 72
execute @a[scores={temp=71}] ~ ~ ~ tag @s add closeaction
execute @a[scores={temp=71}] ~ ~ ~ tellraw @s[scores={language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f已关闭游戏提示。之后将不会在您游戏过程中发送提示文案。"}]}
execute @a[scores={temp=71}] ~ ~ ~ tellraw @s[scores={language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fGame prompt has been turned off. The prompt copy will not be sent during your play."}]}
execute @a[scores={temp=71}] ~ ~ ~ tellraw @s[scores={language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f已關閉遊戲提示。 之後將不會在您遊戲過程中發送提示文案。"}]}
execute @a[scores={temp=71}] ~ ~ ~ tellraw @s[scores={language=3}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fゲームをオフにしました。その后、ゲーム中に提示文案を送ることはございません。"}]}
execute @a[scores={temp=72}] ~ ~ ~ tag @s remove closeaction
execute @a[scores={temp=72}] ~ ~ ~ tellraw @s[scores={language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f已开启游戏提示。系统将会向您发送提示文案。"}]}
execute @a[scores={temp=72}] ~ ~ ~ tellraw @s[scores={language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fThe game prompt has been enabled. The system will send you a prompt copy."}]}
execute @a[scores={temp=72}] ~ ~ ~ tellraw @s[scores={language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f已開啟遊戲提示。 系統將會向您發送提示文案。"}]}
execute @a[scores={temp=72}] ~ ~ ~ tellraw @s[scores={language=3}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fゲーム案内をオンにしました。システムから提示文案をお送りします。"}]}
execute @a[scores={temp=70..72}] ~ ~ ~ scoreboard players reset @s temp