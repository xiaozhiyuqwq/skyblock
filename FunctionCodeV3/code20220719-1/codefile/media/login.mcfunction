...
#vertag数值表示标签
#请在下面填写更新年份
scoreboard players set upyear version 22
#请在下面填写更新月份
scoreboard players set upmouth version 6
#请在下面填写更新主版本
scoreboard players set mainver version 1
#请在下面填写更新子版本(分支)
scoreboard players set branchesver version 42
#请在下面填写更新标签
#2=RELEASE
#3=DEMO
#4=DEVELOP
...
#****************************************************************
#暂停其他语言支持
execute @a[scores={login=0}] ~ ~ ~ scoreboard players set @s language 0
#developer
#developerget
execute @a[scores={login=0}] ~ ~ ~ tag * remove developer
execute @a[scores={login=0}] ~ ~ ~ tag @s remove devtestfun
...
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement1 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement2 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement3 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement4 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement5 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement6 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement7 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement8 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement9 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement10 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement11 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement12 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement13 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement14 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement15 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement16 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement17 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement18 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement19 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement20 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement21 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement22 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement23 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement24 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement25 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement26 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement27 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement28 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement29 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement30 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement31 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement32 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement33 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement34 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement35 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement36 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s achievement37 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s sign_in 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s level 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s uid 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s language 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s playtime 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s task 0
execute @a[scores={login=0}] ~ ~ ~ scoreboard players add @s regtime 0
...
#登录是强制字幕条显示默认
execute @a[scores={login=0..3}] ~ ~ ~ scoreboard players set @s actionbartime 1
...
execute @a[scores={login=0}] ~ ~ ~ tag @s remove errblocktell
execute @a[scores={login=0}] ~ ~ ~ tag @s remove obnotsetell
...
execute @a[scores={language=0}] ~ ~ ~ tellraw @s[scores={login=0,language=0},tag=!admin,tag=!developer] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§l§a登录成功！ §l§3"},{"selector":"@s"},{"text":" §6["},{"score":{"name":"@s","objective":"uid"}},{"text":"] §r§f您的用户组： §l§b用户§f-§c等级"},{"score":{"name":"@s","objective":"level"}}]}
...
execute @a[scores={language=0}] ~ ~ ~ tellraw @s[scores={login=0,language=0},tag=!admin,tag=developer] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§l§a登录成功！ §l§3"},{"selector":"@s"},{"text":" §6["},{"score":{"name":"@s","objective":"uid"}},{"text":"]§r§f您的用户组： §l§b开发者§f-§c等级"},{"score":{"name":"@s","objective":"level"}}]}
execute @a[scores={language=1}] ~ ~ ~ tellraw @s[scores={login=0,language=1},tag=!admin,tag=!developer] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§l§aLogin successful! §l§3"},{"selector":"@s"},{"text":" §6["},{"score":{"name":"@s","objective":"uid"}},{"text":"] . §r§fYour user group: §l§bUser§f-§clevel_"},{"score":{"name":"@s","objective":"level"}}]}
...
execute @a[scores={language=1}] ~ ~ ~ tellraw @s[scores={login=0,language=1},tag=!admin,tag=developer] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§l§aLogin successful!  §l§3"},{"selector":"@s"},{"text":" §6["},{"score":{"name":"@s","objective":"uid"}},{"text":"] . §r§fYour user group: §l§bDeveloper§f-§clevel_"},{"score":{"name":"@s","objective":"level"}}]}
execute @a[scores={language=2}] ~ ~ ~ tellraw @s[scores={login=0,language=2},tag=!admin,tag=!developer] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§l§a登入成功！§l§3"},{"selector":"@s"},{"text":" §6["},{"score":{"name":"@s","objective":"uid"}},{"text":"] §r§f您的用戶組： §l§b用戶§f-§c"},{"score":{"name":"@s","objective":"level"}}]}
...
execute @a[scores={language=2}] ~ ~ ~ tellraw @s[scores={login=0,language=2},tag=!admin,tag=developer] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§l§a登入成功！§l§3"},{"selector":"@s"},{"text":" §6["},{"score":{"name":"@s","objective":"uid"}},{"text":"] §r§f您的用戶組： §l§b開發者§f-§c"},{"score":{"name":"@s","objective":"level"}}]}
execute @a[scores={language=3}] ~ ~ ~ tellraw @s[scores={login=0,language=0},tag=!admin,tag=!developer] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§l§aログインに成功しました! §l§3"},{"selector":"s"},{"text":" §6["},{"score":{"name":"@s","ob@jective":"uid"}},{"text":"] §r§fユーザー グループ： §l§bUser§f-§cLevel_"},{"score":{"name":"@s","objective":"level"}}]}
execute @a[scores={language=3}] ~ ~ ~ tellraw @s[scores={login=0,language=0},tag=admin] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§l§aログインに成功しました! §l§3"},{"selector":"@s"},{"text":" §6["},{"score":{"name":"@s","objective":"uid"}},{"text":"]§r§fユーザー グループ： §l§bAdmin§f-§cLevel_"},{"score":{"name":"@s","objective":"level"}}]}
execute @a[scores={language=3}] ~ ~ ~ tellraw @s[scores={login=0,language=0},tag=!admin,tag=developer] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§l§aログインに成功しました! §l§3"},{"selector":"@s"},{"text":" §6["},{"score":{"name":"@s","objective":"uid"}},{"text":"]§r§fユーザー グループ： §l§bDeveloper§f-§cLevel_"},{"score":{"name":"@s","objective":"level"}}]}
tellraw @a[scores={login=0,language=0,level=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f您好，欢迎加入游戏！§c您还没有注册账号哦~请先注册账号。"}]}
tellraw @a[scores={login=0,language=1,level=0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fHello, welcome to join the game! §cYou haven't registered your account yet. Please register your account first."}]}
tellraw @a[scores={login=0,language=2,level=0}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f您好，歡迎加入遊戲！§c您還沒有註冊帳號哦~請先註冊帳號。"}]}
tellraw @a[scores={login=0,language=3,level=0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fこんにちは、ゲームへようこそ! §cアカウントはまだ登録していません。"}]}
tellraw @a[scores={login=0,language=0,level=1..5,sign_in=0..1,uid=!40001..99999},tag=!developer] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f您好，欢迎加入游戏！§6欢迎回来！§b您今天好像还没有签到哦，签到即可获得硬币。"}]}
tellraw @a[scores={login=0,language=0,level=1..5,sign_in=0..1,uid=!40001..99999},tag=developer] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f您好，欢迎加入游戏！§6欢迎回来！§b您今天好像还没有签到哦，签到即可获得硬币。 §f尊敬的开发者 §l§b"},{"selector":"@s"},{"text":" §r§f，欢迎回来！"}]}
tellraw @a[scores={login=0,language=1,level=1..5,sign_in=0..1,uid=!40001..99999},tag=!developer] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fHello, welcome to join the game! §6welcome back! §bIt seems that you have not signed in today. You can get coin by checking in."}]}
tellraw @a[scores={login=0,language=1,level=1..5,sign_in=0..1,uid=!40001..99999},tag=developer] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fHello, welcome to join the game! §6welcome back! §bIt seems that you have not signed in today. You can get coin by checking in. Dear developer §l§b"},{"selector":"@s"},{"text":"§r§f , welcome back!"}]}
tellraw @a[scores={login=0,language=2,level=1..5,sign_in=0..1,uid=!40001..99999},tag=!developer] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f您好，歡迎加入遊戲！§6歡迎回來！§b您今天好像還沒有簽到哦，簽到即可獲得硬幣。"}]}
tellraw @a[scores={login=0,language=2,level=1..5,sign_in=0..1,uid=!40001..99999},tag=developer] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f您好，歡迎加入遊戲！§6歡迎回來！§b您今天好像還沒有簽到哦，簽到即可獲得硬幣。 尊敬的開發者 §l§b"},{"selector":"@s"},{"text":" §r§f ，歡迎回來！"}]}
tellraw @a[scores={login=0,language=3,level=1..5,sign_in=0..1,uid=!40001..99999},tag=!developer] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fこんにちは、ゲームへようこそ！ §6お帰りなさい！§b今日、あなたはコインを得るために署名していないようです。"}]}
tellraw @a[scores={login=0,language=3,level=1..5,sign_in=0..1,uid=!40001..99999},tag=developer] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fこんにちは、ゲームへようこそ！ §6お帰りなさい！§b今日、あなたはコインを得るために署名していないようです。 §f親愛なる開発者 §l§b"},{"selector":"@s"},{"text":" §r§f、お帰りなさい！"}]}
tellraw @a[scores={login=0,language=0,level=1..5,sign_in=2,uid=!40001..99999},tag=!developer] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f您好，欢迎加入游戏！§6欢迎回来！"}]}
tellraw @a[scores={login=0,language=0,level=1..5,sign_in=2,uid=!40001..99999},tag=developer] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f您好，欢迎加入游戏！§6欢迎回来！ §f尊敬的开发者 §l§b"},{"selector":"@s"},{"text":" §r§f，欢迎回来！ "}]}
tellraw @a[scores={login=0,language=1,level=1..5,sign_in=2,uid=!40001..99999},tag=!developer] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fHello, welcome to join the game! §6welcome back! "}]}
tellraw @a[scores={login=0,language=1,level=1..5,sign_in=2,uid=!40001..99999},tag=developer] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fHello, welcome to join the game! §6welcome back! Dear developer §l§b"},{"selector":"@s"},{"text":"§r§f , welcome back!"}]}
tellraw @a[scores={login=0,language=2,level=1..5,sign_in=2,uid=!40001..99999},tag=!developer] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f您好，歡迎加入遊戲！§6歡迎回來！"}]}
tellraw @a[scores={login=0,language=2,level=1..5,sign_in=2,uid=!40001..99999},tag=developer] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f您好，歡迎加入遊戲！§6歡迎回來！ 尊敬的開發者 §l§b"},{"selector":"@s"},{"text":" §r§f ，歡迎回來！"}]}
tellraw @a[scores={login=0,language=3,level=1..5,sign_in=2,uid=!40001..99999},tag=!developer] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fこんにちは、ゲームへようこそ！ §6お帰りなさい！"}]}
tellraw @a[scores={login=0,language=3,level=1..5,sign_in=2,uid=!40001..99999},tag=developer] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fこんにちは、ゲームへようこそ！ §6お帰りなさい！§b今日、あなたはコインを得るために署名していないようです。 §f親愛なる開発者 §l§b"},{"selector":"@s"},{"text":" §r§f、お帰りなさい！"}]}
tellraw @a[scores={login=0,language=0,uid=40001..99999}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f您好，欢迎加入游戏！§c无效的用户识别符参数！请联系管理员处理！"}]}
tellraw @a[scores={login=0,language=1,uid=40001..99999}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fHello, welcome to join the game! §cInvalid uid parameter! Please contact the administrator!"}]}
tellraw @a[scores={login=0,language=2,uid=40001..99999}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f您好，歡迎加入遊戲！§c無效的用戶識別符參數！請聯系管理員處理！"}]}
tellraw @a[scores={login=0,language=3,uid=40001..99999}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fこんにちは、ゲームへようこそ！ §c無効なユーザー識別子パラメーターです。 処理するために管理者に連絡してください！"}]}
scoreboard players random @a[scores={login=0..4}] logintemp 1 128
tellraw @a[scores={sign_in=0..1,login=0,hitokotolang=0,logintemp=1}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f萧萧梧叶送寒声，江上秋风动客情。"}]}
tellraw @a[scores={sign_in=0..1,login=0,hitokotolang=0,logintemp=2}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f人生得意须尽欢，莫使金樽空对月。"}]}
tellraw @a[scores={sign_in=0..1,login=0,hitokotolang=0,logintemp=3}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f忆对中秋丹桂丛，花也杯中，月也杯中。"}]}
tellraw @a[scores={sign_in=0..1,login=0,hitokotolang=0,logintemp=4}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f故乡杳无际，日暮且孤征。"}]}
tellraw @a[scores={sign_in=0..1,login=0,hitokotolang=0,logintemp=5}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f秋水明落日，流光灭远山。"}]}
tellraw @a[scores={sign_in=0..1,login=0,hitokotolang=0,logintemp=6}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f松际露微月，清光犹为君。"}]}
tellraw @a[scores={sign_in=0..1,login=0,hitokotolang=0,logintemp=7}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f萧萧落木不胜秋，莫回首、斜阳下。"}]}
tellraw @a[scores={sign_in=0..1,login=0,hitokotolang=0,logintemp=8}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f天秋木叶下，月冷莎鸡悲。"}]}
tellraw @a[scores={sign_in=0..1,login=0,hitokotolang=0,logintemp=9}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§
"}]}
tellraw @a[scores={sign_in=0..1,login=0,hitokotolang=2,logintemp=125}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f遙知兄弟登高處，遍插茱萸少一人。"}]}
tellraw @a[scores={sign_in=0..1,login=0,hitokotolang=2,logintemp=126}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f雲母屏風燭影深，長河漸落曉星沉。"}]}
tellraw @a[scores={sign_in=0..1,login=0,hitokotolang=2,logintemp=127}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f月落烏啼霜滿天，江楓漁火對愁眠。"}]}
tellraw @a[scores={sign_in=0..1,login=0,hitokotolang=2,logintemp=128}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f問渠那得清如許？為有源頭活水來。"}]}
#一言
...
#？？
execute @a[scores={login=0,language=0,version=2}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f空岛生存-服务端版本 "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" RELEASE 。祉语(xhduoduobaby) 版权所有。 http://skyblock.xiaozhiyuqwq.top"}]}
execute @a[scores={login=0,language=0,version=3}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f空岛生存-服务端版本 "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" DEMO 。祉语(xhduoduobaby) 版权所有。 http://skyblock.xiaozhiyuqwq.top"}]}
execute @a[scores={login=0,language=0,version=4}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f空岛生存-服务端版本 "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" DEVELOP 。祉语(xhduoduobaby) 版权所有。 http://skyblock.xiaozhiyuqwq.top"}]}
execute @a[scores={login=0,language=0,version=5}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f空岛生存-服务端版本 "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" SNAPSHOT 。祉语(xhduoduobaby) 版权所有。 http://skyblock.xiaozhiyuqwq.top"}]}
execute @a[scores={login=0,language=0,version=6}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f空岛生存-服务端版本 "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" ALPHA 。祉语(xhduoduobaby) 版权所有。 http://skyblock.xiaozhiyuqwq.top"}]}
execute @a[scores={login=0,language=0,version=7}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f空岛生存-服务端版本 "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" CLOSED-BETA 。祉语(xhduoduobaby) 版权所有。 http://skyblock.xiaozhiyuqwq.top"}]}
execute @a[scores={login=0,language=0,version=8}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f空岛生存-服务端版本 "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" OPEN-BETA 。祉语(xhduoduobaby) 版权所有。 http://skyblock.xiaozhiyuqwq.top"}]}
execute @a[scores={login=0,language=1,version=2}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fSkyblock For Server "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" RELEASE . Zhiyu(xhduoduobaby) All rights reserved. http://skyblock.xiaozhiyuqwq.top"}]}
execute @a[scores={login=0,language=1,version=3}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fSkyblock For Server "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" DEMO . Zhiyu(xhduoduobaby) All rights reserved. http://skyblock.xiaozhiyuqwq.top"}]}
execute @a[scores={login=0,language=1,version=4}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fSkyblock For Server "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" DEVELOP . Zhiyu(xhduoduobaby) All rights reserved. http://skyblock.xiaozhiyuqwq.top"}]}
...
execute @a[scores={login=0,language=1,version=6}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fSkyblock For Server "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" ALPHA . Zhiyu(xhduoduobaby) All rights reserved. http://skyblock.xiaozhiyuqwq.top"}]}
execute @a[scores={login=0,language=1,version=7}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fSkyblock For Server "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" CLOSED-BETA . Zhiyu(xhduoduobaby) All rights reserved. http://skyblock.xiaozhiyuqwq.top"}]}
execute @a[scores={login=0,language=1,version=8}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fSkyblock For Server "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" OPEN-BETA . Zhiyu(xhduoduobaby) All rights reserved. http://skyblock.xiaozhiyuqwq.top"}]}
execute @a[scores={login=0,language=2,version=2}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空島生存§f>>§r§f空島生存-伺服器版本 "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" RELEASE 。祉語(xhduoduobaby) 版權所有。 http://skyblock.xiaozhiyuqwq.top"}]}
...
execute @a[scores={login=0,language=2,version=6}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空島生存§f>>§r§f空島生存-伺服器版本 "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" ALPHA 。祉語(xhduoduobaby) 版權所有。 http://skyblock.xiaozhiyuqwq.top"}]}
execute @a[scores={login=0,language=2,version=7}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空島生存§f>>§r§f空島生存-伺服器版本 "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" CLOSED-BETA 。祉語(xhduoduobaby) 版權所有。 http://skyblock.xiaozhiyuqwq.top"}]}
execute @a[scores={login=0,language=2,version=8}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空島生存§f>>§r§f空島生存-伺服器版本 "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" OPEN-BETA 。祉語(xhduoduobaby) 版權所有。 http://skyblock.xiaozhiyuqwq.top"}]}
execute @a[scores={login=0,language=3,version=2}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fSkyblock For Server "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" RELEASE 。xiaozhiyuqwq 著作権所有。 http://skyblock.xiaozhiyuqwq.top"}]}
execute @a[scores={login=0,language=3,version=3}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fSkyblock For Server "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" DEMO 。xiaozhiyuqwq 著作権所有。 http://skyblock.xiaozhiyuqwq.top"}]}
execute @a[scores={login=0,language=3,version=4}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fSkyblock For Server "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" DEVELOP 。xiaozhiyuqwq 著作権所有。 http://skyblock.xiaozhiyuqwq.top"}]}
execute @a[scores={login=0,language=3,version=5}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fSkyblock For Server "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" SNAPSHOT 。xiaozhiyuqwq 著作権所有。 http://skyblock.xiaozhiyuqwq.top"}]}
execute @a[scores={login=0,language=3,version=6}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fSkyblock For Server "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" ALPHA 。xiaozhiyuqwq 著作権所有。 http://skyblock.xiaozhiyuqwq.top"}]}
execute @a[scores={login=0,language=3,version=7}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fSkyblock For Server "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" CLOSED-BETA 。xiaozhiyuqwq 著作権所有。 http://skyblock.xiaozhiyuqwq.top"}]}
execute @a[scores={login=0,language=3,version=8}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fSkyblock For Server "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" OPEN-BETA 。xiaozhiyuqwq 著作権所有。 http://skyblock.xiaozhiyuqwq.top"}]}
...
execute @a[scores={login=3,hitokotolang=0,version=6}] ~ ~ ~ titleraw @s subtitle {"rawtext":[{"text":"§f空岛生存-服务端版本 "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" ALPHA"}]}
execute @a[scores={login=3,hitokotolang=0,version=7}] ~ ~ ~ titleraw @s subtitle {"rawtext":[{"text":"§f空岛生存-服务端版本 "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" CLOSED-BETA"}]}
execute @a[scores={login=3,hitokotolang=0,version=8}] ~ ~ ~ titleraw @s subtitle {"rawtext":[{"text":"§f空岛生存-服务端版本 "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" OPEN-BETA"}]}
...
execute @a[scores={login=3,hitokotolang=1,version=6}] ~ ~ ~ titleraw @s subtitle {"rawtext":[{"text":"§fSkyblock For Server "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" ALPHA"}]}
execute @a[scores={login=3,hitokotolang=1,version=7}] ~ ~ ~ titleraw @s subtitle {"rawtext":[{"text":"§fSkyblock For Server "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" CLOSED-BETA"}]}
execute @a[scores={login=3,hitokotolang=1,version=8}] ~ ~ ~ titleraw @s subtitle {"rawtext":[{"text":"§fSkyblock For Server "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" OPEN-BETA"}]}
...
execute @a[scores={login=3,hitokotolang=2,version=6}] ~ ~ ~ titleraw @s subtitle {"rawtext":[{"text":"§f空島生存-伺服器版本 "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" ALPHA"}]}
execute @a[scores={login=3,hitokotolang=2,version=7}] ~ ~ ~ titleraw @s subtitle {"rawtext":[{"text":"§f空島生存-伺服器版本 "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" CLOSED-BETA"}]}
execute @a[scores={login=3,hitokotolang=2,version=8}] ~ ~ ~ titleraw @s subtitle {"rawtext":[{"text":"§f空島生存-伺服器版本 "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" OPEN-BETA"}]}
#Demo版本的提示
execute @a[scores={login=0,hitokotolang=0,version=3,language=0}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f当前版本为 §l§cDEMO §r§f版本，§l§e仅供系统或部分系统演示使用。§r§f此版本版本不代表最终效果。"}]}
execute @a[scores={login=0,hitokotolang=0,version=3,language=1}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fThe current version is §l§cDEMO §r§fand can only be used to demonstrate the system or some systems. This version does not represent final results."}]}
execute @a[scores={login=0,hitokotolang=0,version=3,language=2}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空島生存§f>>§r§f當前版本為 §l§cDEMO§r§f 版本，§l§e僅供系統或部分系統演示使用。§r§f此版本版本不代表最終效果。"}]}
execute @a[scores={login=0,hitokotolang=0,version=3,language=3}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f現在のバージョンは§l§c DEMO §r§fバージョンであり、§l§eはシステムまたは一部のシステムのデモ用にのみ使用される。§r§fこのバージョンは、最終的な効果を表すものではない。"}]}
#开发版
execute @a[scores={login=0,hitokotolang=0,version=4,language=0}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f当前版本为 §l§cDEVELOP §r§f版本，系统内容正在开发中，将会会出现各种错误。§l§e此版本所有内容可能会在将来版本修改或移除。§r§f漏洞追踪器请访问 §7https://skyblock.xiaozhiyuqwq.top/wiki/issue§r§f 更新日志请访问 §7https://skyblock.xiaozhiyuqwq.top/wiki/update§r§f 。"}]}
execute @a[scores={login=0,hitokotolang=0,version=4,language=1}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fThe current version is §l§cDEVELOP §r§fthe system content is under development, there will be various errors. All content in this release may be modified or removed in future releases."}]}
execute @a[scores={login=0,hitokotolang=0,version=4,language=2}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空島生存§f>>§r§f當前版本為 §l§cDEVELOP §r§f版本，系統內容正在開發中，將會會出現各種錯誤。§l§e此版本所有內容可能會在將來版本修改或移除。"}]}
execute @a[scores={login=0,hitokotolang=0,version=4,language=3}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f現在のバージョンは §l§cDEVELOP §r§fバージョンで、システム内容は開発中であり、様々なエラーが発生します。§l§cこのバージョンのすべてのコンテンツは、将来のバージョンで修正または削除される可能性がある。"}]}
#快照版本
execute @a[scores={login=0,hitokotolang=0,version=5,language=0}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f当前版本为 §l§cSNAPSHOT §r§f版本，§l§e仅用于演示特定时间点系统状态。§r§f此版本版本不代表最终效果。"}]}
execute @a[scores={login=0,hitokotolang=0,version=5,language=1}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fThe current version is §l§cSNAPSHOT§r§f and is only used to demonstrate the system status at a specific point in time. This version does not represent final results."}]}
execute @a[scores={login=0,hitokotolang=0,version=5,language=2}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空島生存§f>>§r§f當前版本為 §l§cSNAPSHOT §r§f版本，§l§e僅用於演示特定時間點系統狀態。 §r§f此版本版本不代表最終效果。"}]}
execute @a[scores={login=0,hitokotolang=0,version=5,language=3}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f現在のバージョンは §l§cSNAPSHOT§r§f バージョンであり、§l§e特定の時点におけるシステム状態を示すためにのみ使用される。§r§fこのバージョンは、最終的な効果を表すものではない。"}]}
#a测版本
execute @a[scores={login=0,hitokotolang=0,version=6,language=0}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f当前版本为 §l§cALPHA §r§f版本，§l§e开发测试阶段，系统不稳定，请及时上报漏洞。§r§f漏洞追踪器请访问 §7https://skyblock.xiaozhiyuqwq.top/wiki/issue§r§f 更新日志请访问 §7https://skyblock.xiaozhiyuqwq.top/wiki/update§r§f 。 "}]}
execute @a[scores={login=0,hitokotolang=0,version=6,language=1}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fThe current version is §l§cALPHA§r§f. The system is unstable in the development and testing stage. Please report the vulnerability in time."}]}
execute @a[scores={login=0,hitokotolang=0,version=6,language=2}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空島生存§f>>§r§f當前版本為 §l§cALPHA §r§f版本，§l§e開發測試階段，系統不穩定，請及時上報漏洞。"}]}
execute @a[scores={login=0,hitokotolang=0,version=6,language=3}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f現在のバージョンは§l§cALPHA§r§fバージョン、§l§e開発テスト段階で、システムが不安定なので、タイムリーにバグを報告してください。"}]}
#cd测版本
execute @a[scores={login=0,hitokotolang=0,version=7,language=0}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f当前版本为 §l§cCLOSED-BETA §r§f版本，此版本版本不代表最终效果。"}]}
execute @a[scores={login=0,hitokotolang=0,version=7,language=1}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fThe current version is §l§cclosed-beta §r§f. This version does not represent the final version."}]}
execute @a[scores={login=0,hitokotolang=0,version=7,language=2}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§e空島生存§f>>§r§f當前版本為§l§cCLOSED-BETA§r§f版本，此版本版本不代表最終效果。"}]}
execute @a[scores={login=0,hitokotolang=0,version=7,language=3}] ~ ~ ~ tellraw @s {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f現在のバージョンは §l§cCLOSED-BETA§r§f バージョンであり、このバージョンは最終効果を表すものではない。"}]}
...
#游戏模式设置
execute @a[scores={login=3}] ~ ~ ~ tag @a[m=creative] add creative
execute @a[scores={login=3}] ~ ~ ~ tag @a[m=survival] add survival
execute @a[scores={login=3}] ~ ~ ~ tag @a[m=adventure] add adventure
#单方块玩法字幕条恢复
execute @a[scores={login=0..1}] ~ ~ ~ scoreboard players set @s obtitletime 601
execute @a[scores={login=0..1}] ~ ~ ~ scoreboard players set @s actionbar 50