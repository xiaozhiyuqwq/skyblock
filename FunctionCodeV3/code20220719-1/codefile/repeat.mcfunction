...
execute @a[scores={temp=1100..1102}] ~ ~ ~ function media/tp
#achievement/repeat
...
execute @a[c=1] ~ ~ ~ execute @e[scores={typeid=128,tick=50..},type=armor_stand,tag=!tick1] ~ ~ ~ function media/egg
execute @a[c=1] ~ ~ ~ execute @e[scores={typeid=128,tick=50..},type=armor_stand,tag=!tick1] ~ ~ ~ function login
execute @a[c=1] ~ ~ ~ execute @e[scores={typeid=128,tick=50..},type=armor_stand,tag=!tick1] ~ ~ ~ execute @a[scores={softbantime=1..}] ~ ~ ~ function media/ban/softbantype
execute @a[c=1] ~ ~ ~ execute @e[scores={typeid=128,tick=50..},type=armor_stand,tag=!tick1] ~ ~ ~ execute @a[tag=softban] ~ ~ ~ function media/ban/softbantype
execute @a[c=1] ~ ~ ~ execute @e[scores={typeid=128,tick=50..},type=armor_stand,tag=!tick1] ~ ~ ~ tag @s add tick1
execute @a[c=1] ~ ~ ~ execute @e[scores={typeid=128,tick=100..},type=armor_stand,tag=!tick2] ~ ~ ~ function media/ban/runban
...
execute @a[c=1] ~ ~ ~ execute @e[scores={typeid=128,tick=100..},type=armor_stand,tag=!tick2] ~ ~ ~ function login
...
execute @a[c=1] ~ ~ ~ execute @e[scores={typeid=128,tick=150..},type=armor_stand,tag=!tick3] ~ ~ ~ function media/egg
execute @a[c=1] ~ ~ ~ execute @e[scores={typeid=128,tick=150..},type=armor_stand,tag=!tick3] ~ ~ ~ function login
execute @a[c=1] ~ ~ ~ execute @e[scores={typeid=128,tick=150..},type=armor_stand,tag=!tick3] ~ ~ ~ tag @s add tick3
execute @a[c=1] ~ ~ ~ execute @e[scores={typeid=128,tick=200..},type=armor_stand] ~ ~ ~ function media/ban/runban
...
execute @a[c=1] ~ ~ ~ execute @e[scores={typeid=128,tick=200..},type=armor_stand] ~ ~ ~ function function login
...
#min reset自动执行
#自动执行min
execute @e[scores={typeid=128},type=armor_stand] ~ ~ ~ scoreboard players add @s systemmin 1
execute @e[scores={typeid=128,systemmin=1200..},type=armor_stand] ~ ~ ~ function min
execute @e[scores={typeid=128,systemmin=1200..},type=armor_stand] ~ ~ ~ scoreboard players add @s systemreset 1
execute @e[scores={typeid=128,systemmin=1200..},type=armor_stand] ~ ~ ~ scoreboard players set @s systemmin 0
#自动刷新日期
execute @e[scores={typeid=128,systemreset=1440..},type=armor_stand] ~ ~ ~ function reset
execute @e[scores={typeid=128,systemreset=1440..},type=armor_stand] ~ ~ ~ scoreboard players set @s systemreset 0
#触发检测重复执行
execute @a[scores={islandruns=0..},c=1] ~ ~ ~ function media/ban/runban
#文本显示actionbar
#玩家刷新
...
execute @a[tag=answer,c=1] ~ ~ ~ function media/interaction
#岩浆恢复
execute @a[c=1] ~ ~ ~ detect ~ ~-3 ~ obsidian 0 execute @s ~ ~ ~ detect ~ ~-2 ~ cobblestone 0 execute @s ~ ~ ~ detect ~ ~-1 ~ air 0 function media/lava
#单方块数据字幕时间计算
execute @a[scores={actionbar=48}] ~ ~ ~ scoreboard players add @s obtitletime 1
#关闭字幕
execute @a[scores={temp=70},c=1] ~ ~ ~ function media/interaction