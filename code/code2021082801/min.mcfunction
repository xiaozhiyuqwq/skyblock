...
execute @r[tag=changegamerule,c=2] ~ ~ ~ scoreboard players add gamerulescore uidafter 2
...
#PVP破坏修改
#开(15%)
execute @e[type=armor_stand,scores={typeid=128,uidafter=1061..1080},tag=!changerule-5] ~ ~ ~ tag @s add gamerule-pvp
execute @e[type=armor_stand,scores={typeid=128,uidafter=1061..1080},tag=!changerule-5] ~ ~ ~ tellraw @a[scores={language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f游戏规则已修改！游戏规则 [§b误伤§f] 当前的状态 [§a开启§l+§r§f]。"}]}
execute @e[type=armor_stand,scores={typeid=128,uidafter=1061..1080},tag=!changerule-5] ~ ~ ~ titleraw @a[scores={login=4}] title {"rawtext":[{"text":"§l"}]}
execute @e[type=armor_stand,scores={typeid=128,uidafter=1061..1080},tag=!changerule-5] ~ ~ ~ titleraw @a[scores={login=4,language=0}] subtitle {"rawtext":[{"text":"§f游戏规则 [§b误伤§f] 当前的状态 [§a开启§l+§r§f]"}]}
execute @e[type=armor_stand,scores={typeid=128,uidafter=1061..1080},tag=!changerule-5] ~ ~ ~ tag @s add changerule-5
execute @e[type=armor_stand,scores={typeid=128},tag=gamerule-pvp] ~ ~ ~ gamerule pvp true
execute @e[type=armor_stand,scores={typeid=128,uidafter=1061..1080},tag=changerule-5] ~ ~ ~ scoreboard players set gamerule uidafter 240
#关(10%)
#永夜破坏修改
#开(5%)
execute @e[type=armor_stand,scores={typeid=128,uidafter=1081..1100}] ~ ~ ~ 
#关(15%)
...
execute @e[type=armor_stand,scores={typeid=128,uidafter=1001..1015}] ~ ~ ~ tag @s remove changerule-3
execute @e[type=armor_stand,scores={typeid=128,uidafter=1001..1015}] ~ ~ ~ tag @s remove changerule-4
execute @e[type=armor_stand,scores={typeid=128,uidafter=1001..1015}] ~ ~ ~ tag @s remove changerule-5




execute @e[type=armor_stand,scores={typeid=128,uidafter=1016..1030}] ~ ~ ~ tag @s remove changerule-1
execute @e[type=armor_stand,scores={typeid=128,uidafter=1016..1030}] ~ ~ ~ tag @s remove changerule-3
execute @e[type=armor_stand,scores={typeid=128,uidafter=1016..1030}] ~ ~ ~ tag @s remove changerule-4
execute @e[type=armor_stand,scores={typeid=128,uidafter=1016..1030}] ~ ~ ~ tag @s remove changerule-5




execute @e[type=armor_stand,scores={typeid=128,uidafter=1031..1045}] ~ ~ ~ tag @s remove changerule-1
execute @e[type=armor_stand,scores={typeid=128,uidafter=1031..1045}] ~ ~ ~ tag @s remove changerule-2
execute @e[type=armor_stand,scores={typeid=128,uidafter=1031..1045}] ~ ~ ~ tag @s remove changerule-4
execute @e[type=armor_stand,scores={typeid=128,uidafter=1031..1045}] ~ ~ ~ tag @s remove changerule-5



execute @e[type=armor_stand,scores={typeid=128,uidafter=1046..1060}] ~ ~ ~ tag @s remove changerule-1
execute @e[type=armor_stand,scores={typeid=128,uidafter=1046..1060}] ~ ~ ~ tag @s remove changerule-2
execute @e[type=armor_stand,scores={typeid=128,uidafter=1046..1060}] ~ ~ ~ tag @s remove changerule-3
execute @e[type=armor_stand,scores={typeid=128,uidafter=1046..1060}] ~ ~ ~ tag @s remove changerule-5


execute @e[type=armor_stand,scores={typeid=128,uidafter=1061..1080}] ~ ~ ~ tag @s remove changerule-1
execute @e[type=armor_stand,scores={typeid=128,uidafter=1061..1080}] ~ ~ ~ tag @s remove changerule-2
execute @e[type=armor_stand,scores={typeid=128,uidafter=1061..1080}] ~ ~ ~ tag @s remove changerule-3
execute @e[type=armor_stand,scores={typeid=128,uidafter=1061..1080}] ~ ~ ~ tag @s remove changerule-4
