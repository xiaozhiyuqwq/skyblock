...
#文本4-任务
#任务提示-language=0
execute @a[scores={actionbartime=226..300,level=!0,language=0,actionbar=50,task=1}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§e任务未开放 §f更新日志 https://www.wolai.com/xiaozhiyuqwq/7JxnfASAXj13ZbYUiBTttB"}]}
...
#任务提示-language=1
execute @a[scores={actionbartime=226..300,level=!0,language=1,actionbar=50,task=1}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§e任务未开放 §f更新日志 https://www.wolai.com/xiaozhiyuqwq/7JxnfASAXj13ZbYUiBTttB"}]}
...
#任务提示-language=2
execute @a[scores={actionbartime=226..300,level=!0,language=2,actionbar=50,task=1}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§e任务未开放 §f更新日志 https://www.wolai.com/xiaozhiyuqwq/7JxnfASAXj13ZbYUiBTttB"}]}
...
#任务提示-language=3
execute @a[scores={actionbartime=226..300,level=!0,language=3,actionbar=50,task=1}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§e任务未开放 §f更新日志 https://www.wolai.com/xiaozhiyuqwq/7JxnfASAXj13ZbYUiBTttB"}]}
