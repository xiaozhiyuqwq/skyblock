...
#原版的刷新
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=100..110},c=1] ~ ~ ~ fill ~-1 62 ~-1 ~4 61 ~4 stone 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=100..110},c=1] ~ ~ ~ fill ~-1 63 ~-1 ~4 63 ~4 grass 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=100..110},c=1] ~ ~ ~ fill ~2 61 ~2 ~4 63 ~4 air 0
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=100..110},c=1] ~ ~ ~ setblock ~ 63 ~ bedrock
