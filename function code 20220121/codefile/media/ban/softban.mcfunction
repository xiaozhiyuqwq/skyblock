...
scoreboard players reset @a[tag=developer,scores={softbantime=1..2147483646},tag=developersoftban] bantime
tag @a[tag=developer,tag=ban,tag=developersoftban] remove ban
