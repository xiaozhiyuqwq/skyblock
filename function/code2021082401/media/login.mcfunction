...
#彩蛋
execute @a[scores={login=0..1}] ~ ~ ~ scoreboard players add @s stinger 0
execute @a[scores={login=0..1,scores={stinger=0},tag=stinger] ~ ~ ~ tag @s remove stinger
execute @a[scores={login=0..1,scores={stinger=0},tag=!stinger] ~ ~ ~ scoreboard players add @s stinger 1
