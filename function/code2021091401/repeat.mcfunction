...
#减少卡顿分步执行
execute @e[scores={typeid=128},type=armor_stand] ~ ~ ~ scoreboard players add @s tick 1
...
execute @e[scores={typeid=128,tick=200..},type=armor_stand] ~ ~ ~ function function media/islandbarrier/runban
execute @e[scores={typeid=128,tick=200..},type=armor_stand] ~ ~ ~ function function media/contraband
execute @e[scores={typeid=128,tick=200..},type=armor_stand] ~ ~ ~ function function media/ob/other
execute @e[scores={typeid=128,tick=200..},type=armor_stand] ~ ~ ~ function function media/devtool/getinfo
execute @e[scores={typeid=128,tick=200..},type=armor_stand] ~ ~ ~ function function media/islandbarrier/islandbarrier
