...
#文本7 - 广告2
execute @a[scores={actionbartime=451..525,language=0,level=!0,actionbar=50,actionbartext=201}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f未闻花香，但识花香，再遇花时，泪已千行。"}]}
...
execute @a[scores={actionbartime=451..525,language=2,level=!0,actionbar=50,actionbartext=201}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f未聞花香，但識花香，再遇花時，淚已千行。"}]}
