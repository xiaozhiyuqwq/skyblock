...
tellraw @a[scores={login=0,language=0,level=1..5,sign_in=2,uid=!40001..99999},tag=developer] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§f您好，欢迎加入游戏！§6欢迎回来！ §f尊敬的开发者 §l§b"},{"selector":"@s"},{"text":" §r§f，欢迎回来！ 盛夏的雨过后，青空映照而过，仿如一体浑然天生。小小的你轻轻摇曳，在我的面前，却默然不语......"}]}
...
tellraw @a[scores={login=0,language=2,level=1..5,sign_in=2,uid=!40001..99999},tag=developer] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§f您好，歡迎加入遊戲！§6歡迎回來！ 尊敬的開發者 §l§b"},{"selector":"@s"},{"text":" §r§f ，歡迎回來！ 盛夏的雨過後，青空映照而過，仿如一體渾然天生。小小的你輕輕搖曳，在我的面前，卻默然不語……"}]}
