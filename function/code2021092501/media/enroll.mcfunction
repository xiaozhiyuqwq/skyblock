...
execute @a[tag=receiveitem] ~ ~ ~ scoreboard players set @a[tag=devreceive] coin 99999999
#task
scoreboard players add @a[tag=receiveitem] task 0
scoreboard players set @a[scores={task=0,level=!0},tag=receiveitem] task 1
