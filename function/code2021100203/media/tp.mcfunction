...
#提示
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @s[scores={tptype=1,temp=1101,language=0,x=!0,z=!0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§6传送成功！§b开始生存吧！ §f检索方式 §6用户识别符 §f检索。当前岛屿识别符 §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f。"}]}
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @s[scores={tptype=2,temp=1101,language=0,x=!0,z=!0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§6传送成功！§b开始生存吧！ §f检索方式 §1队伍识别符 §f检索。当前岛屿识别符 §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f。"}]}
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @s[scores={tptype=3,temp=1101,language=0,x=!0,z=!0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§6传送成功！§b开始生存吧！ §f检索方式 §a公会识别符 §f检索。当前岛屿识别符 §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f。"}]}
...
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @s[scores={tptype=5,temp=1101,language=0,x=!0,z=!0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§6传送成功！§b开始生存吧！ §f检索方式 §d派对识别符 §f检索。当前岛屿识别符 §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f。"}]}
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @s[scores={tptype=1,temp=1101,language=1,x=!0,z=!0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§6Transfer successful! §bSurvive in the desolate sky island! §fRetrieval method §6UID .Current Island ID §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f."}]}
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @s[scores={tptype=2,temp=1101,language=1,x=!0,z=!0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§6Transfer successful! §bSurvive in the desolate sky island! §fRetrieval method §1ID .Current Island ID §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f."}]}
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @s[scores={tptype=3,temp=1101,language=1,x=!0,z=!0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§6Transfer successful! §bSurvive in the desolate sky island! §fRetrieval method §aGuild .Current Island ID §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f."}]}
...
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @s[scores={tptype=5,temp=1101,language=1,x=!0,z=!0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§6Transfer successful! §bSurvive in the desolate sky island! §fRetrieval method §dParty .Current Island ID §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f."}]}
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @s[scores={tptype=1,temp=1101,language=2,x=!0,z=!0}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§6傳送成功！§b開始生存吧！ §f檢索方式 §6用戶識別符 §f檢索。當前島嶼識別符 §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f。"}]}
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @s[scores={tptype=2,temp=1101,language=2,x=!0,z=!0}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§6傳送成功！§b開始生存吧！ §f檢索方式 §1隊伍識別符 §f檢索。當前島嶼識別符 §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f。"}]}
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @s[scores={tptype=3,temp=1101,language=2,x=!0,z=!0}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§6傳送成功！§b開始生存吧！ §f檢索方式 §a公會識別符 §f檢索。當前島嶼識別符 §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f。"}]}
...
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @s[scores={tptype=5,temp=1101,language=2,x=!0,z=!0}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§6傳送成功！§b開始生存吧！ §f檢索方式 §d派對識別符 §f檢索。當前島嶼識別符 §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f。"}]}
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @s[scores={tptype=1,temp=1101,language=3,x=!0,z=!0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§6転送成功！§bSkyblockで開拓しましょう。 §f検索モード §6UID §f検索。現在の島ID §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f。"}]}
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @s[scores={tptype=2,temp=1101,language=3,x=!0,z=!0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§6転送成功！§bSkyblockで開拓しましょう。 §f検索モード §1ID §f検索。現在の島ID §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f。"}]}
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @s[scores={tptype=3,temp=1101,language=3,x=!0,z=!0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§6転送成功！§bSkyblockで開拓しましょう。 §f検索モード §aGuild §f検索。現在の島ID §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f。"}]}
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @s[scores={tptype=4,temp=1101,language=3,x=!0,z=!0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§6転送成功！§bSkyblockで開拓しましょう。 §f検索モード §3Visit §f検索。現在の島ID §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f。"}]}
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @s[scores={tptype=5,temp=1101,language=3,x=!0,z=!0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§6転送成功！§bSkyblockで開拓しましょう。 §f検索モード §dParty §f検索。現在の島ID §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f。"}]}
