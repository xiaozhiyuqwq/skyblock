...
#刷新箱子进行概率计算
execute @e[type=leash_knot,tag=obset,scores={obnumber=!1,oblevel=0..100,obnumber=!0..89,obbox=0..8}] ~ ~ ~ scoreboard players random @s obblocktemp 1 1053
execute @e[type=leash_knot,tag=obset,scores={obnumber=!1,oblevel=0..100,obnumber=!0..89,obbox=9..15}] ~ ~ ~ scoreboard players random @s obblocktemp 1 1047
execute @e[type=leash_knot,tag=obset,scores={obnumber=!1,oblevel=0..100,obnumber=!0..89,obbox=16..20}] ~ ~ ~ scoreboard players random @s obblocktemp 1 1042
execute @e[type=leash_knot,tag=obset,scores={obnumber=!1,oblevel=0..100,obnumber=!0..89,obbox=21..36}] ~ ~ ~ scoreboard players random @s obblocktemp 1 1033
execute @e[type=leash_knot,tag=obset,scores={obnumber=!1,oblevel=0..100,obnumber=!0..89,obbox=37..50}] ~ ~ ~ scoreboard players random @s obblocktemp 1 1026
execute @e[type=leash_knot,tag=obset,scores={obnumber=!1,oblevel=0..100,obnumber=!0..89,obbox=51..65}] ~ ~ ~ scoreboard players random @s obblocktemp 1 1021
execute @e[type=leash_knot,tag=obset,scores={obnumber=!1,oblevel=0..100,obnumber=!0..89,obbox=56..70}] ~ ~ ~ scoreboard players random @s obblocktemp 1 1015
execute @e[type=leash_knot,tag=obset,scores={obnumber=!1,oblevel=0..100,obnumber=!0..89,obbox=71..85}] ~ ~ ~ scoreboard players random @s obblocktemp 1 1005
execute @e[type=leash_knot,tag=obset,scores={obnumber=!1,oblevel=0..100,obnumber=!0..89,obbox=85..99}] ~ ~ ~ scoreboard players random @s obblocktemp 1 1002
execute @e[type=leash_knot,tag=obset,scores={obnumber=!1,oblevel=0..100,obnumber=!0..89,obbox=100..}] ~ ~ ~ scoreboard players random @s obblocktemp 1 1000
#计算今日刷新箱子数量
...
#实体方块保护（即重力方块）
execute @e[type=leash_knot,tag=obset,tag=!obproject] ~ ~ ~ detect ~ 99 ~ structure_void 0 setblock ~ 99 ~ air
...
execute @e[type=leash_knot,tag=obset,tag=obproject] ~ ~ ~ detect ~ 99 ~ air 0 setblock ~ 99 ~ structure_void 0
#方块到 6500 刷黑曜石
...
execute @e[type=leash_knot,tag=obset,tag=errornewblock,tag=obnewcheck] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ stone 0
...
execute @e[type=leash_knot,tag=ob,scores={version=1,obegglevel=116..130},tag=obnew,tag=!obnewerror] ~ ~ ~ scoreboard players random @s oblevel 201 205
execute @e[type=leash_knot,tag=ob,scores={version=1,obegglevel=131..200},tag=obnew,tag=!obnewerror] ~ ~ ~ scoreboard players random @s obegglevel 1 3
...
execute @e[type=leash_knot,scores={version=1,oblevel=205},tag=obnew,tag=!obnewerror] ~ ~ ~ tellraw @a[x=~,y=101,z=~,scores={language=1},r=200] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fSingle block generation list has been refreshed! Current stage [§6End City§f] ."}]}
...
execute @e[type=leash_knot,scores={version=1,oblevel=205},tag=obnew,tag=!obnewerror] ~ ~ ~ tellraw @a[x=~,y=101,z=~,scores={language=3},r=200] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f一方のブロック生成リストが更新されました。現段階 [§6End City§f] 。"}]}
...
execute @e[type=leash_knot,tag=ob,scores={version=1,oblevel=1..27},tag=obnew,tag=!obnewerror] ~ ~ ~ scoreboard players random @s obleveltarget 400 900
...
execute @e[type=leash_knot,tag=ob,scores={version=1,oblevel=201..300},tag=obnew,tag=!obnewerror] ~ ~ ~ scoreboard players set @s obleveltarget 200
