...
#注册
#跑图（跨空岛）提示
execute @a ~ ~ ~ titleraw @s[scores={language=0,actionbar=30,islandruns=1..}] actionbar {"rawtext":[{"text":"§6您当前未处于检索目标岛屿，请不要加入其他岛屿范围哦。"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=1,actionbar=30,islandruns=1..}] actionbar {"rawtext":[{"text":"§6You are not currently in the search target island."}]}
execute @a ~ ~ ~ titleraw @s[scores={language=2,actionbar=30,islandruns=1..}] actionbar {"rawtext":[{"text":"§6您當前未處於檢索目標島嶼，請不要進入其他島嶼範圍。"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=3,actionbar=30,islandruns=1..}] actionbar {"rawtext":[{"text":"§6現在取得先の島にいません。他の島の範囲には入らないでください。"}]}
#单方块刷新点保护
...
#未注册
titleraw @a[scores={level=0,language=0}] actionbar {"rawtext":[{"text":"§l§f您无法进行游戏，请先注册一个账户。\n§r§f在游玩之前您需要阅读并同意我们的 §l§c用户协议\n§r§f何当共剪西窗烛，却话巴山夜雨时。"}]}
titleraw @a[scores={level=0,language=1}] actionbar {"rawtext":[{"text":"§fYou cannot play the game, please register an account first.\n§r§fYou need to read and agree to our §l§cUser Agreement §r§fbefore playing."}]}
titleraw @a[scores={level=0,language=2}] actionbar {"rawtext":[{"text":"§f§l您無法進行遊戲，請先註冊一個帳戶。\n§r§f在遊玩之前您需要閱讀並同意我們的 §l§c使用者協定\n§r§f何當共剪西窗燭，卻話巴山夜雨時。"}]}
titleraw @a[scores={level=0,language=3}] actionbar {"rawtext":[{"text":"§l§fゲームはできません。まずアカウントを登録してください。\n§r§f遊ぶ前に、私たちのユーザー契約を読んで同意する必要があります。"}]}
#删除
scoreboard players set @e[scores={typeid=128,actionbartime=25..},type=armor_stand,c=1] actionbartime 0