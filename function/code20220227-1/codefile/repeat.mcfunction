...
#clear
execute @a[tag=clear] ~ ~ ~ function media/interaction
#gamemode
...
#reset
execute @a[tag=reset] ~ ~ ~ function media/interaction
#team
#team.join (temp=8848)
...
execute @a[tag=enrollsuccess] ~ ~ ~ function media/enroll
execute @a[tag=enrollsuccess2] ~ ~ ~ function media/enroll
#检索 
...
execute @a[c=1] ~ ~ ~ execute @e[scores={typeid=128,tick=200..},type=armor_stand] ~ ~ ~ function media/devtool/getinfo
...
execute @a[tag=developer,tag=devtestfun] ~ ~ ~ function media/devtool/devtest
#文本显示actionbar
scoreboard players add @a actionbartime 1
scoreboard players set @a[scores={actionbartime=601..}] actionbartime 1
scoreboard players add @e[scores={typeid=128},type=armor_stand,c=1] actionbartime 1
execute @e[scores={typeid=128,actionbartime=25..},type=armor_stand,c=1] ~ ~ ~ function media/actionbar
...
execute @a[tag=dice] ~ ~ ~ function media/interaction
#岩浆恢复
execute @a ~ ~ ~ detect ~ ~-3 ~ obsidian 0 execute @s ~ ~ ~ detect ~ ~-2 ~ cobblestone 0 execute @s ~ ~ ~ detect ~ ~-1 ~ air 0 function media/lava