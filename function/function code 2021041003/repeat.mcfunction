...
execute @a[tag=receiveitem] ~ ~ ~ tellraw @s[tag=receiveitem,tag=developer,scores={language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§6"},{"selector":"@s"},{"text":" §f您好！您拥有开发者权限，系统已自动选择开发者注册通道。尊敬的开发者，欢迎回来！"}]}
execute @a[tag=receiveitem] ~ ~ ~ tellraw @s[tag=receiveitem,tag=developer,scores={language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§6"},{"selector":"@s"},{"text":" §fHello! You have developer rights, and the system has automatically selected the developer registration channel. Dear developers, welcome back!"}]}
execute @a[tag=receiveitem] ~ ~ ~ tellraw @s[tag=receiveitem,tag=developer,scores={language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§6"},{"selector":"@s"},{"text":" §f您好！您擁有開發者許可權，系統已自動選擇開發者注册通道。尊敬的開發者，歡迎回來！"}]}
execute @a[tag=receiveitem] ~ ~ ~ tellraw @s[tag=receiveitem,tag=developer,scores={language=3}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§6"},{"selector":"@s"},{"text":" §fこんにちは開発者権限を持っています。開発者登録のためのチャンネルは自動的に選択されました。尊敬する開発者、お帰りください。"}]}
execute @a[tag=receiveitem] ~ ~ ~ tag @s remove receiveitem
#游客注册
execute @a[scores={temp=231}] ~ ~ ~ scoreboard players set @s level 1
execute @a[scores={temp=231}] ~ ~ ~ scoreboard players set @s coin 1200
...
execute @a[scores={temp=223..224,uid=!1..40000}] ~ ~ ~ scoreboard players set uidafter uidafter 40001
#插入部分
#setposition
