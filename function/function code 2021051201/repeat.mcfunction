...
execute @a[scores={actionbartime=401..500,actionbartext=1..3},tag=!actionbartext1] ~ ~ ~ scoreboard players random @s actionbartext 101 106
...
execute @a[scores={actionbartime=501..600,actionbartext=1..3},tag=!actionbartext2] ~ ~ ~ scoreboard players random @s actionbartext 101 105
execute @a[scores={actionbartime=501..600,actionbartext=4..10},tag=!actionbartext2] ~ ~ ~ scoreboard players random @s actionbartext 201 205
