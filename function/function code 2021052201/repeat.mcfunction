...
#请在下面填写更新子版本(分支)
scoreboard players set branchesver version 1
#请在下面填写更新标签
...
execute @a[scores={actionbartime=376..450,actionbartext=1..2},tag=!actionbartext1] ~ ~ ~ scoreboard players random @s actionbartext 101 106
execute @a[scores={actionbartime=376..450,actionbartext=3..10},tag=!actionbartext1] ~ ~ ~ scoreboard players random @s actionbartext 201 205
...
execute @a[scores={actionbartime=451..525,actionbartext=3..10,language=1},tag=!actionbartext2] ~ ~ ~ scoreboard players random @s actionbartext 201 205
execute @a[scores={actionbartime=451..525,actionbartext=3..10,language=3},tag=!actionbartext2] ~ ~ ~ scoreboard players random @s actionbartext 201 205
execute @a[scores={actionbartime=451..525,actionbartext=3..10,language=0},tag=!actionbartext2] ~ ~ ~ scoreboard players random @s actionbartext 201 206
execute @a[scores={actionbartime=451..525,actionbartext=3..10,language=2},tag=!actionbartext2] ~ ~ ~ scoreboard players random @s actionbartext 201 206
...
execute @a[scores={actionbartime=451..525,actionbartext=206,language=0},tag=!actionbartext2] ~ ~ ~ scoreboard players random @s actionbartext 211 216
execute @a[scores={actionbartime=451..525,actionbartext=206,language=2},tag=!actionbartext2] ~ ~ ~ scoreboard players random @s actionbartext 211 216
...
#文本5 - 运行状态
execute @e[scoers={typeid=128},type=minecraft:armor_stand] ~ ~ ~ scoreboard players add @s actionbartime 1
execute @e[scoers={typeid=128,actionbartime=100..},type=minecraft:armor_stand,tag=!renewsystemstate] ~ ~ ~ scoreboard players operation registernum systemstate = registernum registernum
execute @e[scoers={typeid=128,actionbartime=100..},type=minecraft:armor_stand,tag=!renewsystemstate] ~ ~ ~ execute @a ~ ~ ~ scoreboard players set online systemstate 0
execute @e[scoers={typeid=128,actionbartime=100..},type=minecraft:armor_stand,tag=!renewsystemstate] ~ ~ ~ execute @a ~ ~ ~ scoreboard players add online systemstate 1
execute @e[scoers={typeid=128,actionbartime=100..},type=minecraft:armor_stand,tag=!renewsystemstate] ~ ~ ~ execute @a[tag=admin] ~ ~ ~ scoreboard players set onlineadmin systemstate 0
execute @e[scoers={typeid=128,actionbartime=100..},type=minecraft:armor_stand,tag=!renewsystemstate] ~ ~ ~ execute @a[tag=admin] ~ ~ ~ scoreboard players add onlineadmin systemstate 1
...
execute @a[scores={actionbartime=301..375,language=1,level=!0,actionbar=50,version=1}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§a[STATE] §fUsers Number[§l§6"},{"score":{"name":"registernum","objective":"systemstate"}},{"text":"§r§f] §fOnline[§l§6"},{"score":{"name":"online","objective":"systemstate"}},{"text":"§r§f] §fOnline Admin[§l§6"},{"score":{"name":"onlineadmin","objective":"systemstate"}},{"text":"§r§f] §fVersion [§l§c"},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" BETA§r§f]"}]}
execute @a[scores={actionbartime=301..375,language=1,level=!0,actionbar=50,version=2}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§a[STATE] §fUsers Number[§l§6"},{"score":{"name":"registernum","objective":"systemstate"}},{"text":"§r§f] §fOnline[§l§6"},{"score":{"name":"online","objective":"systemstate"}},{"text":"§r§f] §fOnline Admin[§l§6"},{"score":{"name":"onlineadmin","objective":"systemstate"}},{"text":"§r§f] §fVersion[§l§c"},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" RELEASE§r§f]"}]}
execute @a[scores={actionbartime=301..375,language=1,level=!0,actionbar=50,version=3}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§a[STATE] §fUsers Number[§l§6"},{"score":{"name":"registernum","objective":"systemstate"}},{"text":"§r§f] §fOnline[§l§6"},{"score":{"name":"online","objective":"systemstate"}},{"text":"§r§f] §fOnline Admin[§l§6"},{"score":{"name":"onlineadmin","objective":"systemstate"}},{"text":"§r§f] §fVersion[§l§c"},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" DEMO§r§f]"}]}
execute @a[scores={actionbartime=301..375,language=1,level=!0,actionbar=50,version=4}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§a[STATE] §fUsers Number[§l§6"},{"score":{"name":"registernum","objective":"systemstate"}},{"text":"§r§f] §fOnline[§l§6"},{"score":{"name":"online","objective":"systemstate"}},{"text":"§r§f] §fOnline Admin[§l§6"},{"score":{"name":"onlineadmin","objective":"systemstate"}},{"text":"§r§f] §fVersion[§l§c"},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" DEVELOP§r§f]"}]}
execute @a[scores={actionbartime=301..375,language=1,level=!0,actionbar=50,version=5}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§a[STATE] §fUsers Number[§l§6"},{"score":{"name":"registernum","objective":"systemstate"}},{"text":"§r§f] §fOnline[§l§6"},{"score":{"name":"online","objective":"systemstate"}},{"text":"§r§f] §fOnline Admin[§l§6"},{"score":{"name":"onlineadmin","objective":"systemstate"}},{"text":"§r§f] §fVersion[§l§c"},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" SNAPSHOT§r§f]"}]}
...
#文本7 - 广告2
execute @a[scores={actionbartime=451..525,language=0,level=!0,actionbar=50,actionbartext=201}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f水能载舟，亦能覆舟。"}]}
...
execute @a[scores={actionbartime=451..525,language=0,level=!0,actionbar=50,actionbartext=215}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f如今走过这世间，万般§b流连§f，翻过§a岁月§f不同侧脸，措不及防闯入§d你§f的笑颜。"}]}
execute @a[scores={actionbartime=451..525,language=0,level=!0,actionbar=50,actionbartext=216}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§b晚风§f吹起你鬓间的白发，§d抚平§f回忆留下的§c疤§f，你的眼中-明暗交杂-§a一笑生花§f。"}]}
...
execute @a[scores={actionbartime=451..525,language=2,level=!0,actionbar=50,actionbartext=201}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f水能載舟，亦能覆舟。"}]}
...
execute @a[scores={actionbartime=451..525,language=2,level=!0,actionbar=50,actionbartext=215}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f如今走過這世間，萬般§b流連§f，翻過§a歲月§f不同側臉，措不及防闖入§d你§f的笑顏。"}]}
execute @a[scores={actionbartime=451..525,language=2,level=!0,actionbar=50,actionbartext=216}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f晚風§f吹起你鬢間的白髮，§d撫平§f回憶留下的§c疤§f，你的眼中-明暗交雜-§a一笑生花§f。"}]}
