...
#请在下面填写更新子版本(分支)
scoreboard players set branchesver version 3
...
execute @e[scoers={typeid=128,actionbartime=100..},type=minecraft:armor_stand] ~ ~ ~ scoreboard players operation registernum systemstate = registernum registernum
execute @e[scoers={typeid=128,actionbartime=100..},type=minecraft:armor_stand] ~ ~ ~ scoreboard players set online systemstate 0
execute @e[scoers={typeid=128,actionbartime=100..},type=minecraft:armor_stand] ~ ~ ~ execute @a ~ ~ ~ scoreboard players add online systemstate 1
execute @e[scoers={typeid=128,actionbartime=100..},type=minecraft:armor_stand] ~ ~ ~ scoreboard players set onlineadmin systemstate 0
execute @e[scoers={typeid=128,actionbartime=100..},type=minecraft:armor_stand] ~ ~ ~ execute @a[tag=admin] ~ ~ ~ scoreboard players add onlineadmin systemstate 1
execute @e[scoers={typeid=128,actionbartime=100..},type=minecraft:armor_stand] ~ ~ ~ scoreboard players set @s actionbartime 0
...
execute @a[scores={actionbartime=526..600,language=0,level=!0,actionbar=50,actionbartext=205}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§fNULL"}]}
...
execute @a[scores={actionbartime=526..600,language=1,level=!0,actionbar=50,actionbartext=203}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§fNULL"}]}
...
execute @a[scores={actionbartime=526..600,language=3,level=!0,actionbar=50,actionbartext=203}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§fNULL"}]}
execute @a[scores={actionbartime=526..600,language=3,level=!0,actionbar=50,actionbartext=204}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§fNULL"}]}
execute @a[scores={actionbartime=526..600,language=3,level=!0,actionbar=50,actionbartext=205}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§fNULL"}]}
