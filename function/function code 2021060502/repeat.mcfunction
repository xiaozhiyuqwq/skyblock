...
execute @e[type=leash_knot,tag=obset] ~ ~ ~ scoreboard players random @s obblocktemp 1 100
execute @e[type=leash_knot,tag=obset] ~ ~ ~ scoreboard players random @s obtypetemp 1 100
execute @e[type=leash_knot,tag=obset,scores={obtypetemp=1..5}] ~ ~ ~ scoreboard players random @s obtypetemp 101 200
#第一阶段刷新-平原
#方块
#5%草方块 5%泥土 15%石头 5%圆石 5%橡树原木 5%橡树木头 10%橡树叶 5%沙子 5%安山岩 5%闪长岩 5%花岗岩 3%白桦原木 2%白桦木头 5%白桦树树叶 7%煤炭矿石 4%铁矿石 3%金矿石 1%红石矿石 5%沙砾 
execute @e[type=leash_knot,tag=obset,scores={obblocktemp=1..5}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ grass 0
execute @e[type=leash_knot,tag=obset,scores={obblocktemp=6..10}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ dirt 0
execute @e[type=leash_knot,tag=obset,scores={obblocktemp=11..25}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ stone 0
execute @e[type=leash_knot,tag=obset,scores={obblocktemp=26..30}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ cobblestone 0
execute @e[type=leash_knot,tag=obset,scores={obblocktemp=31..35}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ log 0
execute @e[type=leash_knot,tag=obset,scores={obblocktemp=36..40}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ wood 0
execute @e[type=leash_knot,tag=obset,scores={obblocktemp=41..50}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ leaves 0
execute @e[type=leash_knot,tag=obset,scores={obblocktemp=51..55}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ sand 0
execute @e[type=leash_knot,tag=obset,scores={obblocktemp=56..60}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ stone 1
execute @e[type=leash_knot,tag=obset,scores={obblocktemp=61..65}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ stone 2
execute @e[type=leash_knot,tag=obset,scores={obblocktemp=66..70}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ stone 3
execute @e[type=leash_knot,tag=obset,scores={obblocktemp=66..70}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ stone 3
execute @e[type=leash_knot,tag=obset,scores={obblocktemp=71..73}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ log 3
execute @e[type=leash_knot,tag=obset,scores={obblocktemp=74..75}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ wood 3
execute @e[type=leash_knot,tag=obset,scores={obblocktemp=76..80}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ leaves 3
execute @e[type=leash_knot,tag=obset,scores={obblocktemp=81..87}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ coal_ore 0
execute @e[type=leash_knot,tag=obset,scores={obblocktemp=88..91}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ iron_ore 0
execute @e[type=leash_knot,tag=obset,scores={obblocktemp=82..94}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ gold_ore 0
execute @e[type=leash_knot,tag=obset,scores={obblocktemp=95}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ redstone_ore 0
execute @e[type=leash_knot,tag=obset,scores={obblocktemp=96..100}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ gravel 0
#生物
15%骷髅 15%僵尸 20%鸡 20牛 20%羊 5%村民 5%僵尸村民
execute @e[type=leash_knot,tag=obset,scores={obtypetemp=101..115}] ~ ~ ~ detect ~ 100 ~ air 0 summon zombie ~ 102 ~
execute @e[type=leash_knot,tag=obset,scores={obtypetemp=116..130}] ~ ~ ~ detect ~ 100 ~ air 0 summon skeleton ~ 102 ~
execute @e[type=leash_knot,tag=obset,scores={obtypetemp=131..150}] ~ ~ ~ detect ~ 100 ~ air 0 summon chicken ~ 102 ~
execute @e[type=leash_knot,tag=obset,scores={obtypetemp=151..170}] ~ ~ ~ detect ~ 100 ~ air 0 summon cow ~ 102 ~
execute @e[type=leash_knot,tag=obset,scores={obtypetemp=171..190}] ~ ~ ~ detect ~ 100 ~ air 0 summon sheep ~ 102 ~
execute @e[type=leash_knot,tag=obset,scores={obtypetemp=191..195}] ~ ~ ~ detect ~ 100 ~ air 0 summon villager ~ 102 ~
execute @e[type=leash_knot,tag=obset,scores={obtypetemp=196..200}] ~ ~ ~ detect ~ 100 ~ air 0 summon zombie_villager ~ 102 ~
#生成完成
