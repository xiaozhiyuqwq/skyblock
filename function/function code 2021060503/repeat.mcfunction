...
execute @e[type=leash_knot,tag=ob,scores={version=1}] ~ ~ ~ scoreboard players add @s oblevel 0
execute @e[type=leash_knot,tag=ob,scores={version=1,oblevel=0}] ~ ~ ~ scoreboard players set @s oblevel 1
execute @e[type=leash_knot,tag=obset] ~ ~ ~ scoreboard players add @s obnumber 1
execute @e[type=leash_knot,tag=obset] ~ ~ ~ scoreboard players random @s obblocktemp 1 1000
...
execute @e[type=leash_knot,tag=obset,scores={oblevel=1,obblocktemp=601..659}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ stone 2
execute @e[type=leash_knot,tag=obset,scores={oblevel=1,obblocktemp=660..700}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ stone 3
execute @e[type=leash_knot,tag=obset,scores={oblevel=1,obblocktemp=701..739}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ log 3
execute @e[type=leash_knot,tag=obset,scores={oblevel=1,obblocktemp=740..759}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ wood 3
execute @e[type=leash_knot,tag=obset,scores={oblevel=1,obblocktemp=760..800}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ leaves 3
...
execute @e[type=leash_knot,tag=obset,scores={oblevel=1,obtypetemp=1001..1159}] ~ ~ ~ detect ~ 100 ~ air 0 summon zombie ~ 102 ~
execute @e[type=leash_knot,tag=obset,scores={oblevel=1,obtypetemp=1160..1300}] ~ ~ ~ detect ~ 100 ~ air 0 summon skeleton ~ 102 ~
execute @e[type=leash_knot,tag=obset,scores={oblevel=1,obtypetemp=1301..1500}] ~ ~ ~ detect ~ 100 ~ air 0 summon chicken ~ 102 ~
execute @e[type=leash_knot,tag=obset,scores={oblevel=1,obtypetemp=1501..1700}] ~ ~ ~ detect ~ 100 ~ air 0 summon cow ~ 102 ~
execute @e[type=leash_knot,tag=obset,scores={oblevel=1,obtypetemp=1701..1900}] ~ ~ ~ detect ~ 100 ~ air 0 summon sheep ~ 102 ~
execute @e[type=leash_knot,tag=obset,scores={oblevel=1,obtypetemp=1901..1959}] ~ ~ ~ detect ~ 100 ~ air 0 summon villager ~ 102 ~
execute @e[type=leash_knot,tag=obset,scores={oblevel=1,obtypetemp=1960..2000}] ~ ~ ~ detect ~ 100 ~ air 0 summon zombie_villager ~ 102 ~
#生成完成
execute @e[type=leash_knot,tag=obset] ~ 99 ~ tp @e[type=item,r=3] ~ 102 ~
...
execute @e[type=leash_knot,tag=ob,scores={version=1,oblevel=0..600}] ~ ~ ~ scoreboard players set @s oblevel 1
execute @e[type=leash_knot,tag=ob,scores={version=1,oblevel=601..1400}] ~ ~ ~ scoreboard players set @s oblevel 2
