...
execute @e[type=leash_knot,tag=ob,scores={version=1,obnumber=0..600}] ~ ~ ~ scoreboard players set @s oblevel 1
execute @e[type=leash_knot,tag=ob,scores={version=1,obnumber=601..1400}] ~ ~ ~ scoreboard players set @s oblevel 2
