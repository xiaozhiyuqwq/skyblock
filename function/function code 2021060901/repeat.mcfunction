...
execute @e[type=leash_knot,tag=obset,scores={oblevel=8,obblocktemp=101..250}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ stone 0
...
execute @e[type=leash_knot,tag=ob,scores={version=1},tag=obnew] ~ ~ ~ scoreboard players random @s oblevel 1 7
