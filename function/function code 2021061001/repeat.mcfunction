...
execute @e[type=leash_knot,tag=ob,scores={version=1},tag=obnew] ~ ~ ~ scoreboard players random @s oblevel 1 9
...
execute @e[type=leash_knot,tag=ob,scores={version=1,oblevel=6},tag=obnew,tag=oblevel7] ~ ~ ~ tag @s add obnewerror
