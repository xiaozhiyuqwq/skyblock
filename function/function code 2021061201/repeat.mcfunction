...
#阶段7刷新 - 竹林
#方块
execute @e[type=leash_knot,tag=obset,scores={oblevel=7,obblocktemp=1..20}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ grass 0
execute @e[type=leash_knot,tag=obset,scores={oblevel=7,obblocktemp=21..100}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ dirt 0
...
execute @e[type=leash_knot,tag=ob,scores={version=1},tag=obnew] ~ ~ ~ scoreboard players random @s oblevel 1 11
