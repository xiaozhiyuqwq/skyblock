...
execute @e[type=leash_knot,tag=obset,scores={oblevel=12,obblocktemp=696..700}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ stained_hardened_clay 15
execute @e[type=leash_knot,tag=obset,scores={oblevel=12,obblocktemp=701..750}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ copper_ore 0
...
execute @e[type=leash_knot,tag=ob,scores={version=1},tag=obnew] ~ ~ ~ scoreboard players random @s oblevel 1 12
