...
execute @a[tag=admin,tag=git] ~ ~ ~ tellraw @s[scores={language=0},tag=admin] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§a[地址源：CODING] §bhttps://e.coding.net/xiaozhiyuqwq/skyblock/skyblock.git"}]}
...
execute @a[tag=admin,tag=git] ~ ~ ~ tellraw @s[scores={language=1},tag=admin] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§a[Address Source : CODING] §bhttps://e.coding.net/xiaozhiyuqwq/skyblock/skyblock.git"}]}
...
execute @a[tag=admin,tag=git] ~ ~ ~ tellraw @s[scores={language=2},tag=admin] {"rawtext":[{"text":"§l§e空島生存§f>>§r§a[地址源：CODING] §bhttps://e.coding.net/xiaozhiyuqwq/skyblock/skyblock.git"}]}
...
execute @a[tag=admin,tag=git] ~ ~ ~ tellraw @s[scores={language=3},tag=admin] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§a[アドレスソース：CODING] §bhttps://e.coding.net/xiaozhiyuqwq/skyblock/skyblock.git "}]}
...
execute @e[type=leash_knot,tag=ob,scores={version=1},tag=obnew] ~ ~ ~ tag @s remove oblevel6
execute @e[type=leash_knot,tag=ob,scores={version=1},tag=obnew] ~ ~ ~ tag @s remove oblevel7
execute @e[type=leash_knot,tag=ob,scores={version=1},tag=obnew] ~ ~ ~ tag @s remove oblevel8
execute @e[type=leash_knot,tag=ob,scores={version=1},tag=obnew] ~ ~ ~ tag @s remove oblevel9
execute @e[type=leash_knot,tag=ob,scores={version=1},tag=obnew] ~ ~ ~ tag @s remove oblevel10
execute @e[type=leash_knot,tag=ob,scores={version=1},tag=obnew] ~ ~ ~ tag @s remove oblevel11
execute @e[type=leash_knot,tag=ob,scores={version=1},tag=obnew] ~ ~ ~ tag @s remove oblevel12
execute @e[type=leash_knot,tag=ob,scores={version=1},tag=obnew] ~ ~ ~ tag @s remove oblevel13
