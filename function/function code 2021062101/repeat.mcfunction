...
execute @e[scores={version=2,typeid=128},type=minecraft:armor_stand] ~ ~ ~ tellraw @a[scores={language=2},tag=owner] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f同時，在您使用項目的時候，也必須要遵守來自MOJANG團隊所制訂的[MINECRAFT使用者授權合約]，該協定您可以訪問MOJANG團隊官方網站（https://account.mojang.com/documents/minecraft_eula）或者是訪問NULL査詢。"}]}
...
execute @a[tag=admin,tag=git] ~ ~ ~ tellraw @s[scores={language=0},tag=admin] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f4.使用命令 cd 设置仓库本地位置([cd]命令语法：cd <路径> ，举例：设置目录至D盘xiaozhiyuqwq文件夹下： cd d:/xiaozhiyuqwq )。请注意，本地位置根目录下不可用任何文件。"}]}
...
execute @a[tag=admin,tag=git] ~ ~ ~ tellraw @s[scores={language=1},tag=admin] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f4. Uses the command cd to set the warehouse local location ([cd] command syntax: cd <path>, for example: set the directory to the D disk xiaozhiyuqwq folder: cd d:/xiaozhiyuqwq). Note that no files are not available under the local location root."}]}
...
execute @a[tag=admin,tag=git] ~ ~ ~ tellraw @s[scores={language=2},tag=admin] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f4.使用命令 cd 設置倉庫本地位置([cd]命令語法：cd <路徑> ，舉例：設置目錄至D盤xiaozhiyuqwq文件夾下： cd d:/xiaozhiyuqwq )。請注意，本地位置根目錄下不可用任何文件。"}]}
...
execute @a[tag=admin,tag=git] ~ ~ ~ tellraw @s[scores={language=3},tag=admin] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f4.コマンド cd を使用してウェアハウスのローカル位置を設定します（[cd]コマンド構文:cd<パス>。例:Dディスクxiaozhiyuqwqフォルダにディレクトリを設定:cd d:/xiaozhiyuqwq）。 ローカルのルートディレクトリではファイルを使用できないことに注意してください。 "}]}
...
execute @a[scores={actionbartime=451..525,language=0,level=!0,actionbar=50,actionbartext=204}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f果然有时候表白了连朋友也做不了了呢……"}]}
...
execute @a[scores={actionbartime=451..525,language=2,level=!0,actionbar=50,actionbartext=204}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f果然有時候表白了連朋友也做不了了呢……"}]}
...
#方块
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obblocktemp=1..50,obnumber=!0..30}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ grass 0
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obblocktemp=51..100,obnumber=!0..30}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ dirt 0
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obblocktemp=101..200,obnumber=!0..30}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ stone 0
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obblocktemp=201..300,obnumber=!0..30}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ cobblestone 0
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obblocktemp=301..350,obnumber=!0..30}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ log 0
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obblocktemp=351..400,obnumber=!0..30}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ leaves 0
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obblocktemp=401..450,obnumber=!0..30}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ log 3
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obblocktemp=451..500,obnumber=!0..30}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ leaves 3
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obblocktemp=501..550,obnumber=!0..30}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ log2 1
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obblocktemp=551..600,obnumber=!0..30}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ leaves2 1
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obblocktemp=601..650,obnumber=!0..30}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ sand 0
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obblocktemp=651..700,obnumber=!0..30}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ stone 1
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obblocktemp=701..750,obnumber=!0..30}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ stone 3
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obblocktemp=751..800,obnumber=!0..30}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ stone 5
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obblocktemp=801..850,obnumber=!0..30}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ coal_ore 0
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obblocktemp=851..900,obnumber=!0..30}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ iron_ore 0
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obblocktemp=901..930,obnumber=!0..30}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ gold_ore 0
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obblocktemp=931..950,obnumber=!0..30}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ diamond_ore 0
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obblocktemp=951..1000,obnumber=!0..30}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ gravel 0
#生物
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obtypetemp=1001..1250,obnumber=!0..30}] ~ ~ ~ summon chicken ~ 102 ~
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obtypetemp=1251..1500,obnumber=!0..30}] ~ ~ ~ summon cow ~ 102 ~
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obtypetemp=1501..1750,obnumber=!0..30}] ~ ~ ~ summon sheep ~ 102 ~
execute @e[type=leash_knot,tag=obset,scores={oblevel=0,obtypetemp=1751..2000,obnumber=!0..30}] ~ ~ ~ summon pig ~ 102 ~
#阶段1刷新-平原
#方块
...
execute @e[type=leash_knot,tag=ob,scores={version=1},tag=obnew] ~ ~ ~ scoreboard players random @s oblevel 1 13
...
execute @e[type=leash_knot,tag=ob,scores={version=1,oblevel=11},tag=obnew,tag=oblevel12] ~ ~ ~ tag @s add obnewerror
execute @e[type=leash_knot,tag=ob,scores={version=1,oblevel=11},tag=obnew,tag=oblevel13] ~ ~ ~ tag @s add obnewerror
...
execute @e[type=leash_knot,tag=ob,scores={version=1},tag=oblevel1,tag=oblevel2,tag=oblevel3,tag=oblevel4,tag=oblevel5,tag=oblevel6,tag=oblevel7,tag=oblevel8,tag=oblevel9,tag=oblevel10,tag=oblevel11,tag=oblevel12,tag=oblevel13] ~ ~ ~ tag @s add obchange
...
execute @e[type=leash_knot,tag=ob,scores={version=1,obnumber=30}] ~ 101 ~ titleraw @a[r=50,scores={language=0}] title {"rawtext":[{"text":"§l"}]}
execute @e[type=leash_knot,tag=ob,scores={version=1,obnumber=30}] ~ 101 ~ titleraw @a[r=50,scores={language=2}] title {"rawtext":[{"text":"§l"}]}
...
execute @e[type=leash_knot,tag=ob,scores={version=1},tag=obnew,tag=!obnewerror] ~ ~ ~ scoreboard players random @s obleveltarget 300 700
