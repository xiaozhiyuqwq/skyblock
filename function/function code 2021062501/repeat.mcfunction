...
execute @e[type=leash_knot,tag=obset,scores={obdaily=10001..},tag=obnotset] ~ 100 ~ tellraw @p[r=10,scores={language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f您今天方块挖掘数量已经到达上限了，请明天再尝试。"}]}
execute @e[type=leash_knot,tag=obset,scores={obdaily=10001..},tag=obnotset] ~ 100 ~ tellraw @p[r=10,scores={language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fYou have reached the maximum number of squares today. Please try again tomorrow."}]}
execute @e[type=leash_knot,tag=obset,scores={obdaily=10001..},tag=obnotset] ~ 100 ~ tellraw @p[r=10,scores={language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f您今天方塊挖掘數量已經到達上限了，請明天再嘗試。"}]}
execute @e[type=leash_knot,tag=obset,scores={obdaily=10001..},tag=obnotset] ~ 100 ~ tellraw @p[r=10,scores={language=3}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f今日はブロックの数が上限に達しました。明日もう一度試してみてください。"}]}
...
#实体方块保护（即重力方块）
execute @e[type=leash_knot,tag=obset] ~ ~ ~ tag @s remove obproject
...
execute @e[type=leash_knot,tag=obset,scores={oblevel=2,obblocktemp=960..1000}] ~ ~ ~ detect ~ 99 ~ air 0 setblock ~ 100 ~ tag @s add obproject
...
execute @e[type=leash_knot,tag=ob,scores={version=1},tag=obnew] ~ ~ ~ scoreboard players random @s oblevel 1 15
...
execute @e[type=leash_knot,tag=ob,scores={version=1,oblevel=14},tag=obnew,tag=oblevel15] ~ ~ ~ tag @s add obnewerror
...
execute @e[type=leash_knot,tag=ob,scores={version=1},tag=oblevel1,tag=oblevel2,tag=oblevel3,tag=oblevel4,tag=oblevel5,tag=oblevel6,tag=oblevel7,tag=oblevel8,tag=oblevel9,tag=oblevel10,tag=oblevel11,tag=oblevel12,tag=oblevel13,tag=oblevel14,tag=oblevel15] ~ ~ ~ tag @s add obchange
