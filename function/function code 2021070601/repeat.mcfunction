...
execute @e[type=leash_knot,tag=ob,scores={version=1},tag=obnew] ~ ~ ~ scoreboard players random @s oblevel 1 20
...
execute @e[type=leash_knot,tag=ob,scores={version=1},tag=oblevel1,tag=oblevel2,tag=oblevel3,tag=oblevel4,tag=oblevel5,tag=oblevel6,tag=oblevel7,tag=oblevel8,tag=oblevel9,tag=oblevel10,tag=oblevel11,tag=oblevel12,tag=oblevel13,tag=oblevel14,tag=oblevel15,tag=oblevel16,tag=oblevel17,tag=oblevel18,tag=oblevel19,tag=oblevel20] ~ ~ ~ tag @s add obchange
