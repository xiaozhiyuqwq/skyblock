...
execute @e[type=leash_knot,tag=obset,scores={oblevel=23,obblocktemp=651..750}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ soul_sand 0
...
execute @e[type=leash_knot,tag=ob,scores={version=1},tag=obnew] ~ ~ ~ tag @s[scores={oblevel=21}] add oblevel23
execute @e[type=leash_knot,tag=ob,scores={version=1},tag=obnew] ~ ~ ~ scoreboard players random @s oblevel 1 23
