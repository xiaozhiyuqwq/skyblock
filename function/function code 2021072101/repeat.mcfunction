...
execute @a[tag=pve] ~ ~ ~ summon zombie ~5 ~ ~
execute @a[tag=pve] ~ ~ ~ summon zombie ~-5 ~ ~
execute @a[tag=pve] ~ ~ ~ summon skeleton ~ ~ ~5
execute @a[tag=pve] ~ ~ ~ summon skeleton ~ ~ ~-5
execute @a[tag=pve] ~ ~ ~ summon spider ~5 ~ ~
execute @a[tag=pve] ~ ~ ~ summon spider ~-5 ~ ~
execute @a[tag=pve,scores={pve=1..10}] ~ ~ ~ summon husk ~-5 ~ ~
execute @a[tag=pve,scores={pve=1..10}] ~ ~ ~ summon husk ~5 ~ ~
execute @a[tag=pve,scores={pve=1..10}] ~ ~ ~ summon drowned ~ ~ ~5
execute @a[tag=pve,scores={pve=1..10}] ~ ~ ~ summon drowned ~ ~ ~-5
execute @a[tag=pve,scores={pve=11..20}] ~ ~ ~ summon stray ~ ~ ~-5
execute @a[tag=pve,scores={pve=11..20}] ~ ~ ~ summon stray ~ ~ ~5
execute @a[tag=pve,scores={pve=21..30}] ~ ~ ~ summon slime ~ ~ ~5
execute @a[tag=pve,scores={pve=21..30}] ~ ~ ~ summon slime ~ ~ ~-5
execute @a[tag=pve,scores={pve=21..30}] ~ ~ ~ summon slime ~-5 ~ ~
execute @a[tag=pve,scores={pve=21..30}] ~ ~ ~ summon slime ~5 ~ ~
execute @a[tag=pve,scores={pve=31..40}] ~ ~ ~ summon witch ~5 ~ ~
execute @a[tag=pve,scores={pve=31..40}] ~ ~ ~ summon witch ~-5 ~ ~
execute @a[tag=pve,scores={pve=41..50}] ~ ~ ~ summon wither_skeleton ~ ~ ~-5
execute @a[tag=pve,scores={pve=41..50}] ~ ~ ~ summon wither_skeleton ~ ~ ~5
execute @a[tag=pve,scores={pve=51..60}] ~ ~ ~ summon vindicator ~ ~ ~5
execute @a[tag=pve,scores={pve=61..70}] ~ ~ ~ summon evocation_illager ~ ~ ~-5
execute @a[tag=pve,scores={pve=71..80}] ~ ~ ~ summon magma_cube ~5 ~ ~
execute @a[tag=pve,scores={pve=71..80}] ~ ~ ~ summon magma_cube ~-5 ~ ~
execute @a[tag=pve,scores={pve=71..80}] ~ ~ ~ summon ghast ~ ~ ~5
execute @a[tag=pve,scores={pve=81..90}] ~ ~ ~ summon silverfish ~5 ~ ~
execute @a[tag=pve,scores={pve=81..90}] ~ ~ ~ summon silverfish ~-5 ~ ~
execute @a[tag=pve,scores={pve=81..90}] ~ ~ ~ summon silverfish ~ ~ ~5
execute @a[tag=pve,scores={pve=81..90}] ~ ~ ~ summon silverfish ~ ~ ~-5
execute @a[tag=pve,scores={pve=81..90}] ~ ~ ~ summon endermite ~ ~ ~-5
execute @a[tag=pve,scores={pve=81..90}] ~ ~ ~ summon endermite ~ ~ ~5
execute @a[tag=pve,scores={pve=81..90}] ~ ~ ~ summon endermite ~5 ~ ~
execute @a[tag=pve,scores={pve=81..90}] ~ ~ ~ summon endermite ~-5 ~ ~
execute @a[tag=pve,scores={pve=91..100}] ~ ~ ~ summon shulker ~-5 ~ ~
execute @a[tag=pve,scores={pve=91..100}] ~ ~ ~ summon shulker ~5 ~ ~
execute @a[tag=pve] ~ ~ ~ scoreboard players random @s[tag=pve] pve 1 100
execute @a[tag=pve,scores={pve=1..30}] ~ ~ ~ summon lightning_bolt ~ ~ ~
execute @a[tag=pve,scores={pve=1..30}] ~ ~ ~ summon lightning_bolt ~-5 ~ ~
execute @a[tag=pve,scores={pve=1..30}] ~ ~ ~ summon lightning_bolt ~5 ~ ~
execute @a[tag=pve,scores={pve=1..30}] ~ ~ ~ summon lightning_bolt ~ ~ ~5
execute @a[tag=pve,scores={pve=1..30}] ~ ~ ~ summon lightning_bolt ~ ~ ~-5
...
execute @a[tag=bolt] ~ ~ ~ summon lightning_bolt ~-5 ~ ~
execute @a[tag=bolt] ~ ~ ~ summon lightning_bolt ~5 ~ ~
execute @a[tag=bolt] ~ ~ ~ summon lightning_bolt ~ ~ ~5
execute @a[tag=bolt] ~ ~ ~ summon lightning_bolt ~ ~ ~-5
execute @a[tag=bolt] ~ ~ ~ summon creeper ~15 ~ ~
execute @a[tag=bolt] ~ ~ ~ summon creeper ~-15 ~ ~
execute @a[tag=bolt] ~ ~ ~ summon creeper ~ ~ ~15
execute @a[tag=bolt] ~ ~ ~ summon creeper ~ ~ ~-15
