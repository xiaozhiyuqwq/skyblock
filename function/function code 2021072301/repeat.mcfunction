...
execute @a[scores={temp=444}] ~ ~ ~ scoreboard players add @s[scores={temp=444,deadcoin=!0}] deadproject 1335
...
execute @a[tag=bolt,scores={bolt=99}] ~ ~ ~ give @s golden_apple 1 0
...
execute @a[tag=bolt,scores={bolt=!99..100}] ~ ~ ~ tellraw @a[scores={language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f渡劫失败......"}]}
execute @a[tag=bolt,scores={bolt=!99..100}] ~ ~ ~ tellraw @a[scores={language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fFailure in practice."}]}
execute @a[tag=bolt,scores={bolt=!99..100}] ~ ~ ~ tellraw @a[scores={language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f渡劫失敗......"}]}
execute @a[tag=bolt,scores={bolt=!99..100}] ~ ~ ~ tellraw @a[scores={language=3}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f追いはぎに負ける。"}]}
