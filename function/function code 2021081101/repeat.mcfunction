...
#计算
execute @a[scores={temp=444}] ~ ~ ~ scoreboard players random @s[scores={temp=444,level=1}] deadcoin 1 10
execute @a[scores={temp=444}] ~ ~ ~ scoreboard players random @s[scores={temp=444,level=2}] deadcoin 5 15
execute @a[scores={temp=444}] ~ ~ ~ scoreboard players random @s[scores={temp=444,level=3}] deadcoin 10 20
execute @a[scores={temp=444}] ~ ~ ~ scoreboard players random @s[scores={temp=444,level=4}] deadcoin 16 25
execute @a[scores={temp=444}] ~ ~ ~ scoreboard players random @s[scores={temp=444,level=5}] deadcoin 20 30
