...
scoreboard players set @a[scores={temp=50,about=600..,abouttext=6}] abouttext 7
execute @a[scores={temp=50,about=700..,abouttext=7}] ~ ~ ~ titleraw @s title {"rawtext":[{"text":"§6xiaozhiyuqwq"}]}
scoreboard players set @a[scores={temp=50,about=720..,abouttext=7}] abouttext 8
execute @a[scores={temp=50,about=720..,abouttext=8}] ~ ~ ~ titleraw @s title {"rawtext":[{"text":"§6HeroHerobrine26"}]}
execute @a[scores={temp=50,about=700..,abouttext=7..8,language=0}] ~ ~ ~ titleraw @s subtitle {"rawtext":[{"text":"§e空岛生存-服务端版本 §b开发组"}]}
scoreboard players set @a[scores={temp=50,about=720..,abouttext=8}] abouttext 9
...
execute @a[scores={temp=50,about=920..,abouttext=16}] ~ ~ ~ titleraw @s title {"rawtext":[{"text":"§6RNTSRNTS"}]}
execute @a[scores={temp=50,about=940..,abouttext=17}] ~ ~ ~ titleraw @s title {"rawtext":[{"text":"§6shuangtao"}]}
execute @a[scores={temp=50,about=960..,abouttext=18}] ~ ~ ~ titleraw @s title {"rawtext":[{"text":"§6tilamisu1234"}]}
...
scoreboard players set @a[scores={temp=50,about=940..,abouttext=18}] abouttext 19
execute @a[scores={temp=50,about=960..,abouttext=20}] ~ ~ ~ titleraw @s title {"rawtext":[{"text":"§b一只卑微的量筒"}]}
execute @a[scores={temp=50,about=980..,abouttext=21}] ~ ~ ~ titleraw @s title {"rawtext":[{"text":"§bAce_AR"}]}
...
execute @a[scores={temp=50,about=1000..,abouttext=22..26,language=0}] ~ ~ ~ titleraw @s subtitle {"rawtext":[{"text":"§e空岛生存-服务端版本 §b特别感谢"}]}
