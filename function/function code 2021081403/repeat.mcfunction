...
execute @a[tag=!islandruns,tag=!nosur,scores={tptype=1..3},tag=mainworld] ~ ~ ~ gamemode 0 @s[m=2]
execute @a[tag=!islandruns,tag=!nosur,scores={tptype=5},tag=mainworld] ~ ~ ~ gamemode 0 @s[m=2]
