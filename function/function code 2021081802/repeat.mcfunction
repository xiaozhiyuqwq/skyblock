...
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @a[scores={tptype=1,temp=1101,language=3,x=!0,z=!0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§6転送成功！§bSkyblockで開拓しましょう。 §f検索モード §6UID §f検索。現在の島ID §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f。"}]}
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @a[scores={tptype=2,temp=1101,language=3,x=!0,z=!0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§6転送成功！§bSkyblockで開拓しましょう。 §f検索モード §1ID §f検索。現在の島ID §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f。"}]}
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @a[scores={tptype=3,temp=1101,language=3,x=!0,z=!0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§6転送成功！§bSkyblockで開拓しましょう。 §f検索モード §aGuild §f検索。現在の島ID §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f。"}]}
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @a[scores={tptype=4,temp=1101,language=3,x=!0,z=!0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§6転送成功！§bSkyblockで開拓しましょう。 §f検索モード §3Visit §f検索。現在の島ID §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f。"}]}
execute @a[scores={temp=1101}] ~ ~ ~ tellraw @a[scores={tptype=5,temp=1101,language=3,x=!0,z=!0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§6転送成功！§bSkyblockで開拓しましょう。 §f検索モード §dParty §f検索。現在の島ID §l§e"},{"score":{"name":"@s","objective":"iduse"}},{"text":"§r§f。"}]}
...
#日志打印
execute @a[tag=developer] ~ ~ ~ tag @s add infomassage
execute @a[tag=info] ~ ~ ~ tag @s add infonow
execute @a[tag=info1] ~ ~ ~ tag @s add infonow
execute @a[tag=info2] ~ ~ ~ tag @s add infonow
execute @a[tag=info3] ~ ~ ~ tag @s add infonow
execute @a[tag=info4] ~ ~ ~ tag @s add infonow
execute @a[tag=info5] ~ ~ ~ tag @s add infonow
execute @a[tag=info6] ~ ~ ~ tag @s add infonow
execute @a[tag=info7] ~ ~ ~ tag @s add infonow
execute @a[tag=info8] ~ ~ ~ tag @s add infonow
execute @a[tag=info9] ~ ~ ~ tag @s add infonow
execute @a[tag=info10] ~ ~ ~ tag @s add infonow
execute @a[tag=info11] ~ ~ ~ tag @s add infonow
execute @a[tag=info12] ~ ~ ~ tag @s add infonow
execute @a[tag=info13] ~ ~ ~ tag @s add infonow
execute @a[tag=info14] ~ ~ ~ tag @s add infonow
execute @a[tag=info15] ~ ~ ~ tag @s add infonow
execute @a[tag=info16] ~ ~ ~ tag @s add infonow
execute @a[tag=info17] ~ ~ ~ tag @s add infonow
execute @a[tag=info18] ~ ~ ~ tag @s add infonow
execute @a[tag=info19] ~ ~ ~ tag @s add infonow
execute @a[tag=info20] ~ ~ ~ tag @s add infonow
execute @a[tag=info21] ~ ~ ~ tag @s add infonow
execute @a[tag=info22] ~ ~ ~ tag @s add infonow
execute @a[tag=info23] ~ ~ ~ tag @s add infonow
execute @a[tag=info24] ~ ~ ~ tag @s add infonow
execute @a[tag=info25] ~ ~ ~ tag @s add infonow
execute @a[tag=info26] ~ ~ ~ tag @s add infonow
execute @a[tag=info27] ~ ~ ~ tag @s add infonow
execute @a[tag=info28] ~ ~ ~ tag @s add infonow
execute @a[tag=info29] ~ ~ ~ tag @s add infonow
execute @a[tag=info30] ~ ~ ~ tag @s add infonow
execute @a[tag=info31] ~ ~ ~ tag @s add infonow
execute @a[tag=info32] ~ ~ ~ tag @s add infonow
execute @a[tag=info33] ~ ~ ~ tag @s add infonow
execute @a[tag=info34] ~ ~ ~ tag @s add infonow
execute @a[tag=info35] ~ ~ ~ tag @s add infonow
execute @a[tag=infonow] ~ ~ ~ tag @a[tag=developer] add infonow
execute @a[tag=infomassage,tag=infonow] ~ ~ ~ tellraw @s[scores={language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f系统出现了一点问题，以下内容是日志信息，请您将日志信息发送至邮箱 hi@xiaozhiyuqwq.top ，感谢您的配合！"}]}
execute @a[tag=infomassage,tag=infonow] ~ ~ ~ tellraw @s[scores={language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fThere is a problem with the system. The following is the log information. Please send the log information to hi@xiaozhiyuqwq.top , thank you for your cooperation!"}]}
execute @a[tag=infomassage,tag=infonow] ~ ~ ~ tellraw @s[scores={language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f系統出現了一點問題，以下內容是日誌資訊，請您將日誌資訊發送至郵箱hi@xiaozhiyuqwq.top，感謝您的配合！"}]}
execute @a[tag=infomassage,tag=infonow] ~ ~ ~ tellraw @s[scores={language=3}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fシステムに問題がありました。以下はログ情報です。ログ情報をメールボックスに送ってください。hi@xiaozhiyuqwq.topご協力ありがとうございます。zhiyuqwq.top ，感谢您的配合！"}]}
execute @a[tag=infomassage,tag=infonow] ~ ~ ~ tellraw @s[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r ============ "}]}
execute @a[tag=infomassage,tag=infonow] ~ ~ ~ tellraw @s[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r Log Information "}]}
execute @a[tag=infomassage,tag=infonow] ~ ~ ~ tellraw @s[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r If you are not a developer and find this message, please send it to hi@xiaozhiyuqwq.top . "}]}
execute @a[tag=infomassage,tag=infonow] ~ ~ ~ tellraw @s[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r "}]}
execute @a[tag=infomassage,tag=infonow,scores={version=1}] ~ ~ ~ tellraw @s[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r SYSTEMVERSION "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" BETA"}]}
execute @a[tag=infomassage,tag=infonow,scores={version=2}] ~ ~ ~ tellraw @s[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r SYSTEMVERSION "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" RELEASE"}]}
execute @a[tag=infomassage,tag=infonow,scores={version=3}] ~ ~ ~ tellraw @s[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r SYSTEMVERSION "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" DEMO"}]}
execute @a[tag=infomassage,tag=infonow,scores={version=4}] ~ ~ ~ tellraw @s[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r SYSTEMVERSION "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" DEVELOP"}]}
execute @a[tag=infomassage,tag=infonow,scores={version=5}] ~ ~ ~ tellraw @s[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r SYSTEMVERSION "},{"score":{"name":"upyear","objective":"version"}},{"text":"."},{"score":{"name":"upmouth","objective":"version"}},{"text":"-"},{"score":{"name":"mainver","objective":"version"}},{"text":"."},{"score":{"name":"branchesver","objective":"version"}},{"text":" SNAPSHOT"}]}
execute @a[tag=infomassage,tag=infonow] ~ ~ ~ tellraw @s[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r "}]}
execute @a[tag=info] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  UID(1)="},{"score":{"name":"@s","objective":"uid"}},{"text":"  ID(2)="},{"score":{"name":"@s","objective":"id"}},{"text":"  Guild(3)="},{"score":{"name":"@s","objective":"guild"}},{"text":"  Coins(4)="},{"score":{"name":"@s","objective":"coin"}},{"text":"  Level(5)="},{"score":{"name":"@s","objective":"level"}},{"text":"  Onlinetime(6)="},{"score":{"name":"@s","objective":"playtime"}},{"text":"  Todayonline(7)="},{"score":{"name":"@s","objective":"dailyplaytime"}},{"text":"  Temp(8)="},{"score":{"name":"@s","objective":"temp"}},{"text":"  Language(9)="},{"score":{"name":"@s","objective":"language"}},{"text":"  Registered(10)="},{"score":{"name":"@s","objective":"registernum"}},{"text":"  IDNow(11)="},{"score":{"name":"@s","objective":"iduse"}},{"text":"  Tptype(12)="},{"score":{"name":"@s","objective":"tptype"}},{"text":"  Actionbar(13)="},{"score":{"name":"@s","objective":"actionbar"}},{"text":"  Actionbartime(14)="},{"score":{"name":"@s","objective":"actionbartime"}},{"text":"  Actionbartext(15)="},{"score":{"name":"@s","objective":"actionbartext"}},{"text":"  Task(16)="},{"score":{"name":"@s","objective":"task"}},{"text":"  Visit(17)="},{"score":{"name":"@s","objective":"visit"}},{"text":"  Party(18)="},{"score":{"name":"@s","objective":"party"}},{"text":"  Oneblocknumber(19)="},{"score":{"name":"@s","objective":"obnumber"}},{"text":"  Banwarn(20)="},{"score":{"name":"@s","objective":"banwarn"}},{"text":"  Deadproject(21)="},{"score":{"name":"@s","objective":"deadproject"}},{"text":"  Hitokoto(22)="},{"score":{"name":"@s","objective":"sign_intext"}},{"text":"  achievement1(23)="},{"score":{"name":"@s","objective":"achievement1"}},{"text":"  achievement2(24)="},{"score":{"name":"@s","objective":"achievement2"}},{"text":"  achievement3(25)="},{"score":{"name":"@s","objective":"achievement3"}},{"text":"  achievement4(26)="},{"score":{"name":"@s","objective":"achievement4"}},{"text":"  achievement5(27)="},{"score":{"name":"@s","objective":"achievement5"}},{"text":"  achievement6(28)="},{"score":{"name":"@s","objective":"achievement6"}},{"text":"  achievement7(29)="},{"score":{"name":"@s","objective":"achievement7"}},{"text":"  achievement8(30)="},{"score":{"name":"@s","objective":"achievement8"}},{"text":"  achievement9(31)="},{"score":{"name":"@s","objective":"achievement9"}},{"text":"  achievement10(32)="},{"score":{"name":"@s","objective":"achievement10"}},{"text":"  achievement11(33)="},{"score":{"name":"@s","objective":"achievement11"}},{"text":"  achievement12(34)="},{"score":{"name":"@s","objective":"achievement12"}},{"text":"  achievement13(35)="},{"score":{"name":"@s","objective":"achievement13"}}]}
execute @a[tag=info] ~ ~ ~ tag @s remove info
execute @a[tag=info1] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  UID(1)="},{"score":{"name":"@s","objective":"uid"}}]}
execute @a[tag=info1] ~ ~ ~ tag @s remove info1
execute @a[tag=info2] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  ID(2)="},{"score":{"name":"@s","objective":"id"}}]}
execute @a[tag=info2] ~ ~ ~ tag @s remove info2
execute @a[tag=info3] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  Guild(3)="},{"score":{"name":"@s","objective":"guild"}}]}
execute @a[tag=info3] ~ ~ ~ tag @s remove info3
execute @a[tag=info4] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  Coins(4)="},{"score":{"name":"@s","objective":"coin"}}]}
execute @a[tag=info4] ~ ~ ~ tag @s remove info4
execute @a[tag=info5] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  Level(5)="},{"score":{"name":"@s","objective":"level"}}]}
execute @a[tag=info5] ~ ~ ~ tag @s remove info5
execute @a[tag=info6] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  Onlinetime(6)="},{"score":{"name":"@s","objective":"playtime"}}]}
execute @a[tag=info6] ~ ~ ~ tag @s remove info6
execute @a[tag=info7] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  Todayonline(7)="},{"score":{"name":"@s","objective":"dailyplaytime"}}]}
execute @a[tag=info7] ~ ~ ~ tag @s remove info7
execute @a[tag=info8] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  Temp(8)="},{"score":{"name":"@s","objective":"temp"}}]}
execute @a[tag=info8] ~ ~ ~ tag @s remove info8
execute @a[tag=info9] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  Language(9)="},{"score":{"name":"@s","objective":"language"}}]}
execute @a[tag=info9] ~ ~ ~ tag @s remove info9
execute @a[tag=info10] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  Registered(10)="},{"score":{"name":"@s","objective":"registernum"}}]}
execute @a[tag=info10] ~ ~ ~ tag @s remove info10
execute @a[tag=info11] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  IDNow(11)="},{"score":{"name":"@s","objective":"iduse"}}]}
execute @a[tag=info11] ~ ~ ~ tag @s remove info11
execute @a[tag=info12] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  Tptype(12)="},{"score":{"name":"@s","objective":"tptype"}}]}
execute @a[tag=info12] ~ ~ ~ tag @s remove info12
execute @a[tag=info13] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  Actionbar(13)="},{"score":{"name":"@s","objective":"actionbar"}}]}
execute @a[tag=info13] ~ ~ ~ tag @s remove info13
execute @a[tag=info14] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  Actionbartime(14)="},{"score":{"name":"@s","objective":"actionbartime"}}]}
execute @a[tag=info14] ~ ~ ~ tag @s remove info14
execute @a[tag=info15] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  Actionbartext(15)="},{"score":{"name":"@s","objective":"actionbartext"}}]}
execute @a[tag=info15] ~ ~ ~ tag @s remove info15
execute @a[tag=info16] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  Task(16)="},{"score":{"name":"@s","objective":"task"}}]}
execute @a[tag=info16] ~ ~ ~ tag @s remove info16
execute @a[tag=info17] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  Visit(17)="},{"score":{"name":"@s","objective":"visit"}}]}
execute @a[tag=info17] ~ ~ ~ tag @s remove info17
execute @a[tag=info18] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  Party(18)="},{"score":{"name":"@s","objective":"party"}}]}
execute @a[tag=info18] ~ ~ ~ tag @s remove info18
execute @a[tag=info19] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  Oneblocknumber(19)="},{"score":{"name":"@s","objective":"obnumber"}}]}
execute @a[tag=info19] ~ ~ ~ tag @s remove info19
execute @a[tag=info20] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  Banwarn(20)="},{"score":{"name":"@s","objective":"banwarn"}}]}
execute @a[tag=info20] ~ ~ ~ tag @s remove info20
execute @a[tag=info21] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  Deadproject(21)="},{"score":{"name":"@s","objective":"deadproject"}}]}
execute @a[tag=info21] ~ ~ ~ tag @s remove info21
execute @a[tag=info22] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  Hitokoto(22)="},{"score":{"name":"@s","objective":"sign_intext"}}]}
execute @a[tag=info22] ~ ~ ~ tag @s remove info22
execute @a[tag=info23] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  achievement1(23)="},{"score":{"name":"@s","objective":"achievement1"}}]}
execute @a[tag=info23] ~ ~ ~ tag @s remove info23
execute @a[tag=info24] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  achievement2(24)="},{"score":{"name":"@s","objective":"achievement2"}}]}
execute @a[tag=info24] ~ ~ ~ tag @s remove info24
execute @a[tag=info25] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  achievement3(25)="},{"score":{"name":"@s","objective":"achievement3"}}]}
execute @a[tag=info25] ~ ~ ~ tag @s remove info25
execute @a[tag=info26] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  achievement4(26)="},{"score":{"name":"@s","objective":"achievement4"}}]}
execute @a[tag=info26] ~ ~ ~ tag @s remove info26
execute @a[tag=info27] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  achievement5(27)="},{"score":{"name":"@s","objective":"achievement5"}}]}
execute @a[tag=info27] ~ ~ ~ tag @s remove info27
execute @a[tag=info28] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  achievement6(28)="},{"score":{"name":"@s","objective":"achievement6"}}]}
execute @a[tag=info28] ~ ~ ~ tag @s remove info28
execute @a[tag=info29] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  achievement7(29)="},{"score":{"name":"@s","objective":"achievement7"}}]}
execute @a[tag=info29] ~ ~ ~ tag @s remove info29
execute @a[tag=info30] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  achievement8(30)="},{"score":{"name":"@s","objective":"achievement8"}}]}
execute @a[tag=info30] ~ ~ ~ tag @s remove info30
execute @a[tag=info31] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  achievement9(31)="},{"score":{"name":"@s","objective":"achievement9"}}]}
execute @a[tag=info31] ~ ~ ~ tag @s remove info31
execute @a[tag=info32] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  achievement10(32)="},{"score":{"name":"@s","objective":"achievement10"}}]}
execute @a[tag=info32] ~ ~ ~ tag @s remove info32
execute @a[tag=info33] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  achievement11(33)="},{"score":{"name":"@s","objective":"achievement11"}}]}
execute @a[tag=info33] ~ ~ ~ tag @s remove info33
execute @a[tag=info34] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  achievement12(34)="},{"score":{"name":"@s","objective":"achievement12"}}]}
execute @a[tag=info34] ~ ~ ~ tag @s remove info34
execute @a[tag=info35] ~ ~ ~ tellraw @a[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r §e[INFO]§r  Playername="},{"selector":"@s"},{"text":"  achievement13(35)="},{"score":{"name":"@s","objective":"achievement13"}}]}
execute @a[tag=info35] ~ ~ ~ tag @s remove info35
execute @a[tag=infomassage,tag=infonow] ~ ~ ~ tellraw @s[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r "}]}
execute @a[tag=infomassage,tag=infonow] ~ ~ ~ tellraw @s[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r The log information is output, and there is nothing below. "}]}
execute @a[tag=infomassage,tag=infonow] ~ ~ ~ tellraw @s[tag=infomassage] {"rawtext":[{"text":"§l§6>§b>§r ============ "}]}
execute @a[tag=infonow] ~ ~ ~ tag @s remove infonow
execute @a[tag=infomassage,tag=!developer] ~ ~ ~ tag @s remove infomassage