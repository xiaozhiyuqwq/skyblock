...
execute @e[type=leash_knot,tag=obset,scores={obdaily=10001..},tag=obnotset] ~ 100 ~ tellraw @a[r=20,scores={language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f您挖掘过于频繁了啦！请耐心等待10分钟后再试。"}]}
execute @e[type=leash_knot,tag=obset,scores={obdaily=10001..},tag=obnotset] ~ 100 ~ tellraw @a[r=20,scores={language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fYour operation is too frequent. Please wait patiently for 10 minutes and try again."}]}
execute @e[type=leash_knot,tag=obset,scores={obdaily=10001..},tag=obnotset] ~ 100 ~ tellraw @a[r=20,scores={language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f您的操作過於頻繁，請耐心等待10分鐘後再試。"}]}
execute @e[type=leash_knot,tag=obset,scores={obdaily=10001..},tag=obnotset] ~ 100 ~ tellraw @a[r=20,scores={language=3}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f操作が頻繁すぎますので、10分ぐらい待ってから試してください。"}]}
...
execute @e[type=leash_knot,tag=ob,scores={version=1,obcheck=0,obcheckcredit=!0..70},tag=obset] ~ ~ ~ scoreboard players set @s obcheckcredit 70
...
execute @e[type=leash_knot,tag=ob,scores={version=1,obcheck=0,obcheckcredit=11..20},tag=obset] ~ ~ ~ scoreboard players random @s obcheck 250 300
execute @e[type=leash_knot,tag=ob,scores={version=1,obcheck=0,obcheckcredit=21..30},tag=obset] ~ ~ ~ scoreboard players random @s obcheck 200 250
execute @e[type=leash_knot,tag=ob,scores={version=1,obcheck=0,obcheckcredit=31..40},tag=obset] ~ ~ ~ scoreboard players random @s obcheck 150 200
execute @e[type=leash_knot,tag=ob,scores={version=1,obcheck=0,obcheckcredit=41..50},tag=obset] ~ ~ ~ scoreboard players random @s obcheck 100 150
execute @e[type=leash_knot,tag=ob,scores={version=1,obcheck=0,obcheckcredit=51..60},tag=obset] ~ ~ ~ scoreboard players random @s obcheck 50 100
execute @e[type=leash_knot,tag=ob,scores={version=1,obcheck=0,obcheckcredit=61..},tag=obset] ~ ~ ~ scoreboard players set @s obcheck 40
...
#检测成功增加风险等级
execute @e[type=leash_knot,tag=obset,tag=obnewcheck,tag=errornewblock,scores={obcheckcredit=0..70}] ~ ~ ~ scoreboard players add @s obcheckcredit 1
...
execute @e[type=leash_knot,tag=obset,tag=errornewblock,tag=obnewcheck] ~ ~ ~ tellraw @a[r=100,scores={language=0},tag=!errblocktell] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f在刷新点周围检测到活塞，请移除活塞后重试。"}]}
execute @e[type=leash_knot,tag=obset,tag=errornewblock,tag=obnewcheck] ~ ~ ~ tellraw @a[r=100,scores={language=1},tag=!errblocktell] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fThe piston was detected around the refresh point, please remove the piston and try again."}]}
execute @e[type=leash_knot,tag=obset,tag=errornewblock,tag=obnewcheck] ~ ~ ~ tellraw @a[r=100,scores={language=2},tag=!errblocktell] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f在刷新點周圍檢測到活塞，請移除活塞后重試。"}]}
execute @e[type=leash_knot,tag=obset,tag=errornewblock,tag=obnewcheck] ~ ~ ~ tellraw @a[r=100,scores={language=3},tag=!errblocktell] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fリフレッシュ ポイントの周囲でピストンが検出された場合は、ピストンを削除してから再試行してください。"}]}
execute @e[type=leash_knot,tag=obset,tag=errornewblock,tag=obnewcheck] ~ ~ ~ tag @a[r=100,tag=!errblocktell] add errblocktell
execute @e[type=leash_knot,tag=obset,tag=errornewblock,tag=obnewcheck] ~ ~ ~ titleraw @a[r=100] title {"rawtext":[{"text":"§l"}]}
execute @e[type=leash_knot,tag=obset,tag=errornewblock,tag=obnewcheck] ~ ~ ~ titleraw @a[r=100,scores={language=0}] subtitle {"rawtext":[{"text":"§e请移除活塞。"}]}
execute @e[type=leash_knot,tag=obset,tag=errornewblock,tag=obnewcheck] ~ ~ ~ titleraw @a[r=100,scores={language=1}] subtitle {"rawtext":[{"text":"§ePlease remove the piston."}]}
execute @e[type=leash_knot,tag=obset,tag=errornewblock,tag=obnewcheck] ~ ~ ~ titleraw @a[r=100,scores={language=2}] subtitle {"rawtext":[{"text":"§e請移除活塞。"}]}
execute @e[type=leash_knot,tag=obset,tag=errornewblock,tag=obnewcheck] ~ ~ ~ titleraw @a[r=100,scores={language=3}] subtitle {"rawtext":[{"text":"§eピストンを削除してください。"}]}
#移除本次不刷新标签
