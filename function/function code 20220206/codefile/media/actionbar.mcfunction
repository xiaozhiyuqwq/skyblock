...
#注册
#跑图（跨空岛）提示
execute @a ~ ~ ~ titleraw @s[scores={language=0,actionbar=30,islandruns=61..80}] actionbar {"rawtext":[{"text":"§6您当前未处于检索目标岛屿，系统将于 §l§b12秒 §r§6后将您传送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=0,actionbar=30,islandruns=81..100}] actionbar {"rawtext":[{"text":"§6您当前未处于检索目标岛屿，系统将于 §l§b11秒 §r§6后将您传送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=0,actionbar=30,islandruns=101..120}] actionbar {"rawtext":[{"text":"§6您当前未处于检索目标岛屿，系统将于 §l§b10秒 §r§6后将您传送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=0,actionbar=30,islandruns=121..140}] actionbar {"rawtext":[{"text":"§6您当前未处于检索目标岛屿，系统将于 §l§b9秒 §r§6后将您传送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=0,actionbar=30,islandruns=141..160}] actionbar {"rawtext":[{"text":"§6您当前未处于检索目标岛屿，系统将于 §l§b8秒 §r§6后将您传送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=0,actionbar=30,islandruns=161..180}] actionbar {"rawtext":[{"text":"§6您当前未处于检索目标岛屿，系统将于 §l§b7秒 §r§6后将您传送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=0,actionbar=30,islandruns=181..200}] actionbar {"rawtext":[{"text":"§6您当前未处于检索目标岛屿，系统将于 §l§b6秒 §r§6后将您传送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=0,actionbar=30,islandruns=201..220}] actionbar {"rawtext":[{"text":"§6您当前未处于检索目标岛屿，系统将于 §l§b5秒 §r§6后将您传送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=0,actionbar=30,islandruns=221..240}] actionbar {"rawtext":[{"text":"§6您当前未处于检索目标岛屿，系统将于 §l§b4秒 §r§6后将您传送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=0,actionbar=30,islandruns=241..260}] actionbar {"rawtext":[{"text":"§6您当前未处于检索目标岛屿，系统将于 §l§b3秒 §r§6后将您传送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=0,actionbar=30,islandruns=261..280}] actionbar {"rawtext":[{"text":"§6您当前未处于检索目标岛屿，系统将于 §l§b2秒 §r§6后将您传送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=0,actionbar=30,islandruns=281..300}] actionbar {"rawtext":[{"text":"§6您当前未处于检索目标岛屿，系统将于 §l§b1秒 §r§6后将您传送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=0,actionbar=30,islandruns=301..}] actionbar {"rawtext":[{"text":"§b系统即将将您传送至主城......."}]}
execute @a ~ ~ ~ titleraw @s[scores={language=1,actionbar=30,islandruns=61..80}] actionbar {"rawtext":[{"text":"§6You are not currently in the search target island. The system will send you to lobby in §l§b12 Seconds "}]}
execute @a ~ ~ ~ titleraw @s[scores={language=1,actionbar=30,islandruns=81..100}] actionbar {"rawtext":[{"text":"§6You are not currently in the search target island. The system will send you to lobby in §l§b11 Seconds "}]}
execute @a ~ ~ ~ titleraw @s[scores={language=1,actionbar=30,islandruns=101..120}] actionbar {"rawtext":[{"text":"§6You are not currently in the search target island. The system will send you to lobby in §l§b10 Seconds "}]}
execute @a ~ ~ ~ titleraw @s[scores={language=1,actionbar=30,islandruns=121..140}] actionbar {"rawtext":[{"text":"§6You are not currently in the search target island. The system will send you to lobby in §l§b9 Seconds "}]}
execute @a ~ ~ ~ titleraw @s[scores={language=1,actionbar=30,islandruns=141..160}] actionbar {"rawtext":[{"text":"§6You are not currently in the search target island. The system will send you to lobby in §l§b8 Seconds "}]}
execute @a ~ ~ ~ titleraw @s[scores={language=1,actionbar=30,islandruns=161..180}] actionbar {"rawtext":[{"text":"§6You are not currently in the search target island. The system will send you to lobby in §l§b7 Seconds "}]}
execute @a ~ ~ ~ titleraw @s[scores={language=1,actionbar=30,islandruns=181..200}] actionbar {"rawtext":[{"text":"§6You are not currently in the search target island. The system will send you to lobby in §l§b6 Seconds "}]}
execute @a ~ ~ ~ titleraw @s[scores={language=1,actionbar=30,islandruns=201..220}] actionbar {"rawtext":[{"text":"§6You are not currently in the search target island. The system will send you to lobby in §l§b5 Seconds "}]}
execute @a ~ ~ ~ titleraw @s[scores={language=1,actionbar=30,islandruns=221..240}] actionbar {"rawtext":[{"text":"§6You are not currently in the search target island. The system will send you to lobby in §l§b4 Seconds "}]}
execute @a ~ ~ ~ titleraw @s[scores={language=1,actionbar=30,islandruns=241..260}] actionbar {"rawtext":[{"text":"§6You are not currently in the search target island. The system will send you to lobby in §l§b3 Seconds "}]}
execute @a ~ ~ ~ titleraw @s[scores={language=1,actionbar=30,islandruns=261..280}] actionbar {"rawtext":[{"text":"§6You are not currently in the search target island. The system will send you to lobby in §l§b2 Seconds "}]}
execute @a ~ ~ ~ titleraw @s[scores={language=1,actionbar=30,islandruns=281..300}] actionbar {"rawtext":[{"text":"§6You are not currently in the search target island. The system will send you to lobby in §l§b1 Seconds "}]}
execute @a ~ ~ ~ titleraw @s[scores={language=1,actionbar=30,islandruns=301..}] actionbar {"rawtext":[{"text":"§bThe system is about to transfer you to lobby......"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=2,actionbar=30,islandruns=61..80}] actionbar {"rawtext":[{"text":"§6您當前未處於檢索目標島嶼，系統將於 §l§b12秒 §r§6後將您傳送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=2,actionbar=30,islandruns=81..100}] actionbar {"rawtext":[{"text":"§6您當前未處於檢索目標島嶼，系統將於 §l§b11秒 §r§6後將您傳送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=2,actionbar=30,islandruns=101..120}] actionbar {"rawtext":[{"text":"§6您當前未處於檢索目標島嶼，系統將於 §l§b10秒 §r§6後將您傳送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=2,actionbar=30,islandruns=121..140}] actionbar {"rawtext":[{"text":"§6您當前未處於檢索目標島嶼，系統將於 §l§b9秒 §r§6後將您傳送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=2,actionbar=30,islandruns=141..160}] actionbar {"rawtext":[{"text":"§6您當前未處於檢索目標島嶼，系統將於 §l§b8秒 §r§6後將您傳送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=2,actionbar=30,islandruns=161..180}] actionbar {"rawtext":[{"text":"§6您當前未處於檢索目標島嶼，系統將於 §l§b7秒 §r§6後將您傳送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=2,actionbar=30,islandruns=181..200}] actionbar {"rawtext":[{"text":"§6您當前未處於檢索目標島嶼，系統將於 §l§b6秒 §r§6後將您傳送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=2,actionbar=30,islandruns=201..220}] actionbar {"rawtext":[{"text":"§6您當前未處於檢索目標島嶼，系統將於 §l§b5秒 §r§6後將您傳送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=2,actionbar=30,islandruns=221..240}] actionbar {"rawtext":[{"text":"§6您當前未處於檢索目標島嶼，系統將於 §l§b4秒 §r§6後將您傳送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=2,actionbar=30,islandruns=241..260}] actionbar {"rawtext":[{"text":"§6您當前未處於檢索目標島嶼，系統將於 §l§b3秒 §r§6後將您傳送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=2,actionbar=30,islandruns=261..280}] actionbar {"rawtext":[{"text":"§6您當前未處於檢索目標島嶼，系統將於 §l§b2秒 §r§6後將您傳送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=2,actionbar=30,islandruns=281..300}] actionbar {"rawtext":[{"text":"§6您當前未處於檢索目標島嶼，系統將於 §l§b1秒 §r§6後將您傳送至主城"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=2,actionbar=30,islandruns=301..}] actionbar {"rawtext":[{"text":"§b系統即將將您傳送至主城......."}]}
execute @a ~ ~ ~ titleraw @s[scores={language=3,actionbar=30,islandruns=61..80}] actionbar {"rawtext":[{"text":"§6現在は検索対象の島にいません。システムは §l§b12秒 §r§6後に本城に転送されます。"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=3,actionbar=30,islandruns=81..100}] actionbar {"rawtext":[{"text":"§6現在は検索対象の島にいません。システムは §l§b11秒 §r§6後に本城に転送されます。"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=3,actionbar=30,islandruns=101..120}] actionbar {"rawtext":[{"text":"§6現在は検索対象の島にいません。システムは §l§b10秒 §r§6後に本城に転送されます。"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=3,actionbar=30,islandruns=121..140}] actionbar {"rawtext":[{"text":"§6現在は検索対象の島にいません。システムは §l§b9秒 §r§6後に本城に転送されます。"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=3,actionbar=30,islandruns=141..160}] actionbar {"rawtext":[{"text":"§6現在は検索対象の島にいません。システムは §l§b8秒 §r§6後に本城に転送されます。"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=3,actionbar=30,islandruns=161..180}] actionbar {"rawtext":[{"text":"§6現在は検索対象の島にいません。システムは §l§b7秒 §r§6後に本城に転送されます。"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=3,actionbar=30,islandruns=181..200}] actionbar {"rawtext":[{"text":"§6現在は検索対象の島にいません。システムは §l§b6秒 §r§6後に本城に転送されます。"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=3,actionbar=30,islandruns=201..220}] actionbar {"rawtext":[{"text":"§6現在は検索対象の島にいません。システムは §l§b5秒 §r§6後に本城に転送されます。"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=3,actionbar=30,islandruns=221..240}] actionbar {"rawtext":[{"text":"§6現在は検索対象の島にいません。システムは §l§b4秒 §r§6後に本城に転送されます。"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=3,actionbar=30,islandruns=241..260}] actionbar {"rawtext":[{"text":"§6現在は検索対象の島にいません。システムは §l§b3秒 §r§6後に本城に転送されます。"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=3,actionbar=30,islandruns=261..280}] actionbar {"rawtext":[{"text":"§6現在は検索対象の島にいません。システムは §l§b2秒 §r§6後に本城に転送されます。"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=3,actionbar=30,islandruns=281..300}] actionbar {"rawtext":[{"text":"§6現在は検索対象の島にいません。システムは §l§b1秒 §r§6後に本城に転送されます。"}]}
execute @a ~ ~ ~ titleraw @s[scores={language=3,actionbar=30,islandruns=301..}] actionbar {"rawtext":[{"text":"§bシステムはまもなくあなたをメイン城に転送します。"}]}
#单方块刷新点保护
execute @e[type=leash_knot,tag=ob] ~ ~ ~ scoreboard players set @a[r=35] actionbar 35
execute @a[scores={actionbar=35},tag=!onsetwarn] ~ ~ ~ tellraw @s[scores={language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§7您已经接近刷新点。请不要采用特殊方案破坏刷新点，否则将会产生不可预知的错误以及导致刷新失败。"}]}
execute @a[scores={actionbar=35},tag=!onsetwarn] ~ ~ ~ tellraw @s[scores={language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§7You are close to the refresh point. Please do not use special schemes to destroy the refresh point, otherwise unpredictable errors will occur and refresh will fail."}]}
execute @a[scores={actionbar=35},tag=!onsetwarn] ~ ~ ~ tellraw @s[scores={language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§7您已經接近重繪點。請不要採用特殊方案破壞重繪點，否則將會產生不可預知的錯誤以及導致重繪失敗。"}]}
execute @a[scores={actionbar=35},tag=!onsetwarn] ~ ~ ~ tellraw @s[scores={language=3}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§7リフレッシュ ポイントに近づいています。 特別なシナリオでリフレッシュ ポイントを破壊しないでください。"}]}
execute @a[scores={actionbar=35}] ~ ~ ~ tag @s add onsetwarn
execute @a[scores={actionbar=!35}] ~ ~ ~ tag @s remove onsetwarn
execute @a[scores={actionbar=35}] ~ ~ ~ titleraw @s[scores={language=0}] actionbar {"rawtext":[{"text":"§l§e请不要破坏刷新点 否则将会产生§c不可预知的错误§e！"}]}
execute @a[scores={actionbar=35}] ~ ~ ~ titleraw @s[scores={language=1}] actionbar {"rawtext":[{"text":"§ePlease do not destroy the refresh point, otherwise unpredictable errors will occur!"}]}
execute @a[scores={actionbar=35}] ~ ~ ~ titleraw @s[scores={language=2}] actionbar {"rawtext":[{"text":"§l§e請不要破壞重繪點 否則將會產生§c不可預知的錯誤§e！"}]}
execute @a[scores={actionbar=35}] ~ ~ ~ titleraw @s[scores={language=3}] actionbar {"rawtext":[{"text":"§l§eリフレッシュポイントを破壊しないと予知できないエラーが発生します。"}]}
#边界
...
#文本1-欢迎
execute @a[scores={actionbartime=1..75,language=0,level=!0,actionbar=50},tag=!admin,tag=!developer] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§c§l用户§f§6 "},{"selector":"@s"},{"text":" §r§b您好，欢迎您！ §f感谢您体验空岛生存！"}]}
execute @a[scores={actionbartime=1..75,language=1,level=!0,actionbar=50},tag=!admin,tag=!developer] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§c§lUser§f§6 "},{"selector":"@s"},{"text":" §r§bHello, welcome! §fThank you for experiencing skyblock!"}]}
execute @a[scores={actionbartime=1..75,language=2,level=!0,actionbar=50},tag=!admin,tag=!developer] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§c§l用戶§f§6 "},{"selector":"@s"},{"text":" §r§b您好，歡迎您！ §f感謝您體驗空島生存！"}]}
execute @a[scores={actionbartime=1..75,language=3,level=!0,actionbar=50},tag=!admin,tag=!developer] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§c§lUser§f§6 "},{"selector":"@s"},{"text":" §r§bこんにちは、歓迎します。 §fSkyblockを体験してくれてありがとうございます。"}]}
...
execute @a[scores={actionbartime=1..75,language=0,level=!0,actionbar=50},tag=!admin,tag=developer] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§c§l开发者§f§6 "},{"selector":"@s"},{"text":" §r§b您好，欢迎您！ §f感谢您体验空岛生存！"}]}
execute @a[scores={actionbartime=1..75,language=1,level=!0,actionbar=50},tag=!admin,tag=developer] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§c§lDeveloper§f§6 "},{"selector":"@s"},{"text":" §r§bHello, welcome! §fThank you for experiencing skyblock!"}]}
execute @a[scores={actionbartime=1..75,language=2,level=!0,actionbar=50},tag=!admin,tag=developer] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§c§l開發者§f§6 "},{"selector":"@s"},{"text":" §r§b您好，歡迎您！ §f感謝您體驗空島生存！"}]}
execute @a[scores={actionbartime=1..75,language=3,level=!0,actionbar=50},tag=!admin,tag=developer] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§c§l開発者§f§6 "},{"selector":"@s"},{"text":" §r§bこんにちは、歓迎します。 §fSkyblockを体験してくれてありがとうございます。"}]}
#文本2-账号数据
...
execute @a[scores={actionbartime=376..450,language=1,level=!0,actionbar=50,actionbartext=205}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§f愿你历尽千帆，归来仍是少年。"}]}
execute @a[scores={actionbartime=376..450,language=1,level=!0,actionbar=50,actionbartext=206}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§f彼岸花花开彼岸，断肠草草断肝肠。"}]}
...
execute @a[scores={actionbartime=376..450,language=0,level=!0,actionbar=50,actionbartext=101}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f在 §d哔哩哔哩 §f搜索并关注 §6祉语(uid:437306982) §f。"}]}
...
execute @a[scores={actionbartime=376..450,language=0,level=!0,actionbar=50,actionbartext=105}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f在 §aOSCHINA §f搜索并关注 §6xiaozhiyuqwq(4991772) §f。"}]}
execute @a[scores={actionbartime=376..450,language=0,level=!0,actionbar=50,actionbartext=106}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f在 §6微博 §f搜索并关注 §6xhduoduobaby(5224637037) §f。"}]}
execute @a[scores={actionbartime=376..450,language=1,level=!0,actionbar=50,actionbartext=101}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§fVisit §dBilibili §fsearch and follow §6祉语(uid:437306982) §f."}]}
...
execute @a[scores={actionbartime=376..450,language=1,level=!0,actionbar=50,actionbartext=105}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§fVisit §aOSCHINA §fsearch and follow §6xiaozhiyuqwq(4991772) §f."}]}
execute @a[scores={actionbartime=376..450,language=1,level=!0,actionbar=50,actionbartext=106}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§fVisit §6Weibo §fsearch and follow §6xhduoduobaby(5224637037) §f."}]}
execute @a[scores={actionbartime=376..450,language=2,level=!0,actionbar=50,actionbartext=101}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f在 §d嗶哩嗶哩 §f蒐索並關注 §6祉语(uid:437306982) §f。"}]}
...
execute @a[scores={actionbartime=376..450,language=2,level=!0,actionbar=50,actionbartext=105}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f在 §aOSCHINA §f蒐索並關注 §6xiaozhiyuqwq(4991772) §f。"}]}
execute @a[scores={actionbartime=376..450,language=2,level=!0,actionbar=50,actionbartext=106}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f在 §6微博 §f蒐索並關注 §6xhduoduobaby(5224637037) §f。"}]}
execute @a[scores={actionbartime=376..450,language=3,level=!0,actionbar=50,actionbartext=101}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§d哔哩哔哩 §fで検索して §6祉语(uid:437306982) §fに注目したり。"}]}
...
execute @a[scores={actionbartime=376..450,language=3,level=!0,actionbar=50,actionbartext=105}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§aOSCHINA §fで検索して §6xiaozhiyuqwq(4991772) §fに注目したり。"}]}
execute @a[scores={actionbartime=376..450,language=3,level=!0,actionbar=50,actionbartext=106}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§6weibo §fで検索して §6xhduoduobaby(5224637037) §fに注目したり。"}]}
#文本7 - 广告2
execute @a[scores={actionbartime=451..525,language=0,level=!0,actionbar=50,actionbartext=201}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f盛夏的雨过后，青空映照而过，仿如一体浑然天生。"}]}
...
execute @a[scores={actionbartime=451..525,language=1,level=!0,actionbar=50,actionbartext=201}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§f盛夏的雨过后，青空映照而过，仿如一体浑然天生。"}]}
execute @a[scores={actionbartime=451..525,language=1,level=!0,actionbar=50,actionbartext=202}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§f遥遥微光，与我同行"}]}
execute @a[scores={actionbartime=451..525,language=1,level=!0,actionbar=50,actionbartext=203}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§f纵有疾风起，人生不言弃。(起风了，唯有努力生存。)"}]}
execute @a[scores={actionbartime=451..525,language=1,level=!0,actionbar=50,actionbartext=204}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§f忠信持之以诚，勤俭行之以恕。"}]}
execute @a[scores={actionbartime=451..525,language=1,level=!0,actionbar=50,actionbartext=205}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§f亲爱的旅人，你仍是记忆中的模样。"}]}
execute @a[scores={actionbartime=451..525,language=1,level=!0,actionbar=50,actionbartext=206}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§f我寻了半生的春天，你一笑便是了。"}]}
execute @a[scores={actionbartime=451..525,language=2,level=!0,actionbar=50,actionbartext=201}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f盛夏的雨過後，青空映照而過，仿如一體渾然天生。"}]}
...
execute @a[scores={actionbartime=451..525,language=3,level=!0,actionbar=50,actionbartext=203}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f盛夏的雨过后，青空映照而过，仿如一体浑然天生。"}]}
...
execute @a[scores={actionbartime=451..525,language=0,level=!0,actionbar=50,actionbartext=101}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f在 §aGitee(码云) §f搜索并关注 §6InoriILU §f。"}]}
execute @a[scores={actionbartime=451..525,language=0,level=!0,actionbar=50,actionbartext=102}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f在 §fGitHub §f搜索并关注 §6InoriILU §f。"}]}
...
execute @a[scores={actionbartime=451..525,language=0,level=!0,actionbar=50,actionbartext=105}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f在 §3TapTap §f搜索并关注 §6祉语(ID:61306024) §f。"}]}
...
execute @a[scores={actionbartime=451..525,language=1,level=!0,actionbar=50,actionbartext=101}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§fVisit §aGitee §fsearch and follow §6InoriILU §f."}]}
execute @a[scores={actionbartime=451..525,language=1,level=!0,actionbar=50,actionbartext=102}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§fVisit §fGitHub §fsearch and follow §6InoriILU §f."}]}
...
execute @a[scores={actionbartime=451..525,language=1,level=!0,actionbar=50,actionbartext=105}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§fVisit §3TapTap §fsearch and follow §6祉语(ID:61306024) §f."}]}
...
execute @a[scores={actionbartime=451..525,language=2,level=!0,actionbar=50,actionbartext=101}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f在 §aGitee §f蒐索並關注 §6InoriILU §f。"}]}
execute @a[scores={actionbartime=451..525,language=2,level=!0,actionbar=50,actionbartext=102}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f在 §fGitHub §f蒐索並關注 §6InoriILU §f。"}]}
...
execute @a[scores={actionbartime=451..525,language=2,level=!0,actionbar=50,actionbartext=105}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f在 §3TapTap §f蒐索並關注 §6祉语(ID:61306024) §f。"}]}
...
execute @a[scores={actionbartime=451..525,language=3,level=!0,actionbar=50,actionbartext=101}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§aGitee §fで検索して §6InoriILU §fに注目したり。"}]}
execute @a[scores={actionbartime=451..525,language=3,level=!0,actionbar=50,actionbartext=102}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§fGitHub §fで検索して §6InoriILU §fに注目したり。"}]}
...
execute @a[scores={actionbartime=451..525,language=3,level=!0,actionbar=50,actionbartext=105}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§3TapTap §fで検索して §6祉语(ID:61306024) §fに注目したり。"}]}
...
execute @a[scores={actionbartime=526..600,language=0,level=!0,actionbar=50,actionbartext=203}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f众里寻他千百度，蓦然回首，那人却在，灯火阑珊处。"}]}
...
execute @a[scores={actionbartime=526..600,language=1,level=!0,actionbar=50,actionbartext=201}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§f何当共剪西窗烛，却话巴山夜雨时。"}]}
execute @a[scores={actionbartime=526..600,language=1,level=!0,actionbar=50,actionbartext=202}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§f回首向来萧瑟处，归去，也无风雨也无晴。"}]}
execute @a[scores={actionbartime=526..600,language=1,level=!0,actionbar=50,actionbartext=203}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§f溪云初起日沉阁，山雨欲来风满楼。"}]}
execute @a[scores={actionbartime=526..600,language=1,level=!0,actionbar=50,actionbartext=204}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§f故国神游，多情应笑我，早生华发。人生如梦，一尊还酹江月。"}]}
execute @a[scores={actionbartime=526..600,language=1,level=!0,actionbar=50,actionbartext=205}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§f青青子衿，悠悠我心。纵我不往，子宁不嗣音？"}]}
execute @a[scores={actionbartime=526..600,language=1,level=!0,actionbar=50,actionbartext=206}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§f众里寻他千百度，蓦然回首，那人却在，灯火阑珊处。"}]}
...
execute @a[scores={actionbartime=526..600,language=3,level=!0,actionbar=50,actionbartext=206}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§l§f雨が過ぎて夏は，青を移した，一つになって。"}]}
#未注册
