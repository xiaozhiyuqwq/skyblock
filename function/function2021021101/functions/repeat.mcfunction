...
tellraw @a[scores={temp=223,language=0,receivetext=3}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f在 §6GitHub§f 上搜索并关注 §3xhduoduobaby§f ，或者访问 §3https://github.com/xhduoduobaby§f 来查看我们完全开放的空岛生存！"}]}
tellraw @a[scores={temp=223,language=1,receivetext=3}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fSearch on §6GitHub§f and follow §3xhduoduobaby§f, or visit §3https://github.com/xhduoduobaby§f Check out our fully open skylock!"}]}
tellraw @a[scores={temp=223,language=2,receivetext=3}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f在 §6GitHub§f 上蒐索並關注 §3xhduoduobaby§f ，或者訪問 §3https://github.com/xhduoduobaby§f 來查看我們完全開放的空島生存！"}]}
...
kick @a[scores={language=0,bantime=17}] §f您当前已经被封禁，无法加入游戏。距离解除封禁还有 §l§e17 分钟 §r§f。如有异议请联系管理员。当前正在运行 空岛生存-服务端版本 v1.0.0 。GitHub主页： https://github.com/xhduoduobaby 。
...
kick @a[scores={language=2,bantime=8}] §f您當前已經被封禁，無法加入遊戲。距離解除封禁還有 §l§e8 分鐘 §r§f。如有異議請聯系管理員。當前正在運行 空島生存-服務端版本 v1.0.0 。GitHub主頁： https://github.com/xhduoduobaby 。
