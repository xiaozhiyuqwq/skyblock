...
tellraw @a[scores={temp=10300,language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§a操作成功！§f您已经成功加入公会，您现在可以选择使用 §l§aGuild §r§f检索以返回您归属公会的岛屿。"}]}
tellraw @a[scores={temp=10300,language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§aOperation successful! §fYou have successfully joined the guild. You can now choose to retrieve using §l§aGuild §r§fto return to the island you belong to."}]}
tellraw @a[scores={temp=10300,language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§a操作成功！§f您已經成功加入公會，現在您可以選擇 §l§aGuild §r§f檢索以返回您歸屬公會的島嶼。"}]}
