#Transfer
scoreboard players set @a[scores={temp=223}] temp 1100
...
#注册系统
scoreboard players set @a[scores={temp=1100}] temp 223
#提示
tellraw @a[scores={tptype=1..3,temp=1101,language=0,x=!0,z=!0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§a传送成功！§f开始生存吧！"}]}
tellraw @a[scores={tptype=1..3,temp=1101,language=1,x=!0,z=!0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§aTransfer successful! §fSurvive in the desolate sky island!"}]}
tellraw @a[scores={tptype=1..3,temp=1101,language=2,x=!0,z=!0}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§a傳送成功！§f開始生存吧！"}]}
tellraw @a[scores={tptype=4,temp=1101,language=0,x=!0,z=!0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§a传送成功！"}]}
tellraw @a[scores={tptype=4,temp=1101,language=1,x=!0,z=!0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§aTransfer successful!"}]}
tellraw @a[scores={tptype=4,temp=1101,language=2,x=!0,z=!0}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§a傳送成功！"}]}
tellraw @a[scores={temp=1101,language=0,x=0,z=!0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§c传送失败！§f请尝试重新检索。"}]}
tellraw @a[scores={temp=1101,language=1,x=0,z=!0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§cTransfer failed! §fPlease try to retrieve again."}]}
tellraw @a[scores={temp=1101,language=2,x=0,z=!0}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§c傳送失敗！§f請嘗試重新檢索。"}]}
tellraw @a[scores={temp=1101,language=0,x=!0,z=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§c传送失败！§f请尝试重新检索。"}]}
tellraw @a[scores={temp=1101,language=1,x=!0,z=0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§cTransfer failed! §fPlease try to retrieve again."}]}
tellraw @a[scores={temp=1101,language=2,x=!0,z=0}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§c傳送失敗！§f請嘗試重新檢索。"}]}
tellraw @a[scores={temp=1101,language=0,x=0,z=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§c传送失败！§f请尝试重新检索。"}]}
tellraw @a[scores={temp=1101,language=1,x=0,z=0}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§cTransfer failed! §fPlease try to retrieve again."}]}
tellraw @a[scores={temp=1101,language=2,x=0,z=0}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§c傳送失敗！§f請嘗試重新檢索。"}]}
tellraw @a[scores={tptype=0,temp=1101,language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§f检索方式 §l§7未检索 §r§f。"}]}
tellraw @a[scores={tptype=0,temp=1101,language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§fRetrieval methods §l§7Null §r§f."}]}
tellraw @a[scores={tptype=0,temp=1101,language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§f檢索方式 §l§7未檢索 §r§f。"}]}
tellraw @a[scores={tptype=1,temp=1101,language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§f检索方式 §l§6UID检索 §r§f。"}]}
tellraw @a[scores={tptype=1,temp=1101,language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§fRetrieval methods §l§6UID §r§f."}]}
tellraw @a[scores={tptype=1,temp=1101,language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§f檢索方式 §l§6UID檢索 §r§f。"}]}
tellraw @a[scores={tptype=2,temp=1101,language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§f检索方式 §l§1ID检索 §r§f。"}]}
tellraw @a[scores={tptype=2,temp=1101,language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§fRetrieval methods §l§1ID §r§f."}]}
tellraw @a[scores={tptype=2,temp=1101,language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§f檢索方式 §l§1ID檢索 §r§f。"}]}
tellraw @a[scores={tptype=3,temp=1101,language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§f检索方式 §l§aGuild检索 §r§f。"}]}
tellraw @a[scores={tptype=3,temp=1101,language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§fRetrieval methods §l§aGuild §r§f."}]}
tellraw @a[scores={tptype=3,temp=1101,language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§f檢索方式 §l§aGuild檢索 §r§f。"}]}
tellraw @a[scores={tptype=4,temp=1101,language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§f检索方式 §l§3Visit检索 §r§f。"}]}
tellraw @a[scores={tptype=4,temp=1101,language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§fRetrieval methods §l§3Visit §r§f."}]}
tellraw @a[scores={tptype=4,temp=1101,language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§f檢索方式 §l§3Visit檢索 §r§f。"}]}
scoreboard players set @a[scores={temp=1101,tptype=4}] x 0
scoreboard players set @a[scores={temp=1101,tptype=4}] z 0
scoreboard players set @a[scores={temp=1101,tptype=4}] visit 0
scoreboard players set @a[scores={temp=1101,tptype=4}] visittime 0
tellraw @a[scores={tptype=4,temp=1101,language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§f公会参观邀请已销毁。"}]}
tellraw @a[scores={tptype=4,temp=1101,language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§fGuild visit invitation destroyed."}]}
tellraw @a[scores={tptype=4,temp=1101,language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§f公會參觀邀請已銷毀。"}]}
gamemode survival @a[scores={tptype=1..3,temp=1101}]
gamemode adventure @a[scores={tptype=4,temp=1101}]
scoreboard players set @a[scores={temp=1101,tptype=4}] tytype 0
scoreboard players reset @a[scores={temp=1101}] temp