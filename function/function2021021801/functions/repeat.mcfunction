...
#文本1-欢迎
execute @a[scores={actionbartime=1..100,language=0,level=!0},tag=!admin,tag=!developer] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§c§l用户§f§6 "},{"selector":"@s"},{"text":" §r§b您好，欢迎您！ §f感谢您体验空岛生存！"}]}
execute @a[scores={actionbartime=1..100,language=0,level=!0},tag=!admin,tag=developer] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§c§l用户§f§6 "},{"selector":"@s"},{"text":" §r§b您好，欢迎您！ §f君茶的本子，好涩好喜欢~"}]}
execute @a[scores={actionbartime=1..100,language=1,level=!0},tag=!admin] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§c§lUser§f§6 "},{"selector":"@s"},{"text":" §r§bHello, welcome! §fThank you for experiencing skyblock!"}]}
execute @a[scores={actionbartime=1..100,language=2,level=!0},tag=!admin] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§c§l用戶§f§6 "},{"selector":"@s"},{"text":" §r§b您好，歡迎您！ §f感謝您體驗空島生存！"}]}
execute @a[scores={actionbartime=1..100,language=3,level=!0},tag=!admin] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§c§lUser§f§6 "},{"selector":"@s"},{"text":" §r§bこんにちは、歓迎します。 §fSkyblockを体験してくれてありがとうございます。"}]}
execute @a[scores={actionbartime=1..100,language=0,level=!0},tag=admin] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§c§l管理员§f§6 "},{"selector":"@s"},{"text":" §r§b您好，欢迎您！ §f歌剧奏响的瞬间，轻音悠远，犹如蔷薇端庄高洁，看落花舞动抚过了少女指尖。"}]}
execute @a[scores={actionbartime=1..100,language=1,level=!0},tag=admin] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§c§lAdmin§f§6 "},{"selector":"@s"},{"text":" §r§bHello, welcome! §fNever stop on the road of exploration!"}]}
execute @a[scores={actionbartime=1..100,language=2,level=!0},tag=admin] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§c§l管理員§f§6 "},{"selector":"@s"},{"text":" §r§b您好，歡迎您！ §f歌劇奏響的瞬間，輕音悠遠，猶如薔薇端莊高潔，看落花舞動撫過了少女指尖。"}]}
execute @a[scores={actionbartime=1..100,language=3,level=!0},tag=admin] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§c§lAdmin§f§6 "},{"selector":"@s"},{"text":" §r§bこんにちは、歓迎します。 §f探索の道で立ち止まらない！"}]}
#文本2-账号数据
execute @a[scores={actionbartime=101..200,language=0,level=!0}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§r§f用户识别符 §l§6"},{"score":{"name":"@s","objective":"uid"}},{"text":"   §r§f队伍识别符 §l§1"},{"score":{"name":"@s","objective":"id"}},{"text":"   §r§f公会识别符 §l§a"},{"score":{"name":"@s","objective":"id"}}]}
execute @a[scores={actionbartime=101..200,language=1,level=!0}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§r§fUID §l§6"},{"score":{"name":"@s","objective":"uid"}},{"text":"   §r§fTeamID §l§1"},{"score":{"name":"@s","objective":"id"}},{"text":"   §r§fGuildID §l§a"},{"score":{"name":"@s","objective":"id"}}]}
execute @a[scores={actionbartime=101..200,language=2,level=!0}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§r§f用戶識別符 §l§6"},{"score":{"name":"@s","objective":"uid"}},{"text":"   §r§f隊伍識別符 §l§1"},{"score":{"name":"@s","objective":"id"}},{"text":"   §r§f队伍识别符 §l§a"},{"score":{"name":"@s","objective":"id"}}]}
execute @a[scores={actionbartime=101..200,language=3,level=!0}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§r§fUID §l§6"},{"score":{"name":"@s","objective":"uid"}},{"text":"   §r§fチームID §l§1"},{"score":{"name":"@s","objective":"id"}},{"text":"   §r§fギルドID §l§a"},{"score":{"name":"@s","objective":"id"}}]}
#文本3-账号财富
execute @a[scores={actionbartime=201..300,language=0,level=!0}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§r§f硬币数量 §l§e"},{"score":{"name":"@s","objective":"coin"}},{"text":"   §r§f在线时长 §l§b"},{"score":{"name":"@s","objective":"playtime"}},{"text":"   §r§f今日在线时长 §l§d"},{"score":{"name":"@s","objective":"dailyplaytime"}},{"text":"   §r§f等级 §l§c"},{"score":{"name":"@s","objective":"level"}}]}
execute @a[scores={actionbartime=201..300,language=1,level=!0}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§r§fCoins §l§e"},{"score":{"name":"@s","objective":"coin"}},{"text":"   §r§fOnline time §l§b"},{"score":{"name":"@s","objective":"playtime"}},{"text":"   §r§fOnline time today §l§d"},{"score":{"name":"@s","objective":"dailyplaytime"}},{"text":"   §r§fLevel §l§c"},{"score":{"name":"@s","objective":"level"}}]}
execute @a[scores={actionbartime=201..300,language=2,level=!0}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§r§f硬幣數量 §l§e"},{"score":{"name":"@s","objective":"coin"}},{"text":"   §r§f線上時長 §l§b"},{"score":{"name":"@s","objective":"playtime"}},{"text":"   §r§f今日線上時長 §l§d"},{"score":{"name":"@s","objective":"dailyplaytime"}},{"text":"   §r§f等級 §l§c"},{"score":{"name":"@s","objective":"level"}}]}
execute @a[scores={actionbartime=201..300,language=3,level=!0}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§r§f硬貨 §l§e"},{"score":{"name":"@s","objective":"coin"}},{"text":"   §r§fオンライン時間 §l§b"},{"score":{"name":"@s","objective":"playtime"}},{"text":"   §r§f今日のオンライン時間 §l§d"},{"score":{"name":"@s","objective":"dailyplaytime"}},{"text":"   §r§fレベル §l§c"},{"score":{"name":"@s","objective":"level"}}]}
#文本4-任务
execute @a[scores={actionbartime=301..400,level=!0}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§f§l君茶的本子，好涩好喜欢"}]}
#未注册
