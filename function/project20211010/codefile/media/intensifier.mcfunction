...
execute @e[scores={typeid=1121..1180}] ~ ~ ~ scoreboard players random @s typeid 1501 1850
...
execute @e[scores={typeid=1501..1850}] ~ ~ ~ scoreboard players set @s typeid 1501
execute @e[scores={typeid=1501..1600}] ~ ~ ~ scoreboard players random @s typeid 1601 1950
...
execute @e[scores={typeid=1601..1950}] ~ ~ ~ scoreboard players set @s typeid 1601
execute @e[scores={typeid=1601..1700}] ~ ~ ~ scoreboard players random @s typeid 1701 2050
...
execute @e[scores={typeid=1601..2050}] ~ ~ ~ scoreboard players set @s typeid 1701
execute @e[scores={typeid=1701..1800}] ~ ~ ~ scoreboard players random @s typeid 1801 2150
...
execute @e[scores={typeid=1000..2150}] ~ ~ ~ scoreboard players set @s tptype 2000