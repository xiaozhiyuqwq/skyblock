...
execute @a[c=1] ~ ~ ~ execute @e[scores={typeid=128,tick=150..},type=armor_stand,tag=!tick3] ~ ~ ~ function media/devtool/devtest
...
#tag=dice 随机骰子
execute @a[tag=suicide] ~ ~ ~ function media/interaction/main
execute @a[tag=warn] ~ ~ ~ function media/interaction/main
execute @a[tag=pve] ~ ~ ~ function media/interaction/main
execute @a[tag=bolt] ~ ~ ~ function media/interaction/main
execute @a[tag=compensate] ~ ~ ~ function media/interaction/main
execute @a ~ ~ ~ detect ~ ~-2 ~ beacon 0 tag @s add beacon
execute @a[tag=beacon] ~ ~ ~ function media/interaction/main
execute @a[tag=dice] ~ ~ ~ function media/interaction/dice
#岩浆恢复
execute @a ~ ~ ~ detect ~ ~-3 ~ obsidian 0 execute @s ~ ~ ~ detect ~ ~-2 ~ cobblestone 0 execute @s ~ ~ ~ detect ~ ~-1 ~ air 0 media/lava