...
execute @e[type=leash_knot,tag=ob,scores={version=1,obnumber=281},tag=obset] ~ 101 ~ titleraw @a[r=50,scores={language=0}] subtitle {"rawtext":[{"text":"§l§f有一束光，照亮了我的世界。"}]}
execute @e[type=leash_knot,tag=ob,scores={version=1,obnumber=281},tag=obset] ~ 101 ~ titleraw @a[r=50,scores={language=2}] subtitle {"rawtext":[{"text":"§l§f有一束光，照亮了我的世界。"}]}
