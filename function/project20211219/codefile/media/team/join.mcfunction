...
execute @a[scores={temp=8858,id=0,uid=!0}] ~ ~ ~ tellraw @a[scores={temp=8858,language=3}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f§a操作成功！§fチームを編成し、ID を使用して自分のチームの島に参加するように選択できるようになりました。"}]}
...
execute @a[scores={temp=8858,id=0,uid=!0}] ~ ~ ~ tellraw @a[scores={temp=8848,language=3}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§a操作成功！§fチームを組む。 §6"},{"selector":"@p[scores={temp=8858},c=1]"},{"text":" §fは島のメンバーになりました。"}]}
...
execute @a[scores={temp=8858,id=!0,uid=!0}] ~ ~ ~ tellraw @a[scores={temp=8858,language=3}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f§c操作失敗！§f他のチームに参加しています。この操作を実行するにはチームを脱退しなければなりません。"}]}
...
execute @a[scores={temp=8858,id=!0,uid=!0}] ~ ~ ~ tellraw @a[scores={temp=8848,language=2}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fc操作失敗！§f§6"},{"selector":"@p[scores={temp=8858},c=1]"},{"text":" §fすでにチームを持っていますので、あなたともう一度チームを作ることはできません。"}]}
