...
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=100..110},c=1] ~ ~ ~ fill ~1 104 ~-2 ~1 105 ~-2 air
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=100..110},c=1] ~ ~ ~ fill ~4 106 ~-1 ~4 107 ~-1 air
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=100..110},c=1] ~ ~ ~ fill ~2 107 ~-1 air
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=100..110},c=1] ~ ~ ~ fill ~2 107 ~1 air
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=100..110},c=1] ~ ~ ~ fill ~4 107 ~1 air
execute @e[type=armor_stand,scores={typeid=128,version=0}] ~ ~ ~ execute @a[scores={temp=223,receive=100..110},c=1] ~ ~ ~ fill ~3 101 ~ ~3 106 ~ log 0
...
execute @e[type=armor_stand,scores={typeid=128,version=1}] ~ ~ ~ execute @a[scores={temp=223,receive=100..110},c=1,tag=gamemodeob] ~ ~ ~ execute @e[type=leash_knot,tag=ob] ~ ~ ~ scoreboard players operation @s version = gamerule version
execute @e[type=armor_stand,scores={typeid=128,version=1}] ~ ~ ~ execute @a[scores={temp=223,receive=100..110},c=1,tag=gamemodeob] ~ ~ ~ scoreboard players add @e[tag=ob,type=leash_knot] obnumber 0
execute @e[type=armor_stand,scores={typeid=128,version=1}] ~ ~ ~ execute @a[scores={temp=223,receive=100..110},c=1,tag=gamemodeob] ~ ~ ~ scoreboard players add @e[tag=ob,type=leash_knot] oblevel 0
execute @e[type=armor_stand,scores={typeid=128,version=1}] ~ ~ ~ execute @a[scores={temp=223,receive=100..110},c=1,tag=gamemodeob] ~ ~ ~ execute @e[tag=ob,type=leash_knot,scores={oblevel=0,obnumber=0}] ~ ~ ~ detect ~ 100 ~ air 0 setblock ~ 100 ~ stained_glass 1
execute @e[type=armor_stand,scores={typeid=128,version=1}] ~ ~ ~ execute @a[scores={temp=223,receive=100..110},c=1,tag=gamemodeob] ~ ~ ~ scoreboard players set @e[tag=ob,type=leash_knot,scores={oblevel=0,obnumber=0}] obnumber 1
#边界刷新
...
#success 注册成功的提示
execute @a[tag=enrollsuccess,tag=!enrollsuccess1] ~ ~ ~ scoreboard objectives add enrolltitle dummy
execute @a[tag=enrollsuccess,tag=!enrollsuccess1] ~ ~ ~ scoreboard objectives add enrolltitle1 dummy
execute @a[tag=enrollsuccess,tag=!enrollsuccess1] ~ ~ ~ scoreboard players add @s enrolltitle 0
execute @a[tag=enrollsuccess,tag=!enrollsuccess1] ~ ~ ~ scoreboard players add @s enrolltitle1 0
