...
execute @a[scores={notice=202}] ~ ~ ~ tellraw @s[scores={language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§7在 §6GitHub§7 上搜索并关注 §3xhduoduobaby§7 ，或者访问 §3https://github.com/xhduoduobaby§7 来查看我们完全开放的空岛生存！"}]}
execute @a[scores={notice=202}] ~ ~ ~ tellraw @s[scores={language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§7Search on §6GitHub§7 and follow §3xhduoduobaby§7, or visit §3https://github.com/xhduoduobaby§7 Check out our fully open skylock!"}]}
execute @a[scores={notice=202}] ~ ~ ~ tellraw @s[scores={language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§7在 §6GitHub§7 上蒐索並關注 §3xhduoduobaby§7 ，或者訪問 §3https://github.com/xhduoduobaby§7 來查看我們完全開放的空島生存！"}]}
execute @a[scores={notice=202}] ~ ~ ~ tellraw @s[scores={language=3}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§6GitHub§7 で検索して §3xhduodubbaby §7に注目したり、訪問したりします。 §3https://github.com/xhduodubbaby §7完全にオープンしたskyblockを見に来ました。"}]}
...
#彩蛋
#主要
scoreboard players reset * stinger
scoreboard players random @e[scores={typeid=128},type=minecraft:armor_stand] stinger 1 10
execute @a ~ ~ ~ scoreboard players operation @s stinger += @e[scores={typeid=128},type=minecraft:armor_stand] stinger
scoreboard players random @a[scores={stinger=200..}] stinger 301 303
#天気の子
...
execute @a[tag=weatheringwithyou] ~ ~ ~ tellraw @s[scores={language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f天空比大海还要深,是个未知的世界。 摘录自 <天气之子> 。"}]}
execute @a[tag=weatheringwithyou] ~ ~ ~ tellraw @s[scores={language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f空は海よりも深く、未知の世界だった。Excerpt from <Weathering With You> ."}]}
execute @a[tag=weatheringwithyou] ~ ~ ~ tellraw @s[scores={language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f天空比大海還要深，是個未知的世界。摘錄自 <天氣之子> 。 "}]}
execute @a[tag=weatheringwithyou] ~ ~ ~ tellraw @s[scores={language=3}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f空は海よりも深く、未知の世界だった。 「天気の子」から抜粋します。"}]}
#君の名は。
execute @a[scores={stinger=302}] ~ ~ ~ tag * remove yourname
execute @r[scores={stinger=302}] ~ ~ ~ tag @r[tag=!stinger] add yourname
execute @a[tag=yourname] ~ ~ ~ tellraw @s[scores={language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f我来见你了。真不容易啊，你在好远的地方啊。 摘录自 <你的名字。> 。"}]}
execute @a[tag=yourname] ~ ~ ~ tellraw @s[scores={language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fお前に会いに来たんだ。大変だったよ。お前すげえ遠くにいるから。 Excerpt from <Your Name> ."}]}
execute @a[tag=yourname] ~ ~ ~ tellraw @s[scores={language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f我來見你了。真不容易啊，你在好遠的地方啊。 摘錄自 <你的名字。> 。 "}]}
execute @a[tag=yourname] ~ ~ ~ tellraw @s[scores={language=3}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§fお前に会いに来たんだ。大変だったよ。お前すげえ遠くにいるから。 「君の名は。」から抜粋します。"}]}
#千と千寻の神隠し
execute @a[scores={stinger=303}] ~ ~ ~ tag * remove spiritedaway
execute @a[scores={stinger=303}] ~ ~ ~ tag @r[tag=!stinger] add spiritedaway
execute @a[tag=spiritedaway] ~ ~ ~ tellraw @s[scores={language=0}] {"rawtext":[{"text":"§l§e空岛生存§f>>§r§f既然插手要做，就要做到底。 摘录自 <千与千寻> 。"}]}
execute @a[tag=spiritedaway] ~ ~ ~ tellraw @s[scores={language=1}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f手を出すんなら、しまいまでやれ！ Excerpt from <Spirited Away> ."}]}
execute @a[tag=spiritedaway] ~ ~ ~ tellraw @s[scores={language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f既然插手要做，就要做到底。 摘錄自 <千與千尋> 。 "}]}
execute @a[tag=spiritedaway] ~ ~ ~ tellraw @s[scores={language=3}] {"rawtext":[{"text":"§l§eSkyBlock§f>>§r§f手を出すんなら、しまいまでやれ！ 「千と千寻の神隠し」から抜粋します。"}]}