...
replaceitem block 1 7 0 slot.container 4 stone_shovel
replaceitem block 1 7 0 slot.container 4 stone_hoe
replaceitem block 1 7 0 slot.container 9 ice 3
...
tellraw @p {"rawtext":[{"text":"§f加载完成，请管理员手动添加常加载区块！"}]}
tellraw @p {"rawtext":[{"text":"§f命令语法：/tickingarea add x y z x y z"}]}