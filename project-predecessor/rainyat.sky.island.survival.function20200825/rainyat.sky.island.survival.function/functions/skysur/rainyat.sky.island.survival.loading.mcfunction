...
scoreboard objectives add id dummy §1归属岛屿ID
scoreboard objectives add uid dummy §6UID编号
...
scoreboard objectives add shopsbuytemp dummy
scoreboard objectives add shopsselltemp dummy
scoreboard objectives add shopsbuyprice dummy §3商店§l§6购买物品§r§3价格
scoreboard objectives add shopssellprice dummy §3商店§l§e售卖物品§r§3价格
