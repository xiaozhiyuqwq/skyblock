...
scoreboard players add @a[tag=guild] guildtime 1
scoreboard players add @a[tag=!guild] guildtime 8848
...
tellraw @a[tag=hang_up,scores={language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§6掛機獎勵已發放！ §f您额外获得了 §e2枚硬幣 §f。"}]}
tellraw @a[tag=reward,scores={language=2}] {"rawtext":[{"text":"§l§e空島生存§f>>§r§f§2額外獎勵已發放！ §f您额外获得了 §e3枚硬幣 §f。"}]}
