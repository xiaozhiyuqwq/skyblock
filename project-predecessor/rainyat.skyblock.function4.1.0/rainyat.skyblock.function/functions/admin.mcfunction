...
execute @a[tag=admin,scores={admin=2,language=0}] ~ ~ ~ title @s actionbar §f当前在线管理员 §6@a[m=admin]
execute @a[tag=admin,scores={admin=2,language=1}] ~ ~ ~ title @s actionbar §fCurrent online administrator §6@a[m=admin]
execute @a[tag=admin,scores={admin=3,language=0},m=creative] ~ ~ ~ title @s actionbar §f您的游戏模式 §r§3创造
execute @a[tag=admin,scores={admin=3,language=1},m=creative] ~ ~ ~ title @s actionbar §fYour game mode §r§3Creative
execute @a[tag=admin,scores={admin=3,language=0},m=adventure] ~ ~ ~ title @s actionbar §f您的游戏模式 §r§d冒险
execute @a[tag=admin,scores={admin=3,language=1},m=adventure] ~ ~ ~ title @s actionbar §fYour game mode §r§dAdventure
execute @a[tag=admin,scores={admin=3,language=0},m=survival] ~ ~ ~ title @s actionbar §f您的游戏模式 §r§6生存
execute @a[tag=admin,scores={admin=3,language=1},m=survival] ~ ~ ~ title @s actionbar §fYour game mode §r§6Survival
...
tellraw @a[scores={admin=5,language=1},tag=admin] {"rawtext":[{"text":"§fCurrently running Rainyat SkyBlock Function v4.1.0 PRO"}]}
tellraw @a[scores={admin=5,language=0},tag=admin] {"rawtext":[{"text":"§f当前正在运行 雨逸阁空岛生存函数包 v4.1.0 PRO"}]}
