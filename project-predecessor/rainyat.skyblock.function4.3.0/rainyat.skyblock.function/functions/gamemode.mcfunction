...
tellraw @a[m=creative,tag=survival,scores={language=2}] {"rawtext":[{"text":"§f您的遊戲模式由 §l§6生存 §r§f變更為 §l§3創造 §r§f。"}]}
tellraw @a[m=creative,tag=adventure,scores={language=2}] {"rawtext":[{"text":"§f您的遊戲模式由 §l§d冒險 §r§f變更為 §l§3創造 §r§f。"}]}
tellraw @a[m=survival,tag=creative,scores={language=2}] {"rawtext":[{"text":"§f您的遊戲模式由 §l§3創造 §r§f變更為 §l§6生存 §r§f。"}]}
tellraw @a[m=survival,tag=adventure,scores={language=2}] {"rawtext":[{"text":"§f您的遊戲模式由 §l§d冒險 §r§f變更為 §l§6生存 §r§f。"}]}
tellraw @a[m=adventure,tag=survival,scores={language=2}] {"rawtext":[{"text":"§f您的遊戲模式由 §l§6生存 §r§f變更為 §l§d冒險 §r§f。"}]}
tellraw @a[m=adventure,tag=creative,scores={language=2}] {"rawtext":[{"text":"§f您的遊戲模式由 §l§3創造 §r§f變更為 §l§d冒險 §r§f。"}]}
