...
tellraw @a[scores={level=1,temp=444},tag=!dead] {"rawtext":[{"text":"§f您阵亡了 §a您的等级：level_1 §c死亡扣除 §e2coin"}]}
tellraw @a[scores={level=2,temp=444},tag=!dead] {"rawtext":[{"text":"§f您阵亡了 §a您的等级：level_2 §c死亡扣除 §e5coin"}]}
tellraw @a[scores={level=3,temp=444},tag=!dead] {"rawtext":[{"text":"§f您阵亡了 §a您的等级：level_3 §c死亡扣除 §e8coin"}]}
tellraw @a[scores={level=4,temp=444},tag=!dead] {"rawtext":[{"text":"§f您阵亡了 §a您的等级：level_4 §c死亡扣除 §e12coin"}]}
tellraw @a[scores={level=5,temp=444},tag=!dead] {"rawtext":[{"text":"§f您阵亡了 §a您的等级：level_5 §c死亡扣除 §e15coin"}]}
...
scoreboard players set @a[scores={level=1,temp=444,coin=0..1},tag=!dead] coin 0
scoreboard players set @a[scores={level=2,temp=444,coin=0..4},tag=!dead] coin 0
scoreboard players set @a[scores={level=3,temp=444,coin=0..7},tag=!dead] coin 0
scoreboard players set @a[scores={level=4,temp=444,coin=0..11},tag=!dead] coin 0
scoreboard players set @a[scores={level=5,temp=444,coin=0..15},tag=!dead] coin 0
tellraw @a[scores={level=0,temp=444},tag=dead] {"rawtext":[{"text":"§f您阵亡了 §a您的等级：level_0 §c死亡扣除不扣除硬币"}]}
...
effect @a[scores={temp=444}] resistance 30 1 true
effect @a[scores={temp=444},tag=dead] regeneration 30 1 true
