...
tellraw @a[scores={level=3,language=0,coin=1001..10000}] {"rawtext":[{"text":"§f在线奖励已发放！ §a您的等级：level_3 §b您获得了 §e1coin"}]}
tellraw @a[scores={level=4,language=0,coin=1001..10000}] {"rawtext":[{"text":"§f在线奖励已发放！ §a您的等级：level_4 §b您获得了 §e2coin"}]}
tellraw @a[scores={level=5,language=0,coin=1001..10000}] {"rawtext":[{"text":"§f在线奖励已发放！ §a您的等级：level_5 §b您获得了 §e2coin"}]}
...
tellraw @a[scores={level=3,language=1,coin=1001..10000}] {"rawtext":[{"text":"§fOnline reward has been issued! §aYour level: level 3 §cYou got §e1coin"}]}
...
tellraw @a[scores={level=5,language=1,coin=1001..10000}] {"rawtext":[{"text":"§fOnline reward has been issued! §aYour level: level 5 §cYou got §e2coin"}]}
...
scoreboard players add @a[scores={level=3,coin=1001..10000}] coin 1
scoreboard players add @a[scores={level=4,coin=1001..10000}] coin 2
scoreboard players add @a[scores={level=5,coin=1001..10000}] coin 2
