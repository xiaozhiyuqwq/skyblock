...
tellraw @a[scores={login=0,language=1}] {"rawtext":[{"text":"§fCurrently running Rainyat SkyBlock Function v4.0.1 PRO"}]}
tellraw @a[scores={login=0,language=0}] {"rawtext":[{"text":"§f当前正在运行 雨逸阁空岛生存函数包 v4.0.1 PRO"}]}
...
execute @a[scores={login=3,language=0}] ~ ~ ~ title @s subtitle §f雨逸阁空岛生存函数包 v4.0.1 PRO
execute @a[scores={login=3,language=1}] ~ ~ ~ title @s subtitle §fRainyat SkyBlock Function v4.0.1 PRO
