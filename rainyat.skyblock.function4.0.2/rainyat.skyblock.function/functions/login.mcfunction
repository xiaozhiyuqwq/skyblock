...
tellraw @a[scores={login=0,language=1}] {"rawtext":[{"text":"§fCurrently running Rainyat SkyBlock Function v4.0.2 PRO"}]}
tellraw @a[scores={login=0,language=0}] {"rawtext":[{"text":"§f当前正在运行 雨逸阁空岛生存函数包 v4.0.2 PRO"}]}
