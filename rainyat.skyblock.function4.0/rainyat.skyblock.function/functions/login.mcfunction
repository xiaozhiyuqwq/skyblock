...
tellraw @a[scores={login=0,language=1}] {"rawtext":[{"text":"§fCurrently running Rainyat SkyBlock Function v4.0 PRO"}]}
tellraw @a[scores={login=0,language=0}] {"rawtext":[{"text":"§f当前正在运行 雨逸阁空岛生存函数包 v4.0 PRO"}]}
...
execute @a[scores={login=4,language=0}] ~ ~ ~ title @r[scores={login=1}] subtitle §6@s §b加入了游戏
execute @a[scores={login=4,language=1}] ~ ~ ~ title  subtitle §6@s §bjoined the game
...
execute @a[scores={login=3,language=0}] ~ ~ ~ title @s subtitle §f雨逸阁空岛生存函数包 v4.0 PRO
execute @a[scores={login=3,language=1}] ~ ~ ~ title @s subtitle §fRainyat SkyBlock Function v4.0 PRO
