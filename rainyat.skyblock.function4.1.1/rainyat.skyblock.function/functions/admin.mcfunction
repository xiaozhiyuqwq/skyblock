...
execute @a[scores={admin=5,language=1},tag=admin] ~ ~ ~ title @s actionbar §fCurrently running Rainyat SkyBlock Function v4.1.1 PRO
execute @a[scores={admin=5,language=0},tag=admin] ~ ~ ~ title @s actionbar §f当前正在运行 雨逸阁空岛生存函数包 v4.1.1 PRO
