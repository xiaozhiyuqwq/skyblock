...
execute @r[tag=!changegamerule,c=3] ~ ~ ~ scoreboard players add gamerulescore uidafter 1
execute @a[tag=!changegamerule,c=3] ~ ~ ~ tag @s add changegamerule
execute @r[tag=!changegamerule,c=2] ~ ~ ~ scoreboard players add gamerulescore uidafter 1
execute @a[tag=!changegamerule,c=2] ~ ~ ~ tag @s add changegamerule
execute @r[tag=!changegamerule,c=3] ~ ~ ~ scoreboard players add gamerulescore uidafter 2
execute @a[tag=!changegamerule,c=3] ~ ~ ~ tag @s add changegamerule
execute @r[tag=!changegamerule,c=2] ~ ~ ~ scoreboard players add gamerulescore uidafter 1
execute @a[tag=!changegamerule,c=2] ~ ~ ~ tag @s add changegamerule
...
execute @e[type=armor_stand,scores={typeid=128},tag=!gamerule-night] ~ ~ ~ scoreboard players reset nighttime uidafter
#火焰蔓延修改
#开(15%)
...
#结束
execute @e[type=armor_stand,scores={typeid=128}] ~ ~ ~ scoreboard players operation @s uidafter = gamerulescore uidafter
execute @e[type=armor_stand,scores={typeid=128,uidafter=1001..1100}] ~ ~ ~ scoreboard players set gamerule uidafter 0
execute @e[type=armor_stand,scores={typeid=128,uidafter=1001..1100}] ~ ~ ~ scoreboard players set @s uidafter 0
scoreboard players reset gamerulescores uidafter
#统一删除已经出现表示的穷举
