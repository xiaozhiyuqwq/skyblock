...
execute @a[tag=set] ~ ~ ~ setblock ~ 4 ~ stained_glass 0
execute @a[tag=set] ~ ~ ~  tickingarea add ~-48 2 ~-48 ~48 200 ~48 girdenroll
execute @a[tag=set] ~ ~ ~  detect ~ 4 ~ air 0 setblock ~ 4 ~ stained_glass 0
execute @a[tag=set] ~ ~ ~  detect ~ 4 ~ stained_glass 0 summon armor_stand ~ 5 ~ 
execute @a[tag=set] ~ ~ ~  detect ~ 4 ~ stained_glass 0 tag @e[x=~,y=2,z=~,r=5,type=armor_stand] add girdset
execute @a[tag=set] ~ ~ ~  detect ~ 4 ~ stained_glass 0 tag @e[x=~,y=2,z=~,r=5,type=armor_stand] add gird
execute @a[tag=set] ~ ~ ~  detect ~ 4 ~ stained_glass 0 tag @e[x=~,y=2,z=~,r=5,type=armor_stand] add girdfirst
