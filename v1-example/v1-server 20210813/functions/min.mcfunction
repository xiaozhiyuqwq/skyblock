...
#彩蛋
#主要
scoreboard players reset @e[scores={typeid=128},type=minecraft:armor_stand] stinger
scoreboard players random @e[scores={typeid=128},type=minecraft:armor_stand] stinger 1 10
execute @a[tag=!stinger] ~ ~ ~ scoreboard players operation @s stinger += @e[scores={typeid=128},type=minecraft:armor_stand] stinger
scoreboard players random @a[scores={stinger=200..},tag=!stinger] stinger 301 303
#天気の子
...
#天弃之子
execute @e[type=minecraft:armor_stand,scores={typeid=128,luckily=1001..1004}] ~ ~ ~ tag @r[scores={coin=7000..}] add unluckily
