...
#请在下面填写更新子版本(分支)
scoreboard players set branchesver version 6
...
#主世界确认
#tag @a remove mainworld
#tag @a[r=99999999999999999] add mainworld
#跑图确认
...
#保护
execute @a[tag=nosur,tag=mainworld] ~ ~ ~ gamemode 2 @s[m=0]
...
execute @a[tag=!islandruns,scores={tptype=1..3},tag=mainworld] ~ ~ ~ gamemode 0 @s[m=2]
execute @a[tag=!islandruns,scores={tptype=5},tag=mainworld] ~ ~ ~ gamemode 0 @s[m=2]
...
#文本4-任务
#任务提示-language=0
execute @a[scores={actionbartime=226..300,level=!0,language=0,actionbar=50,task=1}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§e前面的区域，以后再来探索~"}]}
...
#任务提示-language=1
execute @a[scores={actionbartime=226..300,level=!0,language=1,actionbar=50,task=1}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§e前面的区域，以后再来探索~"}]}
...
#任务提示-language=2
execute @a[scores={actionbartime=226..300,level=!0,language=2,actionbar=50,task=1}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§e前面的区域，以后再来探索~"}]}
execute @a[scores={actionbartime=226..300,level=!0,language=2,actionbar=50,task=2}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§§el§2[任務2] §r§f收集：物品 [§d石頭*10§f] 。"}]}
...
#任务提示-language=3
execute @a[scores={actionbartime=226..300,level=!0,language=3,actionbar=50,task=1}] ~ ~ ~ titleraw @s actionbar {"rawtext":[{"text":"§e前面的区域，以后再来探索~"}]}
